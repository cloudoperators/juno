...
import { createPersesChartsTheme, createPersesMuiTheme, datasourceApi, queryClient } from "../persesApi"
...
export function PersesDashboardWrapper({ theme = "theme-light" }: PersesDashboardWrapperProps) {
