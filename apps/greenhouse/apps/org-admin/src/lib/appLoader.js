...
export async function mount(containerElement, { name, version, assetsHost = document.location.origin, appProps = {} }) {
  ...
  const modulePath = manifest[name][version || "latest"]?.path || manifest[name][version || "latest"]?.entryFile
