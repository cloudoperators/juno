...
import { SideNavigation, SideNavigationItem, Badge, Stack } from "@cloudoperators/juno-ui-components"
        ...
        >
          <Stack>
            ...
            {pluginConfig[key]?.releaseState && (
              <Badge className="ml-1" text={pluginConfig[key]?.releaseState} variant="info" />
            )}
          </Stack>
        </SideNavigationItem>
      ))}
