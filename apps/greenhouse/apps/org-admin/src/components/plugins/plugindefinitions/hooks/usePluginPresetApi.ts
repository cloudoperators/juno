...
export const usePluginPresetApi = () => {
  ...
  const createPluginPreset = (pluginPreset: PluginPreset): Promise<PluginPresetApiResponse> => {
  ...
  const updatePluginPreset = (pluginPreset: PluginPreset): Promise<PluginPresetApiResponse> => {
  ...
  const deletePluginPreset = (pluginPreset: PluginPreset): Promise<PluginPresetApiResponse> => {
