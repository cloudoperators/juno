...
import { Plugin, PluginDefinition, PluginOptionValue } from "../../../../types/types"
...
export const initPluginFromPluginDef = (pluginDefinition: PluginDefinition) => {
  ...
  let initPlugin: Plugin = {
    ...
    spec: {
      ...
      displayName: pluginDefinition.spec?.displayName ?? pluginDefinition.metadata?.name,
      clusterName: "",
      disabled: false,
      optionValues: [],
    },
...
export const initMetadata = (pluginDefinition: PluginDefinition): Plugin["metadata"] => {
  return {
    name: pluginDefinition.metadata!.name!,
    namespace: "",
    labels: {},
...
export const initPluginSpec = (pluginDefinition: PluginDefinition): Plugin["spec"] => {
