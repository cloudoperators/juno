...
import { KubernetesCondition, ResourceStatus, ResourceStatusCondition } from "../../../../types/types"
...
const getResourceStatusFromKubernetesConditions = (conditions: KubernetesCondition[]): ResourceStatus => {
  let message = ""
