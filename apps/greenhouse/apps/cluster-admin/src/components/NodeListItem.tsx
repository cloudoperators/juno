...
import { getResourceStatusFromKubernetesConditions, resourceStatusUnknown } from "../lib/utils/resourceStatus"
...
const NodeListItem: React.FC<NodeListItemProps> = (props: NodeListItemProps) => {
