...
import { useLoggedIn, useCurrentTeam, useDefaultTeam, useStoreActions } from "../components/StoreProvider"
...
const useUrlState = (key) => {
  ...
  useEffect(() => {
    ...
    */
    ...
    console.log(`Team-Admin: (${key || URL_STATE_KEY}) setting up state from url:`, urlStateManager.currentState())
  ...
  useEffect(() => {
    ...
    console.log("useUrlStateKey - after  urlStateManager.push: ", urlStateManager.currentState()?.[TEAM_NAME])
