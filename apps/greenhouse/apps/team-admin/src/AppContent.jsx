...
import { useTeamMemberships, useLoggedIn, useIsMock, useEndpoint, useStoreActions } from "./components/StoreProvider"
    ...
    <Container py px>
      ...
      {loggedIn ? (
        ...
        <Stack alignment="center" distribution="center" direction="vertical" className="h-full">
          <span>
            You are not logged in! To access the application, you need to have the Authentication Application and log
            in.
          </span>
        </Stack>
      )}
