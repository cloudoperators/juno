...
export type AllowedApiObject = Plugin | Cluster | Secret | PluginDefinition | PluginPreset

export type AllowedApiObjectKind = "Plugin" | "Cluster" | "Secret" | "PluginDefinition" | "PluginPreset"
