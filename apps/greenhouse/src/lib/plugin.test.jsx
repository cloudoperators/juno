  ...
  describe("createPluginConfig", () => {
    it("requires at least an id and name", () => {
      ...
      expect(spy).toHaveBeenCalledWith(
        expect.stringContaining("[greenhouse]::createPluginConfig: id and name are required.")
      )
      spy.mockRestore()
    })
    ...
    it("sets weight to default 0 if missing", () => {
      expect(createPluginConfig({ id: "id_test", name: "name_test" })).toEqual(expect.objectContaining({ weight: 0 }))
    })
