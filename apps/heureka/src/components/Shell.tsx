...
export const Shell = ({ embedded }: ShellProps) => {
  ...
  return (
    <AppShell
      ...
      // topNavigation={<Navigation activeItem={state.selectedView?.viewId} />} //TODO: This will be activated after other views will be there and the routing is implemented
    >
      <Container py px>
        <MessagesProvider>
          <Messages />
