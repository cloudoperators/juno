...
export type GetServiceImageVersionsQuery = { __typename?: 'Query', ComponentVersions?: { __typename?: 'ComponentVersionConnection', totalCount: number, edges: Array<{ __typename?: 'ComponentVersionEdge', node: { __typename?: 'ComponentVersion', tag?: string | null, version?: string | null, issueCounts?: { __typename?: 'SeverityCounts', critical: number, high: number, medium: number, low: number, none: number } | null, component?: { __typename?: 'Component', ccrn?: string | null } | null } } | null>, pageInfo?: { __typename?: 'PageInfo', pages?: Array<{ __typename?: 'Page', after?: string | null, pageNumber?: number | null } | null> | null } | null } | null };
...
export type GetServicesQuery = { __typename?: 'Query', Services?: { __typename?: 'ServiceConnection', totalCount: number, edges?: Array<{ __typename?: 'ServiceEdge', node: { __typename?: 'Service', id: string, ccrn?: string | null, objectMetadata?: { __typename?: 'ServiceMetadata', componentInstanceCount: number, issueMatchCount: number } | null, owners?: { __typename?: 'UserConnection', edges?: Array<{ __typename?: 'UserEdge', node: { __typename?: 'User', id: string, uniqueUserId?: string | null, name?: string | null } } | null> | null } | null, supportGroups?: { __typename?: 'SupportGroupConnection', edges?: Array<{ __typename?: 'SupportGroupEdge', node: { __typename?: 'SupportGroup', id: string, ccrn?: string | null } } | null> | null } | null, critical?: { __typename?: 'IssueMatchConnection', totalCount: number } | null, high?: { __typename?: 'IssueMatchConnection', totalCount: number } | null, medium?: { __typename?: 'IssueMatchConnection', totalCount: number } | null, low?: { __typename?: 'IssueMatchConnection', totalCount: number } | null, none?: { __typename?: 'IssueMatchConnection', totalCount: number } | null } } | null> | null, pageInfo?: { __typename?: 'PageInfo', pages?: Array<{ __typename?: 'Page', after?: string | null, pageNumber?: number | null } | null> | null } | null } | null };

export type GetServiceFiltersQueryVariables = Exact<{ [key: string]: never; }>;


export type GetServiceFiltersQuery = { __typename?: 'Query', ServiceFilterValues?: { __typename?: 'ServiceFilterValue', serviceCcrn?: { __typename?: 'FilterItem', displayName?: string | null, filterName?: string | null, values?: Array<string | null> | null } | null, supportGroupCcrn?: { __typename?: 'FilterItem', displayName?: string | null, filterName?: string | null, values?: Array<string | null> | null } | null, uniqueUserId?: { __typename?: 'FilterItem', displayName?: string | null, filterName?: string | null, values?: Array<string | null> | null } | null, userName?: { __typename?: 'FilterItem', displayName?: string | null, filterName?: string | null, values?: Array<string | null> | null } | null } | null };
...
export type GetServicesCountsQuery = { __typename?: 'Query', critical?: { __typename?: 'IssueMatchConnection', totalCount: number } | null, high?: { __typename?: 'IssueMatchConnection', totalCount: number } | null, medium?: { __typename?: 'IssueMatchConnection', totalCount: number } | null, low?: { __typename?: 'IssueMatchConnection', totalCount: number } | null, none?: { __typename?: 'IssueMatchConnection', totalCount: number } | null };


export const GetServiceImageVersionsDocument = gql`
    query GetServiceImageVersions($filter: ComponentVersionFilter, $first: Int, $after: String, $orderBy: [ComponentVersionOrderBy]) {
  ComponentVersions(
    filter: $filter
    first: $first
    after: $after
 ...
 * });
 */
export function useGetServiceImageVersionsQuery(baseOptions?: Apollo.QueryHookOptions<GetServiceImageVersionsQuery, GetServiceImageVersionsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetServiceImageVersionsQuery, GetServiceImageVersionsQueryVariables>(GetServiceImageVersionsDocument, options);
      }
export function useGetServiceImageVersionsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetServiceImageVersionsQuery, GetServiceImageVersionsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetServiceImageVersionsQuery, GetServiceImageVersionsQueryVariables>(GetServiceImageVersionsDocument, options);
        }
export function useGetServiceImageVersionsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetServiceImageVersionsQuery, GetServiceImageVersionsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetServiceImageVersionsQuery, GetServiceImageVersionsQueryVariables>(GetServiceImageVersionsDocument, options);
        }
...
export type GetServiceImageVersionsQueryResult = Apollo.QueryResult<GetServiceImageVersionsQuery, GetServiceImageVersionsQueryVariables>;
export const GetServicesDocument = gql`
    query GetServices($filter: ServiceFilter, $first: Int, $after: String, $orderBy: [ServiceOrderBy], $crit: IssueMatchFilter, $high: IssueMatchFilter, $med: IssueMatchFilter, $low: IssueMatchFilter, $none: IssueMatchFilter) {
 ...
 * });
 */
export function useGetServiceFiltersQuery(baseOptions?: Apollo.QueryHookOptions<GetServiceFiltersQuery, GetServiceFiltersQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetServiceFiltersQuery, GetServiceFiltersQueryVariables>(GetServiceFiltersDocument, options);
      }
export function useGetServiceFiltersLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetServiceFiltersQuery, GetServiceFiltersQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetServiceFiltersQuery, GetServiceFiltersQueryVariables>(GetServiceFiltersDocument, options);
        }
export function useGetServiceFiltersSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetServiceFiltersQuery, GetServiceFiltersQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetServiceFiltersQuery, GetServiceFiltersQueryVariables>(GetServiceFiltersDocument, options);
        }
...
export const GetServicesCountsDocument = gql`
    query GetServicesCounts($crit: IssueMatchFilter, $high: IssueMatchFilter, $med: IssueMatchFilter, $low: IssueMatchFilter, $none: IssueMatchFilter) {
  critical: IssueMatches(filter: $crit) {
    totalCount
  }
  high: IssueMatches(filter: $high) {
 ...
 * });
 */
export function useGetServicesCountsQuery(baseOptions?: Apollo.QueryHookOptions<GetServicesCountsQuery, GetServicesCountsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetServicesCountsQuery, GetServicesCountsQueryVariables>(GetServicesCountsDocument, options);
      }
export function useGetServicesCountsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetServicesCountsQuery, GetServicesCountsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetServicesCountsQuery, GetServicesCountsQueryVariables>(GetServicesCountsDocument, options);
        }
export function useGetServicesCountsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetServicesCountsQuery, GetServicesCountsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetServicesCountsQuery, GetServicesCountsQueryVariables>(GetServicesCountsDocument, options);
        }
