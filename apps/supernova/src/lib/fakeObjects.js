...
const refAlert = {
  annotations: {
    ...
    summary: "vSphere High Availability (HA) has detected a possible host failure for `node014-bb164`. (vc-a-0.cc).",
  },
  ...
  labels: {
    ...
    alert_name: "vSphere High Availability (HA) has detected a possible host failure",
