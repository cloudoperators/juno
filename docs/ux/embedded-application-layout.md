...
When rendered as an embedded app, the page header of the embedded child app will not render, since the parent application will render its own header. Embedded applications retain their own original navigations though.
