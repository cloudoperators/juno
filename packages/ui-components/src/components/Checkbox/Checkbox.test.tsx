...
describe("Checkbox", () => {
  test("renders a valid html input type checkbox", () => {
    render(<Checkbox />)
    expect(screen.getByRole("checkbox")).toBeInTheDocument()
    expect(screen.getByRole("checkbox")).toHaveAttribute("type", "checkbox")
  })

  test("renders a checkbox with a name as passed", () => {
  ...
  test("renders a checkbox with an id as passed", () => {
  ...
  test("renders a Checkbox with an associated label with an id as passed", () => {
  ...
  test("renders a Checkbox with a label associated by an auto-generated id if no id was passed", () => {
    render(<Checkbox label="This is a Checkbox" />)
    expect(screen.getByRole("checkbox")).toBeInTheDocument()
    expect(screen.getByLabelText("This is a Checkbox")).toBeInTheDocument()
  })

  test("renders a checkbox with a value as passed", () => {
  ...
  test("renders a successtext as passed and validates the Checkbox", () => {
  ...
  test("renders an errortext as passed and invalidates the Checkbox", () => {
  ...
  test("does not fire a handler on change when disabled", () => {
    const onChangeSpy = vi.fn()
  ...
  test("does not fire a handler on click when disabled", () => {
    const onClickSpy = vi.fn()
