...
describe("SecretText", () => {
  ...
  test("renders an autocomplete attribute to the SecretText textarea", () => {
    render(<SecretText autoComplete="on" />)
    expect(screen.getByRole("textbox")).toHaveAttribute("autoComplete", "on")
  })

  test("renders Clear, Reveal, Copy, and Paste buttons by default", () => {
    render(<SecretText />)
  ...
  test("does not render a Clear button as passed", () => {
  ...
  test("does not render a Reveal button as passed", () => {
  ...
  test("does not render a Copy button as passed", () => {
  ...
  test("does not render a Paste button as passed", () => {
  ...
  test("renders a Hide button when set to reveal", () => {
    render(<SecretText reveal />)
    expect(screen.getByRole("button", { name: "Hide" })).toBeInTheDocument()
  })

  test("renders concealed text by default", () => {
    render(<SecretText />)
    expect(document.querySelector(".juno-secret-cover")).toBeInTheDocument()
  })

  test("renders unconcealed text when set to reveal", () => {
    render(<SecretText reveal />)
    expect(document.querySelector(".juno-secret-cover")).not.toBeInTheDocument()
  })

  test("renders a disabled SecretText textarea as passed", () => {
    render(<SecretText disabled />)
    expect(screen.getByRole("textbox")).toBeDisabled()
  })

  test("renders disabled buttons when the whole SecretText is set to disabled", () => {
    render(<SecretText disabled />)
    expect(screen.getByRole("button", { name: "Clear" })).toBeInTheDocument()
  ...
  test("renders a disabled Clear button as passed", () => {
    render(<SecretText disableClear />)
    expect(screen.getByRole("button", { name: "Clear" })).toBeInTheDocument()
    expect(screen.getByRole("button", { name: "Clear" })).toBeDisabled()
  })

  test("renders a disabled Toggle button as passed", () => {
    render(<SecretText disableToggle />)
    expect(screen.getByRole("button", { name: "Reveal" })).toBeInTheDocument()
    expect(screen.getByRole("button", { name: "Reveal" })).toBeDisabled()
  })

  test("renders a disabled Paste button as passed", () => {
    render(<SecretText disablePaste />)
    expect(screen.getByRole("button", { name: "Paste" })).toBeInTheDocument()
    expect(screen.getByRole("button", { name: "Paste" })).toBeDisabled()
  })

  test("renders a disabled Copy button as passed", () => {
  ...
  test("renders a generated id when no id was passed", () => {
    render(<SecretText />)
    expect(screen.getByRole("textbox")).toBeInTheDocument()
    expect(screen.getByRole("textbox")).toHaveAttribute("id")
  })

  test("associates label with textarea using an id as passed", () => {
  ...
  test("renders a name attribute as passed", () => {
  ...
  test("renders a readOnly textarea as passed", () => {
    render(<SecretText readOnly />)
    expect(screen.getByRole("textbox")).toHaveAttribute("readOnly")
  })

  test("renders a required SecretText component as passed", () => {
    render(<SecretText label="My Secret Text" required />)
    expect(screen.getByRole("textbox")).toBeInTheDocument()
    expect(document.querySelector(".juno-label")).toBeInTheDocument()
  ...
  test("does not render a Toggle button if passed", () => {
    render(<SecretText toggle={false} />)
    expect(screen.getByRole("textbox")).toBeInTheDocument()
    expect(screen.getByRole("textbox")).toHaveClass("juno-secret-textarea")
  ...
  test("renders an invalid SecretText", () => {
  ...
  test("renders a valid SecretText", () => {
  ...
  test("renders an errortext as passed", () => {
  ...
  test("renders an helptext as passed", () => {
  ...
  test("renders an successtext as passed", () => {
  ...
  test("does not render a Clear nor a Paste button when set to readOnly", () => {
    render(<SecretText readOnly />)
    expect(screen.queryByRole("button", { name: "Clear" })).not.toBeInTheDocument()
    expect(screen.queryByRole("button", { name: "Paste" })).not.toBeInTheDocument()
  })
  ...
  test("renders a wrapperClassName to the outermost wrapping element", () => {
