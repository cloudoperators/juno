...
const getIconWrapperStyles = (variant: "rounded" | "hero" | "default"): string => {
  switch (variant) {
    case "rounded":
      return "jn:absolute jn:inline-flex jn:items-center jn:right-3 jn:top-1"
    case "hero":
      return "jn:absolute jn:inline-flex jn:items-center jn:right-5"
    default:
      return "jn:absolute jn:inline-flex jn:items-center jn:right-3 jn:top-2"
  }
}
