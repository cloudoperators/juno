...
describe("FilterPill", () => {
  ...
  test("renders a filter key label as passed", () => {
  ...
  test("renders a filter key if filter key label missing", () => {
  ...
  test("renders nothing if filter key label not set", () => {
  ...
  test("renders a filter value label as passed", () => {
    render(
  ...
  test("renders a filter value if value label missing", () => {
  ...
  test("renders nothing if filter value or value label not given", () => {
    // the attribute filterKey and filterValue are required keep them empty to test render nothing
    render(<FilterPill data-testid="23" filterKey="" filterValue="" />)
    expect(screen.getByTestId("23")).toBeInTheDocument()
    expect(screen.getByTestId("23")).toHaveTextContent("")
