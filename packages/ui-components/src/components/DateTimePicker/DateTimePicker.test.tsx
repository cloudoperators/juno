...
describe("DateTimePicker", () => {
  ...
  test("allows setting an otherwise invalid value on first load as configured", () => {
  ...
  test("uses a custom conjunction between dates in multiple mode as passed", () => {
  ...
  test("updates the displayed value accordingly when the conjunction prop changes", () => {
