...
describe("IntroBox", () => {
  test("renders an IntroBox", () => {
    render(<IntroBox data-testid="my-introbox" />)
    expect(screen.getByTestId("my-introbox")).toBeInTheDocument()
  })

  test("renders an IntroBox with background image as passed if variant hero", () => {
  ...
  test("renders an IntroBox without background image as passed if variant is not hero", () => {
  ...
  test("renders children passed as children", () => {
    render(
