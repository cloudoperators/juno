...
describe("Container", () => {
  ...
  test("renders a custom className", () => {
    render(<Container data-testid="container" className="my-custom-classname" />)
    expect(screen.getByTestId("container")).toBeInTheDocument()
    expect(screen.getByTestId("container")).toHaveClass("my-custom-classname")
  })

  test("renders all props", () => {
    render(<Container data-testid="container" data-lolol="some-prop" />)
    expect(screen.getByTestId("container")).toBeInTheDocument()
    expect(screen.getByTestId("container")).toHaveAttribute("data-lolol", "some-prop")
  })
})
