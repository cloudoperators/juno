 ...
 */
// // TODO: When we the other components migrate to TS we will migrate this test in the end and delete this dummy
test("DUMMY TEST NEED TO BE DELETED", () => {
...
//   // // TODO: When we whole file ts is then enable thsi test
//   // test.skip("renders an app shell with page header passed as component", async () => {
//   //   render(
//   //     <AppShell
...
//   // // TODO: When we whole file ts is, then enalbe this test again
