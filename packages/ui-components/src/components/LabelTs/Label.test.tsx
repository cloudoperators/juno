...
describe("Label", () => {
  test("renders a label with a text as passed", () => {
    render(<Label text="my-label" />)
    expect(screen.getByText("my-label")).toBeInTheDocument()
  })

  test("renders a label for an element with an id as passed", () => {
