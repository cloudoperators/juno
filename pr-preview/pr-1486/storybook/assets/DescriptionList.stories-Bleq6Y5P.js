import{j as e}from"./iframe-xAC92jOs.js";import"./preload-helper-PPVm8Dsz.js";const d=({children:t,alignTerms:s="right",className:p=""})=>e.jsx("dl",{className:`dl jn:grid jn:grid-cols-4 jn:group ${s==="right"?"align-right":"align-left"} ${p}`,"data-testid":"description-list",children:t}),a=d;try{d.displayName="DescriptionList",d.__docgenInfo={description:`A wrapper component that semantically represents a list of terms and their corresponding descriptions.
...
Pairs with DescriptionTerm to complete the term-description association, offering flexible content styling.`,displayName:"DescriptionDefinition",props:{children:{defaultValue:null,description:"Content to be displayed as the description, accommodating text or more complex nodes to explain or define the associated term.",name:"children",required:!0,type:{name:"ReactNode"}},className:{defaultValue:{value:""},description:"Additional class names for applying custom styles or overriding default styles on the <dd> element.",name:"className",required:!1,type:{name:"string"}}}}}catch{}try{i.displayName="DD",i.__docgenInfo={description:"",displayName:"DD",props:{children:{defaultValue:null,description:"Content to be displayed as the description, accommodating text or more complex nodes to explain or define the associated term.",name:"children",required:!0,type:{name:"ReactNode"}},className:{defaultValue:{value:""},description:"Additional class names for applying custom styles or overriding default styles on the <dd> element.",name:"className",required:!1,type:{name:"string"}}}}}catch{}const g={title:"Components/DescriptionList",component:a,parameters:{docs:{description:{component:'\nA wrapper component that semantically represents a list of terms and their corresponding descriptions. \n\nThis component enforces structure by expecting child elements of `DescriptionTerm` or `DescriptionDefinition`.\n\n### Grid Layout\n- By default, the component uses a 4-column grid layout where each `DescriptionTerm` spans 1 column and each `DescriptionDefinition` spans 3 columns.\n- Customize the grid template by passing other Tailwind CSS grid classes via the `className` prop to override the defaults.\n\n#### Example\n```jsx\n<DL className="jn:grid-cols-2">\n  <DT className="jn:col-span-1">Shipping Method</DT>\n  <DD className="jn:col-span-2">Standard shipping: 5-7 business days.</DD>\n</DL>\n```\n        '}}},argTypes:{children:{control:!1}}},r={render:t=>e.jsxs(a,{...t,children:[e.jsx(n,{children:"Shipping"}),e.jsx(i,{children:"Standard shipping: 5-7 business days."}),e.jsx(n,{children:"Payment Options"}),e.jsx(i,{children:"Credit/Debit cards, PayPal, and bank transfer. Lots and lots and lots of options. Oh so many, many options."}),e.jsx(n,{children:"Delivery Time"}),e.jsx(i,{children:"1 day, 2 days, 3 days."})]})},o={render:t=>e.jsxs(a,{alignTerms:"right",...t,children:[e.jsx(n,{children:"Shipping Method"}),e.jsx(i,{children:"Standard shipping: 5-7 business days."}),e.jsx(n,{children:"Payment Options"}),e.jsx(i,{children:"Credit/Debit cards, PayPal, and bank transfer. Lots and lots of options available for a seamless transaction experience."}),e.jsx(n,{children:"Delivery Time"}),e.jsx(i,{children:"Estimated delivery between 1 to 3 business days after shipping."}),e.jsx(n,{children:"Return Policy"}),e.jsx(i,{children:"Returns are accepted within 30 days of purchase. Items must be returned in their original packaging and condition."}),e.jsx(n,{children:"Customer Support"}),e.jsx(i,{children:"Available via phone, email, and live chat from 9 AM to 6 PM, Monday to Friday. Our support team is ready to assist with any inquiries."})]})};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  ...
  render: args => <DL alignTerms="right" {...args}>
