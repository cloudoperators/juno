import{j as e}from"./iframe-C0xlVtux.js";import"./preload-helper-PPVm8Dsz.js";const l=({children:t,alignTerms:s="right",className:a="",...m})=>e.jsx("dl",{className:`dl jn:grid jn:grid-cols-4 jn:group ${s==="right"?"align-right":"align-left"} ${a}`,...m,children:t}),r=l;try{l.displayName="DescriptionList",l.__docgenInfo={description:`A component that semantically represents a list of terms and their corresponding descriptions.
