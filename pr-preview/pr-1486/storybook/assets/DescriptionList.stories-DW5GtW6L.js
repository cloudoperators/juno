import{j as e}from"./iframe-Cqsz0kI4.js";import"./preload-helper-PPVm8Dsz.js";const d=({children:t,alignTerms:s="right",className:p=""})=>e.jsx("dl",{className:`dl jn:grid jn:grid-cols-4 jn:group ${s==="right"?"align-right":"align-left"} ${p}`,"data-testid":"description-list",children:t}),a=d;try{d.displayName="DescriptionList",d.__docgenInfo={description:`A wrapper component that semantically represents a list of terms and their corresponding descriptions.
