import{j as e}from"./iframe-TQ72e4aj.js";import"./preload-helper-PPVm8Dsz.js";const s=({children:t,alignTerms:a="right",className:p=""})=>e.jsx("dl",{className:`dl jn:grid jn:grid-cols-4 jn:group ${a==="right"?"align-right":"align-left"} ${p}`,"data-testid":"description-list",children:t}),c=s;try{s.displayName="DescriptionList",s.__docgenInfo={description:`A wrapper component that semantically represents a list of terms and their corresponding descriptions using HTML <dl> elements.
