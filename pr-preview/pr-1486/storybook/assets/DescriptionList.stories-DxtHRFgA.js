import{j as e}from"./iframe-B3xxBWRO.js";import"./preload-helper-PPVm8Dsz.js";const d=({children:t,alignTerms:s="right",className:p=""})=>e.jsx("dl",{className:`dl jn:grid jn:grid-cols-4 jn:group ${s==="right"?"align-right":"align-left"} ${p}`,"data-testid":"description-list",children:t}),a=d;try{d.displayName="DescriptionList",d.__docgenInfo={description:`A wrapper component that semantically represents a list of terms and their corresponding descriptions.
...
Supports multiple instances to create a detailed list of terms and definitions.`,name:"children",required:!0,type:{name:"ReactElement<DescriptionTermProps | DescriptionDefinitionProps, string | JSXElementConstructor<any>> | ReactElement<...>[] | ReactElement<...>"}},alignTerms:{defaultValue:{value:"right"},description:"Determines the alignment of terms within the list. Align terms to the left or right based on preference for display style.",name:"alignTerms",required:!1,type:{name:"enum",value:[{value:'"left"'},{value:'"right"'}]}},className:{defaultValue:{value:""},description:"Additional custom class names to apply styles to the <dl> element or to extend styling from the design system.",name:"className",required:!1,type:{name:"string"}}}}}catch{}try{a.displayName="DL",a.__docgenInfo={description:"",displayName:"DL",props:{children:{defaultValue:null,description:`Child components must be either DescriptionTerm or DescriptionDefinition to maintain semantic structure.
...
`,l=({children:t,className:s=""})=>e.jsx("dt",{className:`dt ${m} ${s}`,children:t}),n=l;try{l.displayName="DescriptionTerm",l.__docgenInfo={description:`Represents a term in a description list, rendering an HTML <dt> element.
Used to denote terms, headers, or keys in a semantic way, allowing for flexible styling.`,displayName:"DescriptionTerm",props:{children:{defaultValue:null,description:"Content to be displayed as the term, which could be simple text or any ReactNode, providing semantic meaning to the associated description.",name:"children",required:!0,type:{name:"ReactNode"}},className:{defaultValue:{value:""},description:"Custom class names to apply additional styling to the <dt> element, useful for overrides or custom styles.",name:"className",required:!1,type:{name:"string"}}}}}catch{}try{n.displayName="DT",n.__docgenInfo={description:"",displayName:"DT",props:{children:{defaultValue:null,description:"Content to be displayed as the term, which could be simple text or any ReactNode, providing semantic meaning to the associated description.",name:"children",required:!0,type:{name:"ReactNode"}},className:{defaultValue:{value:""},description:"Custom class names to apply additional styling to the <dt> element, useful for overrides or custom styles.",name:"className",required:!1,type:{name:"string"}}}}}catch{}const u=`
  ...
  jn:p-2
  jn:col-span-3
`,c=({children:t,className:s=""})=>e.jsx("dd",{className:`dd ${u} ${s}`,children:t}),i=c;try{c.displayName="DescriptionDefinition",c.__docgenInfo={description:`Represents the definition or description in a description list, rendering as an HTML <dd> element.
Pairs with DescriptionTerm to complete the term-description association, offering flexible content styling.`,displayName:"DescriptionDefinition",props:{children:{defaultValue:null,description:"Content to be displayed as the description, accommodating text or more complex nodes to explain or define the associated term.",name:"children",required:!0,type:{name:"ReactNode"}},className:{defaultValue:{value:""},description:"Additional class names for applying custom styles or overriding default styles on the <dd> element.",name:"className",required:!1,type:{name:"string"}}}}}catch{}try{i.displayName="DD",i.__docgenInfo={description:"",displayName:"DD",props:{children:{defaultValue:null,description:"Content to be displayed as the description, accommodating text or more complex nodes to explain or define the associated term.",name:"children",required:!0,type:{name:"ReactNode"}},className:{defaultValue:{value:""},description:"Additional class names for applying custom styles or overriding default styles on the <dd> element.",name:"className",required:!1,type:{name:"string"}}}}}catch{}const g={title:"Components/DescriptionList",component:a,parameters:{docs:{description:{component:'\nA wrapper component that contains a list of terms and their corresponding descriptions. \n\nThis component enforces structure by expecting child elements of `DescriptionTerm` and `DescriptionDefinition`.\n\n### Grid Layout\n- By default, the component uses a 4-column grid layout where each `DescriptionTerm` spans 1 column and each `DescriptionDefinition` spans 3 columns.\n- Customise the grid template by passing other Tailwind CSS grid classes via the `className` prop to override the defaults.\n\n#### Example\n```jsx\n<DL className="grid-cols-2">\n  <DT className="col-span-1">Shipping Method</DT>\n  <DD className="col-span-1">Standard shipping: 5-7 business days.</DD>\n</DL>\n```\n        '}}},argTypes:{children:{control:!1}}},r={render:t=>e.jsxs(a,{...t,children:[e.jsx(n,{children:"Shipping"}),e.jsx(i,{children:"Standard shipping: 5-7 business days."}),e.jsx(n,{children:"Payment Options"}),e.jsx(i,{children:"Credit/Debit cards, PayPal, and bank transfer. Lots and lots and lots of options. Oh so many, many options."}),e.jsx(n,{children:"Delivery Time"}),e.jsx(i,{children:"1 day, 2 days, 3 days."})]})},o={render:t=>e.jsxs(a,{alignTerms:"left",...t,children:[e.jsx(n,{children:"Shipping Method"}),e.jsx(i,{children:"Standard shipping: 5-7 business days."}),e.jsx(n,{children:"Payment Options"}),e.jsx(i,{children:"Credit/Debit cards, PayPal, and bank transfer. Lots and lots of options available for a seamless transaction experience."}),e.jsx(n,{children:"Delivery Time"}),e.jsx(i,{children:"Estimated delivery between 1 to 3 business days after shipping."}),e.jsx(n,{children:"Return Policy"}),e.jsx(i,{children:"Returns are accepted within 30 days of purchase. Items must be returned in their original packaging and condition."}),e.jsx(n,{children:"Customer Support"}),e.jsx(i,{children:"Available via phone, email, and live chat from 9 AM to 6 PM, Monday to Friday. Our support team is ready to assist with any inquiries."})]})};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  render: args => <DL {...args}>
      <DT>Shipping</DT>
...
}`,...o.parameters?.docs?.source}}};const D=["Default","LeftAligned"];export{r as Default,o as LeftAligned,D as __namedExportsOrder,g as default};
