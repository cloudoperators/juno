import{j as e,r as s}from"./iframe-CrUpgBEs.js";import{a as V}from"./Navigation.component-Com3K2hv.js";import{I as b}from"./Icon.component-Dh25fUIK.js";const _=`
  jn:px-[1.25rem]
  jn:py-[1rem]
  jn:w-[16rem]
  jn:bg-theme-sidenav
...
`,N=({ariaLabel:i="",children:a,disabled:n=!1,href:t="",icon:o,label:u="",onClick:l,open:c=!1,selected:d=!1,...f})=>{const[r,v]=s.useState(c),m=s.useContext(S);s.useEffect(()=>{v(c)},[c]);const w=p=>{n||(p.stopPropagation(),v(!r))},g=p=>{n||(r||v(!r),t?window.location.href=t:l&&l(p))},I=()=>typeof a!="string"&&s.Children.count(a)>0?e.jsx("span",{onClick:w,role:"button",tabIndex:0,children:e.jsx(b,{size:"24",className:`
          ${n?j:""}`,icon:r?"expandMore":"chevronRight"})}):null,C=()=>e.jsxs("span",{className:k,children:[o&&m===0?e.jsx(b,{className:"jn:mr-[0.25rem]",icon:o,size:"24"}):null,e.jsx("div",{className:`level-${m+1}`,children:u||a})]}),h=()=>e.jsxs(e.Fragment,{children:[C(),I()]}),y=`
    juno-sidenavigation-item
    ${E}
    ${n?j:""}
    ${d?"selected":""}
    ${l||t||a?"jn:cursor-pointer":"jn:cursor-default"}
  `;return e.jsxs(S.Provider,{value:m+1,children:[t?e.jsx("a",{"aria-current":d?"page":void 0,"aria-label":i,className:y,href:n?void 0:t,onClick:g,...f,children:h()}):e.jsx("button",{"aria-current":d?"page":void 0,"aria-label":i,className:y,onClick:n?void 0:g,...f,children:h()}),r&&typeof a!="string"&&a]})};try{N.displayName="SideNavigationItem",N.__docgenInfo={description:`SideNavigationItem is a versatile component designed to be used within the SideNavigation component,
