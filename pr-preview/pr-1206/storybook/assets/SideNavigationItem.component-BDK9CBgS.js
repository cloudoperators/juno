...
`,N=({ariaLabel:i="",children:n,disabled:a=!1,href:t="",icon:r,label:u="",onClick:l,open:c=!1,selected:d=!1,...f})=>{const[o,v]=s.useState(c),m=s.useContext(b);s.useEffect(()=>{v(c)},[c]);const w=p=>{a||(p.stopPropagation(),v(!o))},h=p=>{a||(o||v(!o),t?window.location.href=t:l&&l(p))},I=()=>typeof n!="string"&&V.Children.count(n)>0?e.jsx("span",{onClick:w,role:"button",tabIndex:0,children:e.jsx(x,{size:"24",className:`
          juno-sidenavigation-item
          ${a?j:""}`,icon:o?"expandMore":"chevronRight"})}):null,C=()=>e.jsxs("span",{className:k,children:[r&&m===0?e.jsx(x,{icon:r,size:"24"}):null,e.jsx("div",{className:`juno-sidenavigation-item level-${m+1}`,children:u||n})]}),g=()=>e.jsxs(e.Fragment,{children:[C(),I()]}),y=`
    juno-sidenavigation-item
    ${q}
    ${a?j:""}
    ${d?"selected":""}
    ${l||t||n?"jn:cursor-pointer":"jn:cursor-default"}
  `;return e.jsxs(b.Provider,{value:m+1,children:[t?e.jsx("a",{"aria-current":d?"page":void 0,"aria-label":i,className:y,href:a?void 0:t,onClick:h,...f,children:g()}):e.jsx("button",{"aria-current":d?"page":void 0,"aria-label":i,className:y,onClick:a?void 0:h,...f,children:g()}),o&&n]})};try{N.displayName="SideNavigationItem",N.__docgenInfo={description:`SideNavigationItem is a versatile component designed to be used within the SideNavigation component,
