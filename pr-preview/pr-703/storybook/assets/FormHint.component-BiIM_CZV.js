...
`,o=f.forwardRef(({text:t="",htmlFor:l=void 0,required:a=!1,className:s="",disabled:n=!1,floating:d=!1,minimized:u=!1,...m},c)=>r.jsxs("label",{className:`
				juno-label 
				${p} 
				...
				${s}
			`,htmlFor:l,ref:c,...m,children:[t,a?r.jsx("span",{className:`
					juno-required 
					${b}
  ...
  jn-text-xs
  jn-mt-1
`,v=t=>{switch(t){case"success":return"jn-text-theme-success";case"error":return"jn-text-theme-error";default:return"jn-text-theme-light"}},i=({children:t=null,text:l="",variant:a="help",className:s,...n})=>r.jsx("div",{className:`
        juno-form-hint
        juno-form-hint-${a}
        ${g}
        ${v(a)}
        ${s}
      `,...n,children:t||l});i.displayName="FormHint Js";i.propTypes={children:e.node,text:e.node,variant:e.oneOf(["help","error","success"]),className:e.string};i.__docgenInfo={description:"",methods:[],displayName:"FormHint Js",props:{children:{defaultValue:{value:"null",computed:!1},description:"The children to render as a hint associated with a form element",type:{name:"node"},required:!1},text:{defaultValue:{value:'""',computed:!1},description:"The text to render. If both children and text are passed, children will rendered",type:{name:"node"},required:!1},variant:{defaultValue:{value:'"help"',computed:!1},description:"The variant of the the hint. Defaults to 'help'.",type:{name:"enum",value:[{value:'"help"',computed:!1},{value:'"error"',computed:!1},{value:'"success"',computed:!1}]},required:!1},className:{description:"Pass a custom className",type:{name:"string"},required:!1}}};export{i as F,o as L};
