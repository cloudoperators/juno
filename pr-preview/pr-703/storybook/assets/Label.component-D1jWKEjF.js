import{j as l}from"./jsx-runtime-D6fbYt3N.js";import{e as m}from"./index-DysCNOs_.js";const f=`
  jn-text-theme-high
  jn-text-base
  jn-transform 
  jn-origin-top-left 
...
`,e=m.forwardRef(({text:a="",htmlFor:n=void 0,required:t=!1,className:i="",disabled:s=!1,floating:r=!1,minimized:o=!1,...d},u)=>l.jsxs("label",{className:`
        juno-label 
        ${f} 
        ${r?"juno-label-floating "+c:""}
        ${o?"juno-label-minimized "+p:""}
        ${s?"juno-label-disabled "+j:""} 
        ${i}
