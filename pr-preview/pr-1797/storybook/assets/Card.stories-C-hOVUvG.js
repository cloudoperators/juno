...
`,c=`jn:p-4`,l=(0,i.forwardRef)(({children:e,padding:t=!1,className:n=``,href:r,onClick:i,disabled:l=!1,...u},d)=>{let f=`juno-card ${o} ${(r||i)&&!l?s:``} ${t?c:``} ${n} ${l?`jn:cursor-not-allowed`:``}`,p=e=>{if(l){e.preventDefault();return}i?.(e)};return r?(0,a.jsx)(`a`,{ref:d,href:l?void 0:r,className:`${f} jn:block jn:text-inherit`,onClick:p,"aria-disabled":l?!0:void 0,tabIndex:l?-1:void 0,...u,children:e}):i?(0,a.jsx)(`button`,{ref:d,type:`button`,className:`${f} jn:text-left`,onClick:p,disabled:l,...u,children:e}):(0,a.jsx)(`div`,{ref:d,className:f,...u,children:e})}),l.displayName=`Card`;try{l.displayName=`Card`,l.__docgenInfo={description:`The \`Card\` component acts as a versatile container for various types of content, providing
...
}`,...v.parameters?.docs?.source}}},y=[`Default`,`WithClickEvent`,`WithHref`,`WithHrefAndClickEvent`,`Disabled`,`WithoutPadding`,`InteractiveHover`]}))();export{f as Default,g as Disabled,v as InteractiveHover,p as WithClickEvent,m as WithHref,h as WithHrefAndClickEvent,_ as WithoutPadding,y as __namedExportsOrder,d as default};