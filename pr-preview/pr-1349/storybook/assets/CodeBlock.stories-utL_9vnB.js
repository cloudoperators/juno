import{j as e,r as i}from"./iframe-CpLPiwR6.js";import{C as E}from"./CodeBlock.component-Cxtvkcid.js";import{T as D,a as F}from"./TabList.component-NWTpFhem.js";import{T as B}from"./Tab.component-DQ07Dnia.js";import{T as m}from"./TabPanel.component-LFLfCaoR.js";import"./preload-helper-PPVm8Dsz.js";import"./JsonViewer.component-DEGjDx13.js";import"./SearchInput.component-Ct9_cKSy.js";import"./Icon.component-D5LjExGT.js";import"./Stack.component-ST0rz5pk.js";import"./TabPanel-Din-dVIT.js";const p=({tabs:c,codeBlocks:l})=>e.jsxs(D,{variant:"codeblocks",children:[e.jsx(F,{children:c.map((d,A)=>i.createElement(B,{...d,key:`t-${A}`}))}),l.map((d,A)=>e.jsx(m,{children:e.jsx(E,{...d})},A))]}),j={title:"Components/CodeBlock",component:E,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
