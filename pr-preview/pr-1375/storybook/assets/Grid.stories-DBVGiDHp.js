import{j as n}from"./iframe-CFsHabiD.js";import{G as r}from"./GridRow.component-BQ6XRkm_.js";import{G as o}from"./GridColumn.component-Dn5xQ9JX.js";import"./preload-helper-PPVm8Dsz.js";const G={"--grid-column-flex-grow":"1","--grid-column-flex-shrink":"0","--grid-column-flex-basis":"0","--grid-column-default-width":"auto"},e=({auto:l=!1,children:c,className:a="",...t})=>{const C=l?G:{};return n.jsx("div",{className:`juno-grid ${a}`,style:C,...t,children:c})};try{e.displayName="Grid",e.__docgenInfo={description:`A general-use grid component.
