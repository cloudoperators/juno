...
console.log(greeting)`,k={name:`CodeBlock with Custom Footer (no Copy)`,parameters:{docs:{description:{story:"Pass content into `codeBlockFooter` to add custom actions to the footer bar. Here a Download icon is shown with `copy={false}` to hide the Copy button."}}},render:()=>(0,v.jsx)(s,{content:O,copy:!1,codeBlockFooter:(0,v.jsx)(i,{icon:`download`,onClick:(0,g.useCallback)(()=>{let e=new Blob([O],{type:`text/plain`}),t=URL.createObjectURL(e),n=document.createElement(`a`);n.href=t,n.download=`code.txt`,n.click(),URL.revokeObjectURL(t)},[])})})},A={name:`CodeBlock with Custom Footer and Copy`,parameters:{docs:{description:{story:"Pass content into `codeBlockFooter` and keep `copy={true}` (the default) to show custom actions and the Copy button together in one bar. The tooltip confirmation floats above and does not affect layout."}}},render:()=>(0,v.jsx)(s,{content:O,codeBlockFooter:(0,v.jsx)(i,{icon:`download`,onClick:(0,g.useCallback)(()=>{let e=new Blob([O],{type:`text/plain`}),t=URL.createObjectURL(e),n=document.createElement(`a`);n.href=t,n.download=`code.txt`,n.click(),URL.revokeObjectURL(t)},[])})})},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
