import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-IGKVQItS.js";import{t as r}from"./react-dom-Ey92KDtl.js";import{t as i}from"./jsx-runtime-O9QVJvLM.js";import{r as a,t as o}from"./Icon.component-BQYFU-Ig.js";import{t as s}from"./Icon-CRAVjTSI.js";import{r as c}from"./PortalProvider.component-Do0ZvEjj.js";import{t as l}from"./PortalProvider-Bar7CbH7.js";import{_ as u,d as ee,h as te,i as ne,m as re,n as ie,p as ae,r as oe,s as se,t as ce}from"./floating-ui.react-4hDaIhtu.js";import{t as le}from"./Spinner.component-BLgbJicd.js";import{t as d}from"./Spinner-B1wDQ7Ft.js";import{t as ue}from"./Label.component-CXheOpeM.js";import{t as f}from"./Label-CGpbtceF.js";import{t as p}from"./FormHint.component-CUGIRvK-.js";import{t as m}from"./FormHint-C9CYRumS.js";import{_ as de,f as fe,h as pe,m as me,p as he,t as h}from"./headlessui.esm-XR6roQ2G.js";var g,_,v,ge,_e,ve,ye,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P=t((()=>{g=e(n()),h(),ce(),f(),m(),s(),d(),l(),_=e(r()),v=i(),ge=`
  jn:relative
`,_e=`
...
`,M=(0,g.createContext)(void 0),N=({ariaLabel:e,children:t,className:n=``,defaultValue:r=``,disabled:i=!1,error:a=!1,errortext:s=``,helptext:l=``,id:ce=``,invalid:d=!1,loading:f=!1,label:m,name:he=``,onBlur:h,onChange:N,onFocus:P,onInputChange:F,placeholder:I=`Select…`,required:L=!1,successtext:R=``,truncateOptions:z=!1,valid:B=!1,value:V=``,valueLabel:H,width:U=`full`,wrapperClassName:W=``,...be})=>{let G=e=>!(typeof e==`string`&&e.trim().length===0),xe=ce||`juno-combobox-`+(0,g.useId)(),Se=`juno-combobox-helptext-`+(0,g.useId)(),[K,q]=(0,g.useState)(!1),[Ce,we]=(0,g.useState)(new Map),[J,Te]=(0,g.useState)(``),[Y,Ee]=(0,g.useState)(V),[X,De]=(0,g.useState)(!1),[Z,Oe]=(0,g.useState)(!1),[ke,Ae]=(0,g.useState)(!1),[Q,je]=(0,g.useState)(!1),[$,Me]=(0,g.useState)(!1),{x:Ne,y:Pe,strategy:Fe,refs:Ie,context:Le}=ne({open:K,onOpenChange:q,placement:`bottom-start`,middleware:[ae(4),re(),ee(),te({apply({availableWidth:e,availableHeight:t,elements:n,rects:r}){Object.assign(n.floating.style,{maxWidth:`${e}px`,maxHeight:`${t}px`,minWidth:`${r.reference.width}px`,overflowY:`auto`})}})],whileElementsMounted:u}),{getReferenceProps:Re,getFloatingProps:ze}=se([ie(Le),oe(Le)]),Be=(e,t,n)=>{we(r=>new Map([...Array.from(r),[e??n,{val:e,label:t,children:n}]]))},Ve=(0,g.useMemo)(()=>d||!!(s&&G(s)),[d,s]),He=(0,g.useMemo)(()=>B||!!(R&&G(R)),[B,R]);(0,g.useEffect)(()=>{Ee(V)},[V]),(0,g.useEffect)(()=>{Oe(a)},[a]),(0,g.useEffect)(()=>{De(f)},[f]),(0,g.useEffect)(()=>{je(Ve)},[Ve]),(0,g.useEffect)(()=>{Me(He)},[He]);let Ue=e=>{let t=e||``;Ee(t),t&&q(!1),N&&N(t)},We=e=>{Te(e?.target?.value),F&&F(e)},Ge=e=>{Ae(!0),K||q(!0),P&&P(e)},Ke=e=>{Ae(!1),q(!1),h&&h(e)},qe=c(),Je=J===``?g.Children.toArray(t):g.Children.toArray(t).filter(e=>(0,g.isValidElement)(e)?(e.props.children?.toString()||e.props.label||e.props.value)?.toLowerCase().includes(J.toLowerCase()):!1),Ye=e=>{let t=e=>e==null||typeof e==`object`&&String(e)===`[object Object]`?``:String(e),n=Ce.get(e);return n?.children&&t(n.children)||n?.label||H||t(e)||``};return(0,v.jsx)(M.Provider,{value:{selectedValue:Y,truncateOptions:z,addOptionValueAndLabel:Be},children:(0,v.jsxs)(`div`,{className:`
          juno-combobox-wrapper
          jn:relative
          ${U==`auto`?`jn:inline-block`:`jn:block`}
          ${U==`auto`?`jn:w-auto`:`jn:w-full`}
          ${W}
        `,children:[(0,v.jsx)(me,{defaultValue:r,disabled:i||X||Z,name:he,onChange:Ue,value:Y||r,as:`div`,...be,children:({open:t})=>((0,g.useEffect)(()=>{t!==K&&q(t)},[t]),(0,v.jsxs)(v.Fragment,{children:[(0,v.jsxs)(`div`,{ref:Ie.setReference,className:`
                juno-combobox-input-wrapper
                ${ge}
                ${i?`jn:cursor-not-allowed`:``}
              `,children:[m&&G(m)&&!X&&!Z?(0,v.jsx)(ue,{text:m,disabled:i,required:L,htmlFor:xe,className:`${_e}`,floating:!0,minimized:!!(I||ke||J&&G(J)||Y&&G(Y)),...Re()}):``,(0,v.jsx)(de,{autoComplete:`off`,"aria-label":e||m,"aria-describedby":l?Se:``,id:xe,onBlur:Ke,onChange:We,onFocus:Ge,placeholder:!X&&!Z?I:``,displayValue:e=>Ye(e),className:`
                  juno-combobox-input 
                  ${ve} 
                  ${m&&G(m)?ye:y}
                  ${i?b:``}
