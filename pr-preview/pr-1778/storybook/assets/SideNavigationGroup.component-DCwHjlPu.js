import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-CmJWSAiZ.js";import{t as r}from"./jsx-runtime-O9QVJvLM.js";import{i,r as a}from"./SideNavigationItem.component-IB5sjvOc.js";import{t as o}from"./Icon.component-CZMlXd2l.js";import{t as s}from"./Icon-Cfk7q5R3.js";var c,l,u,d,f,p,m,h=t((()=>{c=e(n()),s(),i(),l=r(),u=`
  jn:flex
  jn:items-start
  jn:justify-between
  jn:pl-[0.5rem]
...
`,p=`
  ...
  jn:items-center
  jn:min-h-[1.875rem]
`,m=({children:e,label:t=``,open:n=!1})=>{let[r,i]=(0,c.useState)(n);(0,c.useEffect)(()=>{i(n)},[n]);let s=e=>{e.stopPropagation(),i(!r)},m=!!e&&c.Children.count(e)>0,h=()=>m?(0,l.jsx)(`span`,{className:p,"aria-hidden":`true`,children:(0,l.jsx)(o,{size:`24`,icon:r?`expandMore`:`chevronRight`})}):null,g=()=>(0,l.jsx)(`span`,{className:d,children:(0,l.jsx)(`span`,{className:f,children:t})});return(0,l.jsxs)(l.Fragment,{children:[(()=>{let e=`juno-sidenavigation-group ${u} ${r?`juno-sidenavigation-group-open`:``}`;return m?(0,l.jsxs)(`button`,{type:`button`,onClick:s,"aria-expanded":r,className:e,children:[g(),h()]}):(0,l.jsx)(`div`,{className:e,children:g()})})(),r&&(0,l.jsx)(a.Provider,{value:1,children:e})]})};try{m.displayName=`SideNavigationGroup`,m.__docgenInfo={description:`SideNavigationGroup is a component designed to encapsulate and organize multiple
