import{j as e}from"./jsx-runtime-D6fbYt3N.js";import{r as t}from"./index-DysCNOs_.js";import{I as i}from"./Icon.component-AKbg8iWE.js";import{S as $}from"./Spinner.component-a74gjTKo.js";const k=`
  jn-w-full
  jn-bg-theme-select
  jn-text-theme-high
  jn-appearance-none
...
`,R="jn-opacity-50",D="jn-border jn-border-theme-error",H="jn-border jn-border-theme-success",s={loading:`
    jn-absolute
    jn-top-0
    jn-right-0
    jn-bottom-0
  ...
  `,error:`
    ...
    jn-select-none
    jn-cursor-not-allowed
  `,loadingSpinner:"jn-ml-auto jn-mr-auto",errorIcon:"jn-ml-auto jn-mr-auto",paddingIconRight:"jn-pr-[3.75rem]",paddingDefaultRight:"jn-pr-9"},G=({isLoading:n,hasError:l,isInvalid:o,isValid:r,disabled:a})=>n?e.jsx("div",{className:`juno-select-loading ${s.loading}`,children:e.jsx($,{className:s.loadingSpinner})}):l?e.jsx("div",{className:`juno-select-error-text ${s.error}`,children:e.jsx(i,{icon:"errorOutline",color:"jn-text-theme-error",className:s.errorIcon})}):e.jsxs("div",{className:`${T} ${a?R:""}`,children:[o&&e.jsx(i,{icon:"dangerous",color:"jn-text-theme-error"}),r&&e.jsx(i,{icon:"checkCircle",color:"jn-text-theme-success"}),e.jsx(i,{icon:"expandMore"})]}),y=({name:n="Unnamed Select",id:l="",children:o,className:r="",disabled:a=!1,invalid:c=!1,valid:d=!1,loading:u=!1,error:p=!1,onChange:g,onClick:v,wrapperClassName:S="",...N})=>{const[b,C]=t.useState(u),[m,w]=t.useState(d),[h,E]=t.useState(c),[f,I]=t.useState(p);t.useEffect(()=>C(u),[u]),t.useEffect(()=>w(d),[d]),t.useEffect(()=>E(c),[c]),t.useEffect(()=>I(p),[p]);const V=j=>g&&g(j),q=j=>v&&v(j),_=m||h?s.paddingIconRight:s.paddingDefaultRight;return e.jsxs("div",{className:`juno-select-wrapper ${O} ${S}`,children:[e.jsx("select",{name:n,id:l,className:`
          juno-select
          ${k}
          ${h?"juno-select-invalid "+D:""}
          ${m?"juno-select-valid "+H:""}
          ${f?"juno-select-error":""}
          ${_}
          ${r}
        `,onChange:V,onClick:q,disabled:a||b||f,...N,children:o}),e.jsx(G,{isLoading:b,hasError:f,isInvalid:h,isValid:m,disabled:a})]})};try{y.displayName="NativeSelect",y.__docgenInfo={description:`A basic, uncontrolled native HTML select component.
...
Triggered when the user changes the selected option.`,name:"onChange",required:!1,type:{name:"((event: ChangeEvent<HTMLSelectElement>) => void)"}},onClick:{defaultValue:null,description:`Event handler for the click event on the select element.
Triggered when the user clicks on the select element.`,name:"onClick",required:!1,type:{name:"((event: MouseEvent<HTMLSelectElement, MouseEvent>) => void)"}},wrapperClassName:{defaultValue:{value:""},description:"Additional CSS classes to apply to the outer wrapper of the select component for custom styling.",name:"wrapperClassName",required:!1,type:{name:"string"}}}}}catch{}const x=({label:n="",disabled:l=!1,className:o="",children:r,...a})=>e.jsx("optgroup",{label:n,disabled:l,className:`juno-select-option-group ${o}`,...a,children:r});try{x.displayName="NativeSelectOptionGroup",x.__docgenInfo={description:`The NativeSelectOptionGroup component groups related options within a dropdown list.
