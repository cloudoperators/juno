import{j as o}from"./jsx-runtime-D6fbYt3N.js";const i=`
  jn-text-xs
  jn-mt-1
...
Overridden by children, if provided.`,name:"text",required:!1,type:{name:"ReactNode"}},variant:{defaultValue:{value:"help"},description:'The variant of the hint ("help", "error", or "success") determining its appearance.',name:"variant",required:!1,type:{name:"enum",value:[{value:'"error"'},{value:'"help"'},{value:'"success"'}]}},className:{defaultValue:{value:""},description:"Additional CSS classes to apply to the form hint for custom styling.",name:"className",required:!1,type:{name:"string"}}}}}catch{}export{t as F};
