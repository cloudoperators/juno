import{j as l}from"./jsx-runtime-BP6H2k8O.js";import{e as D}from"./index-DysCNOs_.js";import{P as t}from"./index-BHU3UH5b.js";import{C as O}from"./ContentArea.component-DnOmP0K3.js";import{C as W}from"./ContentAreaToolbar.component-DDPqWSOu.js";import{I as _,k as L}from"./Icon.component-D0Qkx-jp.js";import{S as M}from"./Spinner.component-BxCg6Jvm.js";import"./withDeprecationWarning.component-xP4XCk2p.js";import"./widgets-BR6-ubtP.js";const E=`
  jn-relative
  jn-grow
  jn-flex
  jn-flex-col
  jn-overflow-hidden
`,r=({className:e="",children:n,...o})=>l.jsx("div",{className:`juno-content-area-wrapper ${E} ${e}`,...o,children:n});r.propTypes={className:t.string,children:t.node};r.__docgenInfo={description:"Deprecated: Will be deleted!",methods:[],displayName:"ContentAreaWrapper",props:{className:{defaultValue:{value:'""',computed:!1},description:"Add custom class name",type:{name:"string"},required:!1},children:{description:"",type:{name:"node"},required:!1}}};const w=`
  jn-font-bold
  jn-inline-flex 
  jn-justify-center 
  jn-items-center
...
`,U=`
  jn-mr-2
`,K=e=>e==="small"?`${J}`:`${U}`,A=e=>e?"in-progress":"",Q=e=>{switch(e){case"default":return"jn-text-theme-accent";case"primary":return"jn-text-white";case"primary-danger":return"jn-text-white";default:return""}},c=D.forwardRef(({label:e,title:n=null,variant:o,size:a="default",disabled:m=null,href:f=null,icon:v=null,className:b="",onClick:d,children:h,progress:s=!1,progressLabel:j="",...y},g)=>{const i=o||"default",p=n||e||"",x=s?l.jsx(M,{size:a==="small"?"1.125rem":"1.5rem",color:`${Q(i)}`}):v?l.jsx(_,{icon:v,title:p,className:`juno-button-icon ${e||h?K(a):""} `,size:a==="small"?"1.125rem":"1.5rem"}):null,C=s&&j?j:e||h,V=P=>{d&&d(P)},I=l.jsxs("button",{type:"button",className:`
          juno-button 
          juno-button-${i} 
          juno-button-${a}-size 
          ${w} 
          ...
          ${S(a,o)}
          ${A(s)} 
          ${b}`,disabled:m,onClick:V,title:p,ref:g,...y,children:[x,C]}),k=l.jsxs("a",{href:f,role:"button",className:`
          juno-button 
          juno-button-${i} 
          juno-button-${a}-size 
          ${w} 
