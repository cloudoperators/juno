import{j as e,r as i}from"./iframe-v4tQulfF.js";import{C as E}from"./CodeBlock.component-C71NYI1O.js";import{T as D,a as F}from"./TabList.component-EFq0unqB.js";import{T as B}from"./Tab.component-DaRA1ODe.js";import{T as m}from"./TabPanel.component--eAc6cgc.js";import"./preload-helper-PPVm8Dsz.js";import"./JsonViewer.component-BeKkYAnP.js";import"./SearchInput.component-C6aO7KCJ.js";import"./Icon.component-CcrIwlu0.js";import"./Stack.component-jn_bwKPH.js";import"./TabPanel-ByHclIYs.js";const p=({tabs:c,codeBlocks:l})=>e.jsxs(D,{variant:"codeblocks",children:[e.jsx(F,{children:c.map((d,A)=>i.createElement(B,{...d,key:`t-${A}`}))}),l.map((d,A)=>e.jsx(m,{children:e.jsx(E,{...d})},A))]}),j={title:"Components/CodeBlock",component:E,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
