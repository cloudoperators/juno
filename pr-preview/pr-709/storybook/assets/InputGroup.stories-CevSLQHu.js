import{j as e}from"./jsx-runtime-D6fbYt3N.js";import{e as F,r as z}from"./index-DysCNOs_.js";import{S as H}from"./Stack.component-B4IgElTG.js";import{B as t}from"./Button.component-CmJwcgRM.js";import{T as y}from"./TextInput.component-DqP2LCkn.js";import"./Icon.component-C0iYw0aN.js";import"./widgets-BR6-ubtP.js";import"./Spinner.component-DoH1gaBh.js";import"./Label.component-D1jWKEjF.js";import"./FormHint.component-BZc1fwDf.js";const J=(r,n,a)=>{if(!z.isValidElement(r))return r;const o={variant:r.props.variant||n,disabled:r.props.disabled||a};return F.cloneElement(r,o)},K=(r,n,a)=>`
    ${r}-${n}
    ${a?`${r}-disabled`:""}
  `,B=({children:r=null,className:n="",variant:a="default",disabled:o=!1,...L})=>{const M=F.Children.map(r,O=>J(O,a,o)),A=K("juno-input-group",a,o);return e.jsx(H,{className:`juno-input-group ${A} ${n}`,...L,children:M})};try{B.displayName="InputGroup",B.__docgenInfo={description:`InputGroup is a component used to visually group related elements such as
Buttons, TextInput, and Select elements, providing a cohesive styling approach.`,displayName:"InputGroup",props:{children:{defaultValue:{value:"null"},description:`The children to render within the InputGroup.
