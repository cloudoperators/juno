import{j as e}from"./jsx-runtime-D6fbYt3N.js";import{B as r}from"./BreadcrumbItem.component-B9lj9gIk.js";import{r as h,e as m}from"./index-DysCNOs_.js";import{I}from"./Icon.component-C2yU3WBp.js";import{S as y}from"./Stack.component-B4IgElTG.js";import"./widgets-BR6-ubtP.js";const o=({children:a,className:n="",...u})=>{const c=h.Children.toArray(a).filter(m.isValidElement),p=c.map((b,s)=>e.jsxs(m.Fragment,{children:[e.jsx(r,{...b.props}),s<c.length-1&&e.jsx(I,{icon:"chevronRight"})]},s));return e.jsx(y,{className:`juno-breadcrumb ${n}`,gap:"1",...u,children:p})};try{o.displayName="Breadcrumb",o.__docgenInfo={description:`Breadcrumb is a component that structures navigational links in a breadcrumb trail.
