import{j as e,r as W}from"./iframe-B-LWM0em.js";import{C as x}from"./CodeBlock.component-CXZtD5HS.js";import{T as S,a as J}from"./TabList.component-DnIKdVKn.js";import{T as R}from"./Tab.component-B4DFq2z3.js";import{T as P}from"./TabPanel.component-CSaafV8r.js";import"./JsonViewer.component-BVFgCAA8.js";import"./SearchInput.component-Caj5sG5j.js";import"./Icon.component-DVKIIcy7.js";import"./Stack.component-BNf355DM.js";import"./TabPanel-6UErwaEc.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
