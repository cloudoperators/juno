import{r as h,e as m,j as e}from"./iframe-B-LWM0em.js";import{B as r}from"./BreadcrumbItem.component-DYMtooFl.js";import{I}from"./Icon.component-DVKIIcy7.js";import{S as y}from"./Stack.component-BNf355DM.js";const n=({children:a,className:c="",...u})=>{const o=h.Children.toArray(a).filter(m.isValidElement),p=o.map((b,s)=>e.jsxs(m.Fragment,{children:[e.jsx(r,{...b.props}),s<o.length-1&&e.jsx(I,{icon:"chevronRight"})]},s));return e.jsx(y,{className:`juno-breadcrumb ${c}`,gap:"1",...u,children:p})};try{n.displayName="Breadcrumb",n.__docgenInfo={description:`Breadcrumb is a component that structures navigational links in a breadcrumb trail.
