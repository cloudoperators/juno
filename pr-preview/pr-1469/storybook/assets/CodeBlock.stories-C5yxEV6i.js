import{j as e,r as i}from"./iframe-BEb8cl8Z.js";import{C as E}from"./CodeBlock.component-roOKVds-.js";import{T as D,a as F}from"./TabList.component-BKHtl3eA.js";import{T as B}from"./Tab.component-XkC1cwBo.js";import{T as m}from"./TabPanel.component-zmeNiLpU.js";import"./preload-helper-PPVm8Dsz.js";import"./JsonViewer.component-CO-CLjdx.js";import"./SearchInput.component-B9oM8l0m.js";import"./Icon.component-cm9a0uqc.js";import"./Stack.component-CFztSbLF.js";import"./TabPanel-DfiCnpgC.js";const p=({tabs:c,codeBlocks:l})=>e.jsxs(D,{variant:"codeblocks",children:[e.jsx(F,{children:c.map((d,A)=>i.createElement(B,{...d,key:`t-${A}`}))}),l.map((d,A)=>e.jsx(m,{children:e.jsx(E,{...d})},A))]}),j={title:"Components/CodeBlock",component:E,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
