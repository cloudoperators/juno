import{r as e,j as a}from"./iframe-C1z8P0kA.js";import{L as J}from"./Label.component-BXkFTrUX.js";import{I as E}from"./Icon.component-D5zf-z5f.js";import{F as h}from"./FormHint.component-BkvPwcf5.js";const K=`
...
`,T=({value:o="",id:F="",name:S,placeholder:j="",disabled:d=!1,readOnly:P=!1,required:C=!1,invalid:y=!1,valid:x=!1,autoFocus:L=!1,className:R="",autoComplete:_="off",helptext:p="",successtext:n="",errortext:l="",onChange:b,onFocus:g,onBlur:q,type:H,label:u,width:c="full",wrapperClassName:A="",...M})=>{const s=t=>!(typeof t=="string"&&t.trim().length===0),W=()=>"juno-textinput-"+e.useId(),V=e.useRef(null),[f,w]=e.useState(""),[k,m]=e.useState(!1),[i,B]=e.useState(!1),[r,O]=e.useState(!1);e.useEffect(()=>{document.hasFocus()&&V.current.contains(document.activeElement)&&m(!0)},[]),e.useEffect(()=>{w(o)},[o]);const I=e.useMemo(()=>y||!!(l&&s(l)),[y,l]),N=e.useMemo(()=>x||!!(n&&s(n)),[x,n]);e.useEffect(()=>{B(I)},[I]),e.useEffect(()=>{O(N)},[N]);const z=t=>{w(t.target.value),b&&b(t)},D=t=>{m(!0),g&&g(t)},U=t=>{m(!1),q&&q(t)},G=({disabled:t})=>r||i?a.jsxs("div",{className:`juno-textinput-row-icon-container ${ne} ${t?le:""}`,children:[i?a.jsx(E,{icon:"dangerous",color:"jn:text-theme-error"}):null,r?a.jsx(E,{icon:"checkCircle",color:"jn:text-theme-success"}):null]}):"",$=F||W();return a.jsxs("div",{className:"juno-textinput-outer-wrapper",children:[a.jsxs("span",{className:`
          ...
          `,children:[a.jsx("input",{type:H,name:S,autoComplete:_,value:f,id:$,ref:V,placeholder:j,disabled:d,readOnly:P,autoFocus:L,onChange:z,onFocus:D,onBlur:U,className:`juno-textinput 
            ...
            ${c=="auto"?"jn:w-auto":"jn:w-full"}
            ${R}
          `,...M}),u&&u.length?a.jsx(J,{text:u,htmlFor:$,className:`${ae}`,disabled:d,required:C,floating:!0,minimized:!!(j||k||f&&s(f))}):"",a.jsx(G,{disabled:d})]}),l&&s(l)?a.jsx(h,{text:l,variant:"error",className:`${v}`}):"",n&&s(n)?a.jsx(h,{text:n,variant:"success",className:`${v}`}):"",p&&s(p)?a.jsx(h,{text:p,className:`${v}`}):""]})};try{T.displayName="TextInput",T.__docgenInfo={description:`A controlled Text Input.
