import{j as e,r as W}from"./iframe-DlbXkkhY.js";import{C as x}from"./CodeBlock.component-BU5bdLar.js";import{T as S,a as J}from"./TabList.component-wOrZGtMf.js";import{T as R}from"./Tab.component-Da8k3Le2.js";import{T as P}from"./TabPanel.component-BmS75FyB.js";import"./JsonViewer.component-CsklDVyh.js";import"./SearchInput.component-Q2pR6OQp.js";import"./Icon.component-BSv4oWQ5.js";import"./Stack.component-BQ6OqSoq.js";import"./TabPanel-DN3QB69J.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
