import{j as e,r as W}from"./iframe-DA9dkm6G.js";import{C as x}from"./CodeBlock.component-BDVlB9nZ.js";import{T as S,a as J}from"./TabList.component-cb1enso9.js";import{T as R}from"./Tab.component-Cee9zggw.js";import{T as P}from"./TabPanel.component-B4kEm-jM.js";import"./JsonViewer.component-CXh6jRUf.js";import"./SearchInput.component-CmxexCin.js";import"./Icon.component-BMfVSm4V.js";import"./Stack.component-BSKM1e-f.js";import"./TabPanel-eL3mBO7U.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
