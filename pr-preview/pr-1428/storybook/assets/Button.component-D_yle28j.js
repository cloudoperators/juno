import{e as A,j as l}from"./iframe-DnjCMMu2.js";import{I}from"./Icon.component-CgXwGdZP.js";import{S as N}from"./Spinner.component-nxQeiveP.js";const y=`
  jn:font-bold
  jn:inline-flex 
  jn:justify-center 
  jn:items-center
...
`,W=e=>e==="small"?`${E}`:`${R}`,B=e=>e?"in-progress":"",O=e=>{switch(e){case"default":return"jn:text-theme-accent";case"primary":return"jn:text-white";case"primary-danger":return"jn:text-white";default:return""}},s=A.forwardRef(({label:e,title:a,variant:n="default",size:t="default",disabled:i,href:d,icon:c,className:m="",onClick:o,children:v,progress:u=!1,progressLabel:b="",...p},f)=>{const r=a||e||"",h=u?l.jsx(N,{size:t==="small"?"1.125rem":"1.5rem",color:`${O(n)}`}):c?l.jsx(I,{icon:c,title:r,className:`juno-button-icon ${e||v?W(t):""} `,size:t==="small"?"1.125rem":"1.5rem"}):null,j=u&&b?b:e||v,S=D=>{o&&o(D)},V=l.jsxs("button",{className:`
          ...
          ${C(n)}
          ${B(u)} 
          ${m}`,disabled:i||void 0,onClick:S,ref:f,...p,type:"button",title:r,children:[h,j]}),q=l.jsxs("a",{href:d||void 0,role:"button",className:`
          juno-button 
          juno-button-${n} 
          juno-button-${t}-size 
          ${y} 
