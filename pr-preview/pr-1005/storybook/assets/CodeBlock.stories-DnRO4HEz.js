import{j as e,r as W}from"./iframe-CLlYSCdk.js";import{C as x}from"./CodeBlock.component-BpkdeZXQ.js";import{T as S,a as J}from"./TabList.component-DVaW7kml.js";import{T as R}from"./Tab.component-DLrGPEHg.js";import{T as P}from"./TabPanel.component-Bo326ui2.js";import"./JsonViewer.component-D-JHlHfq.js";import"./SearchInput.component-BBq4ouLJ.js";import"./Icon.component-DdDTKhO_.js";import"./Stack.component-cqwmpsoz.js";import"./TabPanel-wmSdYcfF.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
