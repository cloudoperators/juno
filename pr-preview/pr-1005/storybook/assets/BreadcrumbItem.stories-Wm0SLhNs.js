import{j as T}from"./jsx-runtime-D_zvdyIk.js";import{K as D}from"./Icon.component-CLN6PgZk.js";import{B as v}from"./BreadcrumbItem.component-CEYTpyuO.js";import"./index-DI7CEG0L.js";const e=A=>T.jsx(v,{...A}),x=Object.keys(D),O={title:"Components/Breadcrumb/BreadcrumbItem",component:v,argTypes:{icon:{options:x,control:{type:"select"}},children:{control:!1}}},r={render:e,parameters:{docs:{description:{story:"A default breadcrumb item"}}},args:{label:"Breadcrumb Item"}},a={render:e,parameters:{docs:{description:{story:"Pass any available icon name to render an additional icon for the item."}}},args:{icon:"place",label:"Breadcrumb Item with Icon"}},n={render:e,parameters:{docs:{description:{story:"An active item represents the current page."}}},args:{label:"Active Breadcrumb Item",active:!0}},t={render:e,parameters:{docs:{description:{story:"A disabled breadcrumb item."}}},args:{label:"Disabled Breadcrumb Item",disabled:!0}},s={render:e,parameters:{docs:{description:{story:"Typically the first item in a breadcrumb."}}},args:{label:"",icon:"home"}};var o,c,m;r.parameters={...r.parameters,docs:{...(o=r.parameters)==null?void 0:o.docs,source:{originalSource:`{
  render: Template,
  parameters: {
    docs: {
      description: {
...
}`,...(B=(h=s.parameters)==null?void 0:h.docs)==null?void 0:B.source}}};const _=["Default","WithIcon","Active","Disabled","Home"];export{n as Active,r as Default,t as Disabled,s as Home,a as WithIcon,_ as __namedExportsOrder,O as default};
