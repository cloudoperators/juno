import{I as b,K as x}from"./Icon.component-BfVPoplv.js";import{j as v}from"./iframe-Bh6tr8C8.js";const w=`
  jn:rounded
  jn:text-sm
...
If a string is provided and it's a valid icon name, that icon will be displayed.`,name:"icon",required:!1,type:{name:'boolean | "info" | "warning" | "danger" | "error" | "success" | "search" | "default" | "download" | "accessTime" | "accountCircle" | "addCircle" | "autoAwesomeMosaic" | "autoAwesomeMotion" | ... 42 more ...'}},text:{defaultValue:{value:""},description:`Pass an optional string of text to be rendered as content.
