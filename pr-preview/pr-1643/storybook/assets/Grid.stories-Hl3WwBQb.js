import{j as n}from"./iframe-B6Byq8Uj.js";import{G as r}from"./GridRow.component-DRmKWjmk.js";import{G as o}from"./GridColumn.component-DKVHv6jE.js";import"./preload-helper-PPVm8Dsz.js";const G={"--grid-column-flex-grow":"1","--grid-column-flex-shrink":"0","--grid-column-flex-basis":"0","--grid-column-default-width":"auto"},e=({auto:l=!1,children:c,className:a="",...t})=>{const C=l?G:{};return n.jsx("div",{className:`juno-grid ${a}`,style:C,...t,children:c})};try{e.displayName="Grid",e.__docgenInfo={description:"The `Grid` component establishes a customizable grid layout, enabling\nresponsive design. It collaborates with `GridColumn` and `GridRow` for\nflexible arrangement of content.",displayName:"Grid",props:{auto:{defaultValue:{value:"false"},description:`Controls whether columns should auto-size.
