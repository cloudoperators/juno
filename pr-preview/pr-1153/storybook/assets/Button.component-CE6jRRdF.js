import{e as _,j as l}from"./iframe-CLN1yHUE.js";import{I}from"./Icon.component-U6qG85Te.js";import{S as L}from"./Spinner.component-DfmNGz_5.js";const y=`
  jn:font-bold
  jn:inline-flex 
  jn:justify-center 
  jn:items-center
...
`,w=(e,a)=>e==="small"?a==="subdued"?`${k}`:`${M}`:a==="subdued"?`${P}`:`${D}`,C=e=>{switch(e){case"default":return $;case"primary":return T;case"primary-danger":return A;case"subdued":return H;default:return $}},E=`
  jn:mr-2
`,O=`
  jn:mr-2
`,R=e=>e==="small"?`${E}`:`${O}`,B=e=>e?"in-progress":"",W=e=>{switch(e){case"default":return"jn:text-theme-accent";case"primary":return"jn:text-white";case"primary-danger":return"jn:text-white";default:return""}},s=_.forwardRef(({label:e,title:a,variant:n="default",size:t="default",disabled:i,href:d,icon:c,className:m="",onClick:o,children:v,progress:u=!1,progressLabel:b="",...p},f)=>{const r=a||e||"",h=u?l.jsx(L,{size:t==="small"?"1.125rem":"1.5rem",color:`${W(n)}`}):c?l.jsx(I,{icon:c,title:r,className:`juno-button-icon ${e||v?R(t):""} `,size:t==="small"?"1.125rem":"1.5rem"}):null,j=u&&b?b:e||v,V=N=>{o&&o(N)},q=l.jsxs("button",{className:`
          ...
          ${C(n)}
          ${B(u)} 
          ${m}`,disabled:i||void 0,onClick:V,ref:f,...p,type:"button",title:r,"data-row-stop-propagation":!0,children:[h,j]}),S=l.jsxs("a",{href:d||void 0,role:"button",className:`
          juno-button 
          juno-button-${n} 
          juno-button-${t}-size 
          ${y} 
