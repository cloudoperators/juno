import{e as D,j as u}from"./iframe-BRZcYXSx.js";import{I as N}from"./Icon.component-REsXP9ce.js";import{S as _}from"./Spinner.component-C1YjDEcl.js";const y=`
  jn:font-bold
  jn:inline-flex 
  jn:justify-center 
  jn:items-center
...
`,E=`
  jn:mr-2
`,U=e=>e==="small"?`${W}`:`${E}`,B=e=>e?"in-progress":"",O=e=>{switch(e){case"default":return"jn:text-theme-accent";case"primary":return"jn:text-white";case"primary-danger":return"jn:text-white";default:return""}},s=D.forwardRef(({label:e,title:a,variant:n="default",size:t="default",disabled:i,href:d,icon:c,className:m="",onClick:r,children:v,progress:o=!1,progressLabel:b="",...p},h)=>{const l=a||e||"",f=o?u.jsx(_,{size:t==="small"?"1.125rem":"1.5rem",color:`${O(n)}`}):c?u.jsx(N,{icon:c,title:l,className:`juno-button-icon ${e||v?U(t):""} `,size:t==="small"?"1.125rem":"1.5rem"}):null,j=o&&b?b:e||v,S=A=>{r&&r(A)},V=u.jsxs("button",{className:`
          juno-button 
          juno-button-${n} 
          juno-button-${t}-size 
          ${y} 
          ...
          ${C(n)}
          ${B(o)} 
          ${m}`,disabled:i||void 0,onClick:S,ref:h,...p,type:"button",title:l,"data-row-stop-propagation":!0,children:[f,j]}),q=u.jsxs("a",{href:d||void 0,role:"button",className:`
          juno-button 
          juno-button-${n} 
          juno-button-${t}-size 
          ${y} 
