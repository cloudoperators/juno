import{r as a,j as e}from"./iframe-CLN1yHUE.js";import{L as D}from"./Label.component-DpP5GAlw.js";import{I as _}from"./Icon.component-U6qG85Te.js";import{F as g}from"./FormHint.component-2ADBzDCP.js";const Z=`
	jn:mb-4
	jn:last:mb-0
`,ee=`
	jn:relative
...
`,k=a.createContext({}),z=({children:o,className:I="",disabled:r=!1,errortext:t="",helptext:p="",id:S="",invalid:v=!1,label:m="",name:E,onChange:x,required:V=!1,selected:h,successtext:n="",valid:R=!1,...i})=>{const d=s=>!(typeof s=="string"&&s.trim().length===0),l=()=>"juno-radiogroup-"+a.useId(),G=E||l(),j=S||l(),[u,f]=a.useState(h),[y,N]=a.useState(!1),[c,T]=a.useState(!1),b=a.useMemo(()=>R||!!(n&&d(n)),[R,n]),q=a.useMemo(()=>v||!!(t&&d(t)),[v,t]);a.useEffect(()=>{N(b)},[b]),a.useEffect(()=>{T(q)},[q]),a.useEffect(()=>{h&&f(h)},[h]);const W=s=>{f(s)},w=s=>{f(s),x&&x(s)};return e.jsx(k.Provider,{value:{selectedValue:u,name:G,onChange:w,updateSelectedValue:W,disabled:r},children:e.jsxs("div",{className:`
          ...
          ${I}
        `,id:j,role:"radiogroup",...i,children:[m&&d(m)?e.jsx(D,{text:m,htmlFor:j,disabled:r,required:V}):"",e.jsxs("div",{className:`
...
`,O=({checked:o=!1,className:I="",disabled:r=!1,errortext:t="",helptext:p="",id:S,invalid:v=!1,label:m,name:E,onChange:x,onClick:V,required:h=!1,successtext:n="",valid:R=!1,value:i="",...d})=>{const l=C=>!(typeof C=="string"&&C.trim().length===0),G=()=>"juno-radio-"+a.useId(),j=a.useContext(k),{selectedValue:u,onChange:f,name:y,updateSelectedValue:N,disabled:c}=j||{},T=()=>j?u===i:!!o,[b,q]=a.useState(()=>T()),[W,w]=a.useState(!1),[s,U]=a.useState(!1),[$,J]=a.useState(!1),F=a.useMemo(()=>v||!!(t&&l(t)),[v,t]),H=a.useMemo(()=>R||!!(n&&l(n)),[R,n]);a.useEffect(()=>{U(F)},[F]),a.useEffect(()=>{J(H)},[H]),a.useEffect(()=>{o&&j&&u===void 0&&N&&N(i)},[]),a.useEffect(()=>{u||q(o)},[o]);const K=()=>{q(!b),f&&typeof f=="function"&&u!==i&&f(i),x&&x(i)},M=()=>u?u===i:b,Q=C=>{V&&V(C)},X=()=>{w(!0)},Y=()=>{w(!1)},L=S||G();return e.jsxs("div",{className:"jn-radio-outer",children:[e.jsxs("div",{className:`juno-radio-wrapper ${se}`,children:[e.jsxs("div",{className:`
           ...
           `,...d,children:[e.jsx("input",{checked:M(),className:`
              ...
              ${$?"juno-radio-valid":""}
            `,disabled:c||r,id:L,onBlur:Y,onChange:K,onClick:Q,onFocus:X,name:y||E,type:"radio",value:i,"data-row-stop-propagation":!0}),M()?e.jsx("span",{className:`${ie}`,"data-row-stop-propagation":!0}):""]}),m&&l(m)?e.jsxs(e.Fragment,{children:[e.jsx(D,{className:`${me}`,disabled:c||r,htmlFor:L,required:h,text:m}),s?e.jsx(_,{icon:"dangerous",color:"jn:text-theme-error",size:"1.125rem",className:`
                    ${B}
                    ${r?"jn:opacity-50":""}
