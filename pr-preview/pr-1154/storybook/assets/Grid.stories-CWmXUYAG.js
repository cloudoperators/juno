import{j as n}from"./iframe-C6pN-Bcm.js";import{G as r}from"./GridRow.component-Dx14m6Py.js";import{G as o}from"./GridColumn.component-BpVHqi8w.js";import"./preload-helper-D9Z9MdNV.js";const G={"--grid-column-flex-grow":"1","--grid-column-flex-shrink":"0","--grid-column-flex-basis":"0","--grid-column-default-width":"auto"},e=({auto:l=!1,children:c,className:a="",...t})=>{const C=l?G:{};return n.jsx("div",{className:`juno-grid ${a}`,style:C,...t,children:c})};try{e.displayName="Grid",e.__docgenInfo={description:`A general-use grid component.
