import{j as e}from"./jsx-runtime-D-gQZ2Nk.js";import{r as J}from"./index-BXnWnNu-.js";import{C as S}from"./CodeBlock.component-DPZyzjsE.js";import{T as L,a as R}from"./TabList.component-Bn5Q7VTH.js";import{T as P}from"./Tab.component-BpoVuYNC.js";import{T as K}from"./TabPanel.component-DWIUlWqe.js";import"./JsonViewer.component-rG82XkXS.js";import"./SearchInput.component-0SycOwcr.js";import"./Icon.component-uANO5hmX.js";import"./Stack.component-BlUUaGeC.js";import"./TabPanel-B9YjS3EW.js";import"./index-BKNjMPK8.js";const E={args:{label:"A Tab Label",children:"Tab 1"}},Z={title:"Components/CodeBlock",component:S,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},U=({tabs:v,codeBlocks:W})=>e.jsxs(L,{variant:"codeblocks",children:[e.jsx(R,{children:v.map((d,c)=>J.createElement(P,{...d,key:`t-${c}`}))}),W.map((d,c)=>e.jsx(K,{children:e.jsx(S,{...d})},c))]}),n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},o={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
