import{j as e,r as i}from"./iframe-B3vnWwUI.js";import{C as E}from"./CodeBlock.component-l_smc1na.js";import{T as D,a as F}from"./TabList.component-B6nq0bVl.js";import{T as B}from"./Tab.component-3iNiQrGj.js";import{T as m}from"./TabPanel.component-CRLv-W9Q.js";import"./preload-helper-PPVm8Dsz.js";import"./JsonViewer.component-zNczfpvq.js";import"./SearchInput.component--a56_PHz.js";import"./Icon.component-BJfbMbJi.js";import"./Stack.component-Cl4gX8G5.js";import"./TabPanel-b5FuihUW.js";const p=({tabs:c,codeBlocks:l})=>e.jsxs(D,{variant:"codeblocks",children:[e.jsx(F,{children:c.map((d,A)=>i.createElement(B,{...d,key:`t-${A}`}))}),l.map((d,A)=>e.jsx(m,{children:e.jsx(E,{...d})},A))]}),j={title:"Components/CodeBlock",component:E,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
