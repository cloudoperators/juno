import{n as e,o as t}from"./rolldown-runtime-C0FnF6B9.js";import{t as n}from"./react-C21x__mS.js";import{t as r}from"./jsx-runtime-BdxMnOeJ.js";import{r as i,t as a}from"./Icon.component-Mfy7Ncyo.js";import{n as o,t as s}from"./Label.component-DOSKHppz.js";import{n as c,t as l}from"./FormHint.component-CpRixu1s.js";var u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D;function O(){return(O=e((()=>{u=t(n()),o(),i(),c(),d=r(),f=`
    jn:rounded-full
    jn:relative
    jn:p-0
    jn:leading-0
...
`,x=`
    jn:mt-0
`,S=e=>typeof e==`string`&&e.trim().length>0,C=e=>{switch(e){case`small`:return`jn:w-[1.75rem] jn:h-4`;case`large`:return`jn:w-[3.125rem] jn:h-[1.6875rem]`;default:return`jn:w-switch-default jn:h-switch-default`}},w=e=>{switch(e){case`small`:return`jn:w-[0.75rem] jn:h-[0.75rem]`;case`large`:return`jn:w-[1.4375rem] jn:h-[1.4375rem]`;default:return`jn:w-switch-handle-default jn:h-switch-handle-default`}},T=(e,t,n)=>{let r=`1.125rem`,i=`${b} ${n?`jn:opacity-50`:``}`;return e?(0,d.jsx)(a,{icon:`dangerous`,color:`jn:text-theme-error`,size:r,className:i}):t?(0,d.jsx)(a,{icon:`checkCircle`,color:`jn:text-theme-success`,size:r,className:i}):null},E=(e,t,n)=>S(e)?(0,d.jsx)(l,{text:e,variant:`error`,className:x}):S(t)?(0,d.jsx)(l,{text:t,variant:`success`,className:x}):S(n)?(0,d.jsx)(l,{text:n,className:x}):null,D=({name:e=``,id:t=``,label:n,required:r=!1,size:i=`default`,on:a=!1,disabled:o=!1,invalid:c=!1,valid:l=!1,helptext:b=``,errortext:x=``,successtext:D=``,className:O=``,onChange:k,onClick:A,wrapperClassName:j=``,...M})=>{let N=(0,u.useId)(),[P,F]=(0,u.useState)(a),[I,L]=(0,u.useState)(!1),[R,z]=(0,u.useState)(!1);(0,u.useEffect)(()=>{F(a)},[a]);let B=(0,u.useMemo)(()=>c||!!S(x),[c,x]),V=(0,u.useMemo)(()=>l||!!S(D),[l,D]);(0,u.useEffect)(()=>{L(B)},[B]),(0,u.useEffect)(()=>{z(V)},[V]);let H=e=>{F(!P),A&&A(e),k&&k(e)},U=t||`juno-switch-`+N;return(0,d.jsxs)(`div`,{children:[(0,d.jsxs)(`span`,{className:`
          juno-switch-wrapper 
          ${m}
          ${j}
