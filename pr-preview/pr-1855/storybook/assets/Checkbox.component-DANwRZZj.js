import{n as e,o as t}from"./rolldown-runtime-C0FnF6B9.js";import{t as n}from"./react-C21x__mS.js";import{t as r}from"./jsx-runtime-BdxMnOeJ.js";import{t as i}from"./Icon.component-B4rrvWVV.js";import{t as a}from"./Icon-C1gNJsPD.js";import{t as o}from"./Label.component-DOSKHppz.js";import{t as s}from"./Label-DvnYklPU.js";import{t as c}from"./FormHint.component-CpRixu1s.js";import{t as l}from"./FormHint-C8bI7riU.js";var u,d,f,p,m,h,g,_,v,y;function b(){return(b=e((()=>{u=t(n()),s(),a(),l(),d=r(),f=`
  jn:mb-4
  jn:last:mb-0
`,p=`
  jn:relative
...
`,_=`
  ...
  jn:right-2
  jn:top-1.5
`,v=(0,u.createContext)(void 0),y=({children:e,className:t=``,disabled:n=!1,errortext:r=``,helptext:a=``,id:s=``,invalid:l=!1,label:y,name:b=``,onChange:x,required:S=!1,selected:C,successtext:w=``,valid:T=!1,...E})=>{let D=e=>typeof e!=`string`||e.trim().length!==0,O=(0,u.useId)(),k=(0,u.useId)(),A=b||`juno-checkboxgroup-`+O,j=s||`juno-checkboxgroup-`+k,[M,N]=(0,u.useState)(C),[P,F]=(0,u.useState)(!1),[I,L]=(0,u.useState)(!1),R=(0,u.useMemo)(()=>T||!!(w&&D(w)),[T,w]),z=(0,u.useMemo)(()=>l||!!(r&&D(r)),[l,r]);return(0,u.useEffect)(()=>{C&&N(C)},[C]),(0,u.useEffect)(()=>{F(R)},[R]),(0,u.useEffect)(()=>{L(z)},[z]),(0,d.jsx)(v.Provider,{value:{selectedOptions:M,name:A,disabled:n,handleCheckboxChange:e=>{let t=e;M&&M.includes(e)?N(M.filter(e=>e!==t)):M&&!M.includes(e)?N(e=>[...e||[],t]):N([t]),x&&x(e)},updateSelectedValue:e=>{C||N(t=>[...t||[],e])}},children:(0,d.jsxs)(`div`,{className:`
          juno-checkboxgroup 
          ${P?`juno-checkboxgroup-valid`:``} 
          ${I?`juno-checkboxgroup-invalid`:``} 
          ${f} 
          ${t}
        `,id:j,role:`group`,...E,children:[y&&D(y)?(0,d.jsx)(o,{text:y,htmlFor:j,disabled:n,required:S}):``,(0,d.jsxs)(`div`,{className:`
            juno-checkbox-group-options 
            ${p} 
            ${P?h:``} 
            ${I?g:``} 
            ${P||I?``:m}
          `,children:[I?(0,d.jsx)(i,{icon:`dangerous`,color:`jn:text-theme-error`,className:`${_}`}):``,P?(0,d.jsx)(i,{icon:`checkCircle`,color:`jn:text-theme-success`,className:`${_}`}):``,e]}),r&&D(r)?(0,d.jsx)(c,{text:r,variant:`error`}):``,w&&D(w)?(0,d.jsx)(c,{text:w,variant:`success`}):``,a&&D(a)?(0,d.jsx)(c,{text:a}):``]})})};try{v.displayName=`CheckboxGroupContext`,v.__docgenInfo={description:``,displayName:`CheckboxGroupContext`,filePath:`/home/runner/work/juno/juno/packages/ui-components/src/components/CheckboxGroup/CheckboxGroup.component.tsx`,methods:[],props:{},tags:{}}}catch{}try{y.displayName=`CheckboxGroup`,y.__docgenInfo={description:`The \`CheckboxGroup\` component provides a context-managed grouping of checkbox elements.
...
{@link CheckboxGroupProps }`}}}catch{}})))()}var x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I;function L(){return(L=e((()=>{x=t(n()),b(),s(),a(),l(),S=r(),C=`
  jn:inline-flex
  jn:items-center
`,w=e=>`
    jn:absolute
...
`,F=`
  jn:mt-0
  jn:ml-6
`,I=({checked:e=!1,className:t=``,disabled:n=!1,errortext:r=``,helptext:a=``,id:s=``,indeterminate:l=!1,invalid:u=!1,label:d,name:f=``,onChange:p,onClick:m,required:h=!1,successtext:g=``,valid:_=!1,value:y=``,wrapperClassName:b=``,...I})=>{let L=e=>typeof e!=`string`||e.trim().length!==0,R=`juno-checkbox-`+(0,x.useId)(),z=(0,x.useContext)(v),{selectedOptions:B,name:V,disabled:H,handleCheckboxChange:U,updateSelectedValue:W}=z||{},[G,K]=(0,x.useState)(z?!!(B&&B.includes(y)):!!e),[ee,te]=(0,x.useState)(!1),[ne,q]=(0,x.useState)(!1),[J,re]=(0,x.useState)(!1),[Y,ie]=(0,x.useState)(!1);(0,x.useEffect)(()=>{e&&z&&W&&W(y)},[]),(0,x.useEffect)(()=>{z||K(e)},[e]);let X=(0,x.useMemo)(()=>u||!!(r&&L(r)),[u,r]),Z=(0,x.useMemo)(()=>_||!!(g&&L(g)),[_,g]);(0,x.useEffect)(()=>{te(l)},[l]),(0,x.useEffect)(()=>{re(X)},[X]),(0,x.useEffect)(()=>{ie(Z)},[Z]);let ae=e=>{K(!G),U&&typeof U==`function`&&U(y),p&&p(e)},oe=e=>{m&&m(e)},se=()=>{q(!0)},ce=()=>{q(!1)},Q=()=>z?!!(B&&B.includes(y)):G,$=s||R;return(0,S.jsxs)(`div`,{className:`jn-checkbox-outer jn:leading-0`,children:[(0,S.jsxs)(`div`,{className:`jn-checkbox-wrapper ${C}`,children:[(0,S.jsxs)(`div`,{className:`
            juno-checkbox
            ${T}
            ${ne?E:``}
            ${H||n?k:``}
            ...
            ${J||Y?``:A}
            ${b}
          `,children:[Q()?(0,S.jsx)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,className:`${D}`,width:`16`,height:`16`,viewBox:`0 0 16 16`,children:(0,S.jsx)(`polygon`,{points:`5.75 11.15 2.6 8 1.55 9.05 5.75 13.25 14.75 4.25 13.7 3.2`})}):``,(0,S.jsx)(`input`,{checked:Q(),className:`
              ${w(H||n)}
              ${J?`juno-checkbox-invalid`:``}
              ${Y?`juno-checkbox-valid`:``}
              ${t}
            `,disabled:H||n,id:$,name:V||f,onBlur:ce,onChange:ae,onClick:oe,onFocus:se,type:`checkbox`,value:y,...I}),ee&&!Q()?(0,S.jsx)(`div`,{className:`${O}`}):``]}),d&&L(d)?(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(o,{text:d,htmlFor:$,disabled:H||n,required:h,className:`${N}`}),J?(0,S.jsx)(i,{icon:`dangerous`,color:`jn:text-theme-error`,size:`1.125rem`,className:`
                  ${P}
                  ${H||n?`jn:opacity-50`:``}
                `}):``,Y?(0,S.jsx)(i,{icon:`checkCircle`,color:`jn:text-theme-success`,size:`1.125rem`,className:`
                  ${P}
                  ${n?`jn:opacity-50`:``}
                `}):``]}):``]}),r&&L(r)?(0,S.jsx)(c,{text:r,variant:`error`,className:`${F}`}):``,g&&L(g)?(0,S.jsx)(c,{text:g,variant:`success`,className:`${F}`}):``,a&&L(a)?(0,S.jsx)(c,{text:a,className:`${F}`}):``]})};try{I.displayName=`Checkbox`,I.__docgenInfo={description:`The \`Checkbox\` component is a versatile form element that allows users to
