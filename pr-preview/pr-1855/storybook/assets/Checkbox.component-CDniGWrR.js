import{n as e,o as t}from"./rolldown-runtime-C0FnF6B9.js";import{t as n}from"./react-C21x__mS.js";import{t as r}from"./jsx-runtime-BdxMnOeJ.js";import{t as i}from"./Icon.component-BlxvYbUQ.js";import{t as a}from"./Icon-BjItkHKO.js";import{t as o}from"./Label.component-DOSKHppz.js";import{t as s}from"./Label-DvnYklPU.js";import{t as c}from"./FormHint.component-CpRixu1s.js";import{t as l}from"./FormHint-C8bI7riU.js";var u,d,f,p,m,h,g,_,v,y;function b(){return(b=e((()=>{u=t(n()),s(),a(),l(),d=r(),f=`
  jn:mb-4
  jn:last:mb-0
`,p=`
  jn:relative
...
`,F=`
  jn:mt-0
  jn:ml-6
`,I=({checked:e=!1,className:t=``,disabled:n=!1,errortext:r=``,helptext:a=``,id:s=``,indeterminate:l=!1,invalid:u=!1,label:d,name:f=``,onChange:p,onClick:m,required:h=!1,successtext:g=``,valid:_=!1,value:y=``,wrapperClassName:b=``,...I})=>{let L=e=>typeof e!=`string`||e.trim().length!==0,R=`juno-checkbox-`+(0,x.useId)(),z=(0,x.useContext)(v),{selectedOptions:B,name:ee,disabled:V,handleCheckboxChange:H,updateSelectedValue:U}=z||{},[W,G]=(0,x.useState)(z?!!(B&&B.includes(y)):!!e),[K,te]=(0,x.useState)(!1),[ne,q]=(0,x.useState)(!1),[J,re]=(0,x.useState)(!1),[Y,ie]=(0,x.useState)(!1);(0,x.useEffect)(()=>{e&&z&&U&&U(y)},[]),(0,x.useEffect)(()=>{z||G(e)},[e]);let X=(0,x.useMemo)(()=>u||!!(r&&L(r)),[u,r]),Z=(0,x.useMemo)(()=>_||!!(g&&L(g)),[_,g]);(0,x.useEffect)(()=>{te(l)},[l]),(0,x.useEffect)(()=>{re(X)},[X]),(0,x.useEffect)(()=>{ie(Z)},[Z]);let ae=e=>{G(!W),H&&typeof H==`function`&&H(y),p&&p(e)},oe=e=>{m&&m(e)},se=()=>{q(!0)},ce=()=>{q(!1)},Q=()=>z?!!(B&&B.includes(y)):W,$=s||R;return(0,S.jsxs)(`div`,{className:`jn-checkbox-outer jn:leading-0`,children:[(0,S.jsxs)(`div`,{className:`jn-checkbox-wrapper ${C}`,children:[(0,S.jsxs)(`div`,{className:`
            juno-checkbox
            ${T}
            ${ne?E:``}
            ${V||n?k:``}
          ...
          `,children:[Q()?(0,S.jsx)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,className:`${D}`,width:`16`,height:`16`,viewBox:`0 0 16 16`,children:(0,S.jsx)(`polygon`,{points:`5.75 11.15 2.6 8 1.55 9.05 5.75 13.25 14.75 4.25 13.7 3.2`})}):``,(0,S.jsx)(`input`,{checked:Q(),className:`
              ...
              ${t}
            `,disabled:V||n,id:$,name:ee||f,onBlur:ce,onChange:ae,onClick:oe,onFocus:se,type:`checkbox`,value:y,...I}),K&&!Q()?(0,S.jsx)(`div`,{className:`${O}`}):``]}),d&&L(d)?(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(o,{text:d,htmlFor:$,disabled:V||n,required:h,className:`${N}`}),J?(0,S.jsx)(i,{icon:`dangerous`,color:`jn:text-theme-error`,size:`1.125rem`,className:`
                  ${P}
                  ${V||n?`jn:opacity-50`:``}
