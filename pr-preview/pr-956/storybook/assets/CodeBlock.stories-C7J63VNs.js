import{j as e,r as W}from"./iframe-lYdxXuy4.js";import{C as x}from"./CodeBlock.component-WiooJTYe.js";import{T as S,a as J}from"./TabList.component-C2N5mcm9.js";import{T as R}from"./Tab.component-C6w8KxgH.js";import{T as P}from"./TabPanel.component-3V-kNx5A.js";import"./JsonViewer.component-COBoq-W9.js";import"./SearchInput.component-DltCOtX_.js";import"./Icon.component-Cl5GMKoT.js";import"./Stack.component-D6bSGTYJ.js";import"./TabPanel-B93Ak4WC.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
