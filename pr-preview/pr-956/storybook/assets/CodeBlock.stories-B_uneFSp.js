import{j as e,r as W}from"./iframe-BfZRxKlV.js";import{C as x}from"./CodeBlock.component-BAmvwg1c.js";import{T as S,a as J}from"./TabList.component-CZvR3SJJ.js";import{T as R}from"./Tab.component-CcqseL0f.js";import{T as P}from"./TabPanel.component-wYPggQSa.js";import"./JsonViewer.component-Dns7CpQG.js";import"./SearchInput.component-3MK1zgwV.js";import"./Icon.component-CzwwtzHb.js";import"./Stack.component-1wm9-SH8.js";import"./TabPanel-DzrKORED.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
