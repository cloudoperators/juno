import{j as e,r as W}from"./iframe-86QK-6gJ.js";import{C as x}from"./CodeBlock.component-CT-e437O.js";import{T as S,a as J}from"./TabList.component-ByCaEWA_.js";import{T as R}from"./Tab.component-B5V9_UkX.js";import{T as P}from"./TabPanel.component-C1X08aZb.js";import"./JsonViewer.component-pHgUJrqF.js";import"./SearchInput.component-CWmtKkDH.js";import"./Icon.component-CXID9OMN.js";import"./Stack.component-DRcnkJw2.js";import"./TabPanel-BtqOIcXz.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
