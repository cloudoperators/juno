import{j as e,r as W}from"./iframe-DVqR9rH8.js";import{C as x}from"./CodeBlock.component-k4-_oMmi.js";import{T as S,a as J}from"./TabList.component-Cdyk7xCl.js";import{T as R}from"./Tab.component-DYnSauBg.js";import{T as P}from"./TabPanel.component-uT7LbR_M.js";import"./JsonViewer.component-kMR-1dvH.js";import"./SearchInput.component-BL0xQpQc.js";import"./Icon.component-CakmTcOR.js";import"./Stack.component-DRuybV0P.js";import"./TabPanel-CzZ115IK.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
