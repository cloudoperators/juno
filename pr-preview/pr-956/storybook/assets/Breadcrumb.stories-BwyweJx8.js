import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{B as r}from"./BreadcrumbItem.component-CfSakDiA.js";import{r as h,e as m}from"./index-DI7CEG0L.js";import{I}from"./Icon.component-tc_P4JTR.js";import{S as y}from"./Stack.component-ou1_mGON.js";const n=({children:a,className:o="",...u})=>{const c=h.Children.toArray(a).filter(m.isValidElement),p=c.map((b,s)=>e.jsxs(m.Fragment,{children:[e.jsx(r,{...b.props}),s<c.length-1&&e.jsx(I,{icon:"chevronRight"})]},s));return e.jsx(y,{className:`juno-breadcrumb ${o}`,gap:"1",...u,children:p})};try{n.displayName="Breadcrumb",n.__docgenInfo={description:`Breadcrumb is a component that structures navigational links in a breadcrumb trail.
