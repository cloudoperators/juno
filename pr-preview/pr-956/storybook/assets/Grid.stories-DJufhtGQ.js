import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{G as l}from"./GridRow.component-uNSrRYiW.js";import{G as o}from"./GridColumn.component-ipMGNKb3.js";const T={"--grid-column-flex-grow":"1","--grid-column-flex-shrink":"0","--grid-column-flex-basis":"0","--grid-column-default-width":"auto"},e=({auto:r=!1,children:_,className:A="",...v})=>{const S=r?T:{};return n.jsx("div",{className:`juno-grid ${A}`,style:S,...v,children:_})};try{e.displayName="Grid",e.__docgenInfo={description:`A general-use grid component.
...
}`,...(j=(h=u.parameters)==null?void 0:h.docs)==null?void 0:j.source}}};var x,p,g;s.parameters={...s.parameters,docs:{...(x=s.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: Template,
  args: {
    children: <GridRow>
        <GridColumn>Column</GridColumn>
...
}`,...(g=(p=s.parameters)==null?void 0:p.docs)==null?void 0:g.source}}};var w,y,f;m.parameters={...m.parameters,docs:{...(w=m.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: Template,
  args: {
    auto: true,
    children: <GridRow>
...
}`,...(N=(R=c.parameters)==null?void 0:R.docs)==null?void 0:N.source}}};const M=["Default","Auto","MixedGrid","MixedAutoGrid","NestedGrid"];export{u as Auto,d as Default,m as MixedAutoGrid,s as MixedGrid,c as NestedGrid,M as __namedExportsOrder,B as default};
