import{j as e,r as W}from"./iframe-CGVnTgh8.js";import{C as x}from"./CodeBlock.component-DAMB5tzn.js";import{T as S,a as J}from"./TabList.component-DRArNUFh.js";import{T as R}from"./Tab.component-D-fPd8m1.js";import{T as P}from"./TabPanel.component-HNQclYSr.js";import"./JsonViewer.component-uI0cgFhg.js";import"./SearchInput.component-Bqu2BzGY.js";import"./Icon.component-CZ0HLpqn.js";import"./Stack.component-Cd4AmxPX.js";import"./TabPanel-D-en6O4Q.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
