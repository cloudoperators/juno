import{j as e,r as W}from"./iframe-DpPEGQdU.js";import{C as x}from"./CodeBlock.component-Bd3LPZY3.js";import{T as S,a as J}from"./TabList.component-B5noLfby.js";import{T as R}from"./Tab.component-CHEzft2q.js";import{T as P}from"./TabPanel.component-NIcsGE_9.js";import"./JsonViewer.component-DdI9m3-P.js";import"./SearchInput.component-B2x2VnvZ.js";import"./Icon.component-C1H1Q8am.js";import"./Stack.component-iedLMLWI.js";import"./TabPanel-s6tzed_z.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
