import{j as e,r as W}from"./iframe-PGud-crQ.js";import{C as x}from"./CodeBlock.component-1RY3wsAx.js";import{T as S,a as J}from"./TabList.component-DCs279M1.js";import{T as R}from"./Tab.component-2aSgkb8u.js";import{T as P}from"./TabPanel.component-CLqQLN8K.js";import"./JsonViewer.component-DgT35zXP.js";import"./SearchInput.component-CfYwv8Cr.js";import"./Icon.component-CgC-e4QX.js";import"./Stack.component-BuN1RjBI.js";import"./TabPanel-D2EiDzdn.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
