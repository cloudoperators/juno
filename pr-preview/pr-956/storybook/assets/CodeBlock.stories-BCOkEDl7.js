import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as J}from"./index-DI7CEG0L.js";import{C as S}from"./CodeBlock.component-DuVvZrDL.js";import{T as L,a as R}from"./TabList.component-CeitEWft.js";import{T as P}from"./Tab.component-DycJ8eJk.js";import{T as K}from"./TabPanel.component-DCdQej-v.js";import"./JsonViewer.component-B06V7fbe.js";import"./SearchInput.component-C0HDdRIF.js";import"./Icon.component-9-Ah6ENR.js";import"./Stack.component-ou1_mGON.js";import"./TabPanel-BMxd_RTe.js";const E={args:{label:"A Tab Label",children:"Tab 1"}},Y={title:"Components/CodeBlock",component:S,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},U=({tabs:v,codeBlocks:W})=>e.jsxs(L,{variant:"codeblocks",children:[e.jsx(R,{children:v.map((d,c)=>J.createElement(P,{...d,key:`t-${c}`}))}),W.map((d,c)=>e.jsx(K,{children:e.jsx(S,{...d})},c))]}),n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},o={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
