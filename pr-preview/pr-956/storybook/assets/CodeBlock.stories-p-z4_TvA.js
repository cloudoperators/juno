import{j as e,r as W}from"./iframe-BXESz6Ks.js";import{C as x}from"./CodeBlock.component-Fai-IDDA.js";import{T as S,a as J}from"./TabList.component-T63OraTo.js";import{T as R}from"./Tab.component-7vnSvekq.js";import{T as P}from"./TabPanel.component-CO7O2Y6k.js";import"./JsonViewer.component-D8OG6ZJZ.js";import"./SearchInput.component-CkLrvZWs.js";import"./Icon.component-CZzWzclc.js";import"./Stack.component-DdG4_krk.js";import"./TabPanel-DssRrZw6.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
