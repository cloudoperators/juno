import{j as e,r as W}from"./iframe-DdxBETxW.js";import{C as x}from"./CodeBlock.component-8-77doF7.js";import{T as S,a as J}from"./TabList.component-KGBJjGbY.js";import{T as R}from"./Tab.component-DYsM4bGC.js";import{T as P}from"./TabPanel.component-CglX1nJH.js";import"./JsonViewer.component-BBsHqJAB.js";import"./SearchInput.component-B8Eauuw0.js";import"./Icon.component-DOEhxk8r.js";import"./Stack.component-KdKVsgek.js";import"./TabPanel-BOdov04e.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
