import{j as r}from"./jsx-runtime-Cf8x2fCZ.js";import{S as f}from"./Stack.component-_Vt9D_CU.js";import"./index-yBjzXJbu.js";const y=({label:t})=>r.jsx("div",{className:`
        jn:flex
        jn:bg-juno-blue
        jn:rounded
        jn:text-white
        ...
        jn:py-3
        jn:border
        jn:border-juno-blue-7`,children:r.jsx("div",{className:"jn:m-auto",children:t})});try{y.displayName="DummyComponent",y.__docgenInfo={description:"",displayName:"DummyComponent",props:{label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string"}}}}}catch{}const ie={title:"Layout/Stack",component:f,argTypes:{children:{control:!1,table:{type:{summary:"ReactNode"}}},gap:{options:["0","px","0.5","1","1.5","2","2.5","3","3.5","4","5","6","7","8","9","10","11","12","14","16","20","24","28","32","36","40","44","48","52","56","60","64","72","80","96"]}}},te=t=>`
...
}`,...(j=(T=i.parameters)==null?void 0:T.docs)==null?void 0:j.source}}};var C,_,A;o.parameters={...o.parameters,docs:{...(C=o.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: Template,
  parameters: {
    docs: {
      description: {
...
}`,...(A=(_=o.parameters)==null?void 0:_.docs)==null?void 0:A.source}}};var B,V,H;c.parameters={...c.parameters,docs:{...(B=c.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: Template,
  parameters: {
    docs: {
      description: {
