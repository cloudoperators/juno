import{j as e,r as W}from"./iframe-Ie7iB9gE.js";import{C as x}from"./CodeBlock.component-CwfrmFC-.js";import{T as S,a as J}from"./TabList.component-_AHLtr4F.js";import{T as R}from"./Tab.component-DcTUu7PS.js";import{T as P}from"./TabPanel.component-D5B31py0.js";import"./JsonViewer.component-v4SnSUlI.js";import"./SearchInput.component-CTXms3rW.js";import"./Icon.component-BE8BNGEE.js";import"./Stack.component-4evaCmLI.js";import"./TabPanel-kbrNlavI.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
