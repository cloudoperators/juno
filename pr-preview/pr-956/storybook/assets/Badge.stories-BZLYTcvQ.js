import{I as oe,K as re}from"./Icon.component-BavwJ0_M.js";import{j as h}from"./jsx-runtime-D_zvdyIk.js";import"./index-DI7CEG0L.js";const ce=`
  jn:rounded
  jn:text-sm
  ...
  jn:justify-center
  jn:items-center
`,x={default:"jn:bg-theme-badge-default",info:"jn:bg-theme-info/25",success:"jn:bg-theme-success/25",warning:"jn:bg-theme-warning/25",danger:"jn:bg-theme-danger/25",error:"jn:bg-theme-error/25"},ie="jn:mr-1 jn:items-center",de=e=>x[e]||x.default,ue=(e,r)=>{if(typeof e=="string"&&pe(e))return e;if(e===!0)return r},le=(e,r)=>{if(e===!0)return`jn:text-theme-${r}`},pe=e=>new Set(Object.values(re)).has(e),g=({variant:e="default",icon:r=!1,text:ae="",className:ne="",children:te,...se})=>{const f=ue(r,e),v=le(r,e);return console.log(v),h.jsxs("span",{className:`
        juno-badge 
        juno-badge-${e} 
        ${ce} 
        ${de(e)} 
        ${r?"jn:inline-flex":""} 
        ${ne}`,...se,children:[f&&h.jsx(oe,{icon:f,size:"1.125rem",className:ie,color:v}),te||ae]})};try{g.displayName="Badge",g.__docgenInfo={description:`A Badge is used to visually represent properties or states of an entity.
...
Takes precedence over the text property.`,name:"children",required:!1,type:{name:"ReactNode"}}}}}catch{}const ve={title:"Components/Badge",component:g,parameters:{text:"default"},argTypes:{icon:{options:["default",...Object.values(re)],control:{type:"select"}},children:{control:!1}}},a={args:{text:"With Icon",icon:!0}},n={args:{text:"Deleted",icon:"deleteForever"}},t={args:{variant:"info",text:"Info"}},s={args:{variant:"info",text:"Info",icon:!0}},o={args:{variant:"success",text:"Success"}},c={args:{variant:"success",text:"Success",icon:!0}},i={args:{variant:"warning",text:"Warning"}},d={args:{variant:"warning",text:"Warning",icon:!0}},u={args:{variant:"danger",text:"Danger"}},l={args:{variant:"danger",text:"Danger",icon:!0}},p={args:{variant:"error",text:"Error"}},m={args:{variant:"error",text:"Error",icon:!0}};var I,y,S;a.parameters={...a.parameters,docs:{...(I=a.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    text: "With Icon",
    icon: true // Default icon based on variant
  }
}`,...(S=(y=a.parameters)==null?void 0:y.docs)==null?void 0:S.source}}};var j,W,b;n.parameters={...n.parameters,docs:{...(j=n.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: {
    text: "Deleted",
    icon: "deleteForever"
  }
}`,...(b=(W=n.parameters)==null?void 0:W.docs)==null?void 0:b.source}}};var w,D,E;t.parameters={...t.parameters,docs:{...(w=t.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    variant: "info",
    text: "Info"
  }
...
}`,...(V=(N=s.parameters)==null?void 0:N.docs)==null?void 0:V.source}}};var B,A,C;o.parameters={...o.parameters,docs:{...(B=o.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
    variant: "success",
    text: "Success"
  }
}`,...(C=(A=o.parameters)==null?void 0:A.docs)==null?void 0:C.source}}};var $,q,O;c.parameters={...c.parameters,docs:{...($=c.parameters)==null?void 0:$.docs,source:{originalSource:`{
  args: {
    variant: "success",
    text: "Success",
    icon: true
