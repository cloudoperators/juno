import{j as e,r as W}from"./iframe-DYnss8VT.js";import{C as x}from"./CodeBlock.component--vMfebQl.js";import{T as S,a as J}from"./TabList.component-D1W_Ir1O.js";import{T as R}from"./Tab.component-CWAkHS68.js";import{T as P}from"./TabPanel.component-DxaqKBt6.js";import"./JsonViewer.component-ChNhGKBK.js";import"./SearchInput.component-DnYq9nFl.js";import"./Icon.component-B5xw9RdC.js";import"./Stack.component-BSu_GOw4.js";import"./TabPanel-BPms34r1.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
