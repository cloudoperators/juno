import{j as n}from"./iframe-Ie7iB9gE.js";import{G as l}from"./GridRow.component-C9cJZqI7.js";import{G as o}from"./GridColumn.component-gELV7Hz5.js";const S={"--grid-column-flex-grow":"1","--grid-column-flex-shrink":"0","--grid-column-flex-basis":"0","--grid-column-default-width":"auto"},i=({auto:r=!1,children:N,className:A="",..._})=>{const v=r?S:{};return n.jsx("div",{className:`juno-grid ${A}`,style:v,..._,children:N})};try{i.displayName="Grid",i.__docgenInfo={description:`A general-use grid component.
