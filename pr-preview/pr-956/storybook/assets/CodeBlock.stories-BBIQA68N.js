import{j as e,r as W}from"./iframe-CEZqkFCg.js";import{C as x}from"./CodeBlock.component-DzV942JN.js";import{T as S,a as J}from"./TabList.component-DycVTrE0.js";import{T as R}from"./Tab.component-BcpJMmNn.js";import{T as P}from"./TabPanel.component-7KiXA3se.js";import"./JsonViewer.component-CXjUzlp1.js";import"./SearchInput.component-D7vmVDlj.js";import"./Icon.component-DUX6NYcJ.js";import"./Stack.component-By91Lncq.js";import"./TabPanel-BS_NHcWo.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
