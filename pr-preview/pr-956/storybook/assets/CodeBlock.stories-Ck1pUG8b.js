import{j as e,r as W}from"./iframe-2EB-YwL5.js";import{C as x}from"./CodeBlock.component-fia96tKD.js";import{T as S,a as J}from"./TabList.component-C0XylE7y.js";import{T as R}from"./Tab.component-CgPAAXiv.js";import{T as P}from"./TabPanel.component-ypJ5ySrQ.js";import"./JsonViewer.component-Ck4_cVoJ.js";import"./SearchInput.component-DfhPIphh.js";import"./Icon.component-BBAAQoeK.js";import"./Stack.component-BGGro8p6.js";import"./TabPanel-BFF-uB3j.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
