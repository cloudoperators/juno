import{j as e,r as W}from"./iframe-BJQzcJBh.js";import{C as x}from"./CodeBlock.component-DbVulgIG.js";import{T as S,a as J}from"./TabList.component-DSpKWVBi.js";import{T as R}from"./Tab.component-CudH_ybJ.js";import{T as P}from"./TabPanel.component-CVvvSjuh.js";import"./JsonViewer.component-3BlTbUU_.js";import"./SearchInput.component-BHOssxXb.js";import"./Icon.component-B0zhLXRx.js";import"./Stack.component-DRgRVwc3.js";import"./TabPanel-D1znx4Pv.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
