import{j as e,r as W}from"./iframe-Cs7cagOK.js";import{C as x}from"./CodeBlock.component-CLyCd35E.js";import{T as S,a as J}from"./TabList.component-CG5po1p4.js";import{T as R}from"./Tab.component-BdrUKq6b.js";import{T as P}from"./TabPanel.component-KLk3Zl-y.js";import"./JsonViewer.component-BHLiUct2.js";import"./SearchInput.component-BOoJN7OT.js";import"./Icon.component-BkalgXnY.js";import"./Stack.component-CIVGTUdA.js";import"./TabPanel-CVOhFCTV.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
