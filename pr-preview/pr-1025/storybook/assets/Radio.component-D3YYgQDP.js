import{r as a,j as e}from"./iframe-B5BLhfwn.js";import{L as D}from"./Label.component-J5iV5fA1.js";import{I as _}from"./Icon.component-DnKB8mbp.js";import{F as g}from"./FormHint.component-DQVSYdhu.js";const Z=`
	jn-mb-4
	last:jn-mb-0
`,ee=`
	jn-relative
...
`,A=`
  jn-mt-0
  jn-ml-6
`,O=({checked:o=!1,className:I="",disabled:l=!1,errortext:t="",helptext:p="",id:S,invalid:v=!1,label:m,name:E,onChange:x,onClick:V,required:h=!1,successtext:n="",valid:R=!1,value:i="",...d})=>{const r=C=>!(typeof C=="string"&&C.trim().length===0),G=()=>"juno-radio-"+a.useId(),j=a.useContext(k),{selectedValue:u,onChange:f,name:y,updateSelectedValue:N,disabled:c}=j||{},T=()=>j?u===i:!!o,[b,q]=a.useState(()=>T()),[W,w]=a.useState(!1),[s,U]=a.useState(!1),[$,J]=a.useState(!1),F=a.useMemo(()=>v||!!(t&&r(t)),[v,t]),H=a.useMemo(()=>R||!!(n&&r(n)),[R,n]);a.useEffect(()=>{U(F)},[F]),a.useEffect(()=>{J(H)},[H]),a.useEffect(()=>{o&&j&&u===void 0&&N&&N(i)},[]),a.useEffect(()=>{u||q(o)},[o]);const K=()=>{q(!b),f&&typeof f=="function"&&u!==i&&f(i),x&&x(i)},M=()=>u?u===i:b,Q=C=>{V&&V(C)},X=()=>{w(!0)},Y=()=>{w(!1)},L=S||G();return e.jsxs("div",{className:"jn-radio-outer",children:[e.jsxs("div",{className:`juno-radio-wrapper ${se}`,children:[e.jsxs("div",{className:`
             juno-radio 
             ${le} 
             ${W?re:""} 
             ${l?de:""} 
           ...
           `,...d,children:[e.jsx("input",{checked:M(),className:`
              ...
              ${$?"juno-radio-valid":""}
            `,disabled:c||l,id:L,onBlur:Y,onChange:K,onClick:Q,onFocus:X,name:y||E,type:"radio",value:i}),M()?e.jsx("span",{className:`${ie}`}):""]}),m&&r(m)?e.jsxs(e.Fragment,{children:[e.jsx(D,{className:`${me}`,disabled:c||l,htmlFor:L,required:h,text:m}),s?e.jsx(_,{icon:"dangerous",color:"jn-text-theme-error",size:"1.125rem",className:`
                    ${B}
                    ${l?"jn-opacity-50":""}
