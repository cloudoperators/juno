import{j as e,r as W}from"./iframe-B5BLhfwn.js";import{C as x}from"./CodeBlock.component-BPYqSecG.js";import{T as S,a as J}from"./TabList.component-BgM8Se0J.js";import{T as R}from"./Tab.component-gmlDb3il.js";import{T as P}from"./TabPanel.component-5etMr6DQ.js";import"./JsonViewer.component-D5bwGl7z.js";import"./SearchInput.component-FehZ5LsJ.js";import"./Icon.component-DnKB8mbp.js";import"./Stack.component-DxY0_zqY.js";import"./TabPanel-DEthLG29.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
