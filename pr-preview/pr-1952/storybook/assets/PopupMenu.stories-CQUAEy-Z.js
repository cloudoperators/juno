import{n as e,o as t}from"./rolldown-runtime-C0FnF6B9.js";import{t as n}from"./react-C21x__mS.js";import{t as r}from"./jsx-runtime-BdxMnOeJ.js";import{n as i,r as a}from"./Icon.component-OHbDcQlR.js";import{n as o,t as s}from"./PortalProvider.component-CPwWWIUc.js";import{t as c}from"./Button.component-T43sZJSo.js";import{t as l}from"./Button-CSQ9mvrR.js";import{a as u,c as d,i as f,n as p,o as m,r as h,s as g,t as _,u as v}from"./PopupMenu-Bm7fVqCH.js";var y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V;function H(){return(H=e((()=>{y=t(n()),_(),a(),o(),l(),b=r(),{fn:x}=__STORYBOOK_MODULE_TEST__,S={title:`Components/PopupMenu`,component:p,subcomponents:{PopupMenuToggle:d,PopupMenuOptions:f,PopupMenuItem:h,PopupMenuSection:u},argTypes:{children:{control:!1},icon:{options:[`moreVert`,...Object.keys(i)],control:{type:`select`}}},decorators:[e=>(0,b.jsx)(s,{children:(0,b.jsx)(e,{})})]},C=y.forwardRef(({className:e=``,onClick:t=void 0,...n},r)=>(0,b.jsx)(c,{ref:r,className:`my-custom-toggle ${e}`,onClick:t,...n,children:`Custom Toggle`})),C.displayName=`ToggleButton`,w=y.forwardRef((e,t)=>{let{isOpen:n}=v(),{className:r,...i}=e;return(0,b.jsx)(c,{ref:t,className:`toggle-button ${n?`
  ...
  parameters: {
    docs: {
      description: {
        story: "When all actions in the menu refer to a single entity type, sort items alphabetically and separate the Delete action from the rest with a horizontal divider."
      }
    }
  },
  args: {
...
}`,...B.parameters?.docs?.source}}},V=[`Default`,`NoMenu`,`DisabledDefaultToggle`,`WithMenuChild`,`WithChildrenAsLinks`,`WithMenuWithRandomContent`,`WithMenuChildWithSection`,`WithIcon`,`WithToggleAndMenuChildren`,`WithToggleAsButtonComponent`,`WithToggleAsButtonStyledByState`,`WithCustomButtonComponentAsChild`,`OverflowMenuMultipleEntityGroups`,`OverflowMenuSingleEntityType`]})))()}H();export{D as Default,k as DisabledDefaultToggle,O as NoMenu,z as OverflowMenuMultipleEntityGroups,B as OverflowMenuSingleEntityType,j as WithChildrenAsLinks,R as WithCustomButtonComponentAsChild,P as WithIcon,A as WithMenuChild,N as WithMenuChildWithSection,M as WithMenuWithRandomContent,F as WithToggleAndMenuChildren,I as WithToggleAsButtonComponent,L as WithToggleAsButtonStyledByState,V as __namedExportsOrder,S as default};