import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./react-IGKVQItS.js";import{t as n}from"./jsx-runtime-O9QVJvLM.js";import{n as r,t as i}from"./Divider.component-BIQ59O7p.js";import{t as a}from"./ButtonRow.component-D6U_-NV1.js";import{t as o}from"./ButtonRow-BZNAchld.js";import{t as s}from"./Button.component-DySZA1uT.js";import{t as c}from"./Button-CLPe4pDE.js";var l,u,d,f,p,m,h,g=e((()=>{t(),l=n(),u=`
  jn:text-sm
  jn:rounded
  jn:border
`,d=`
...
{@link BoxProps }`}}}catch{}})),_=e((()=>{g()})),v=e((()=>{r()})),y,b,x,S,C,w,T,E,D,O,k,A,j;e((()=>{t(),_(),v(),o(),c(),y=n(),b={title:`Components/Box`,component:h,argTypes:{}},x={args:{children:`Some content in a Box.`}},S={parameters:{docs:{description:{story:"To remove padding, set the `unpad` prop."}}},args:{children:`A Box without padding`,unpad:!0}},C={parameters:{docs:{description:{story:"Use the `title` prop to render a bold label above the content."}}},args:{title:`Box Title`,children:`Some content in a Box with a title.`}},w={parameters:{docs:{description:{story:'Pass `variant="info"` to render an Info Box.'}}},args:{variant:`info`,children:`This is a Info Box.`}},T={parameters:{docs:{description:{story:'Pass `variant="warning"` to render an Info Box.'}}},args:{variant:`warning`,children:`This is a Warning Box.`}},E={parameters:{docs:{description:{story:'Pass `variant="success"` to render an Info Box.'}}},args:{variant:`success`,children:`This is a Success Box.`}},D={parameters:{docs:{description:{story:'Pass `variant="error"` to render an Info Box.'}}},args:{variant:`error`,children:`This is a Error Box.`}},O={parameters:{docs:{description:{story:'Pass `variant="danger"` to render an Info Box.'}}},args:{variant:`danger`,children:`This is a Danger Box.`}},k={parameters:{docs:{description:{story:`An Inline Action Box to offer one or more actions in the current context without interrupting the flow or implying urgency.`}}},render:e=>(0,y.jsxs)(h,{title:`This is a Inline Action Box`,...e,children:[(0,y.jsx)(`p`,{children:`Use it to offer one or more actions in the current context without interrupting the flow or implying urgency.`}),(0,y.jsx)(i,{color:`jn:border-theme-higher`}),(0,y.jsx)(a,{children:(0,y.jsx)(s,{size:`small`,children:`Click me`})})]})},A={parameters:{docs:{description:{story:`An Inline Action Box to offer one or more actions in the current context without interrupting the flow or implying urgency.`}}},render:e=>(0,y.jsxs)(h,{variant:`info`,title:`This is a Inline Info Action Box`,...e,children:[(0,y.jsx)(`p`,{children:`Use it to offer one or more actions in the current context without interrupting the flow or implying urgency.`}),(0,y.jsx)(i,{color:`jn:border-theme-higher`}),(0,y.jsxs)(a,{children:[(0,y.jsx)(s,{size:`small`,children:`Click me`}),(0,y.jsx)(s,{size:`small`,variant:`primary`,children:`Click me`})]})]})},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  args: {
  ...
  render: args => <Box title="This is a Inline Action Box" {...args}>
      <p>
  ...
  render: args => <Box variant="info" title="This is a Inline Info Action Box" {...args}>
      <p>
        Use it to offer one or more actions in the current context without interrupting the flow or implying urgency.
      </p>
      <Divider color="jn:border-theme-higher" />
