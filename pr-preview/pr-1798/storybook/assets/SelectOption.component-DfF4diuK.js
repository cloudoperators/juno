...
`,R=`
  ...
  jn:text-ellipsis
  jn:whitespace-nowrap
`,z=({children:e,className:t=``,disabled:n=!1,value:r=``,label:i,...o})=>{let{truncateOptions:s,addOptionValueAndLabel:c}=(0,j.useContext)(O)||{truncateOptions:!1,addOptionValueAndLabel:()=>{}};return(0,j.useEffect)(()=>{c(r,i,e)},[r,i,e]),(0,M.jsx)(p,{as:`li`,disabled:n,value:r||e,className:({selected:e})=>`
        juno-select-option
        jn:min-h-10
        ${N}
        ${e?`juno-select-option-selected `+F:P}
        ${n?`juno-select-option-disabled jn:opacity-50 jn:cursor-not-allowed`:``}
        ${s?`juno-select-option-truncate`:``}
        ${t}
      `,...o,children:({selected:t})=>(0,M.jsxs)(M.Fragment,{children:[t?(0,M.jsx)(a,{icon:`check`,size:`18`,className:I}):``,(0,M.jsx)(`span`,{className:`
            ${n?L:``}
            ${s?R:``}
