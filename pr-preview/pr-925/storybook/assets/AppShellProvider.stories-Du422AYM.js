import{j as e}from"./jsx-runtime-BP6H2k8O.js";import{M as s}from"./Message.component-DhZBOF4y.js";import{S as B,D as _}from"./StyleProvider.component-B_qQwZi3.js";import{S as C}from"./ShadowRoot.component-Drhnz3ND.js";import{P as I}from"./PortalProvider.component-CD4awzcQ.js";import{C as o}from"./CodeBlock.component-BVc7E4Py.js";import"./index-DysCNOs_.js";import"./Icon.component-A9eTkufy.js";import"./index-BEZZli5v.js";import"./JsonViewer.component-CFVeNE-q.js";import"./SearchInput.component-Bbi7uNNv.js";import"./Stack.component-JaLCSfPt.js";const J=({children:r,shadowRoot:h,shadowRootMode:c})=>h?e.jsx(C,{mode:c,children:e.jsx(e.Fragment,{children:r})}):r,i=({shadowRoot:r=!0,shadowRootMode:h="open",stylesWrapper:c="inline",theme:T=_,children:W})=>e.jsx(J,{shadowRoot:r,shadowRootMode:h,children:e.jsx(B,{theme:T,stylesWrapper:r?"inline":c,children:e.jsx(I,{children:W})})});try{i.displayName="AppShellProvider",i.__docgenInfo={description:"This provider acts as a wrapper for Juno apps. It renders a StyleProvider and PortalProvider",displayName:"AppShellProvider",props:{stylesWrapper:{defaultValue:{value:"inline"},description:"Where app stylesheets are imported. This is only relevant if shadowRoot === false. If you use a ShadowRoot the styles must be inline.",name:"stylesWrapper",required:!1,type:{name:"enum",value:[{value:'"inline"'},{value:'"head"'}]}},theme:{defaultValue:{value:"theme-dark"},description:"theme: theme-dark or theme-light",name:"theme",required:!1,type:{name:"enum",value:[{value:'"theme-dark"'},{value:'"theme-light"'}]}},children:{defaultValue:null,description:"React nodes or a collection of React nodes to be rendered as content.",name:"children",required:!1,type:{name:"any"}},shadowRoot:{defaultValue:{value:"true"},description:"Whether the app is rendered inside a ShadowRoot. Only choose false if the app is meant to run as a stand-alone application.",name:"shadowRoot",required:!1,type:{name:"boolean"}},shadowRootMode:{defaultValue:{value:"open"},description:"Shadow root mode",name:"shadowRootMode",required:!1,type:{name:"enum",value:[{value:'"open"'},{value:'"closed"'}]}}}}}catch{}const G={title:"Layout/AppShellProvider",component:i,argTypes:{children:{control:!1}}},a=r=>e.jsx(i,{...r,children:r.children}),l={render:a,args:{children:[e.jsx(s,{children:"Juno styles are added inline"},0),e.jsx(o,{children:`
...
}`,...(M=(j=d.parameters)==null?void 0:j.docs)==null?void 0:M.source}}};const K=["Default","NoShadowRoot","StylesInHead","StylesInline","ThemeLight"];export{l as Default,t as NoShadowRoot,p as StylesInHead,n as StylesInline,d as ThemeLight,K as __namedExportsOrder,G as default};
