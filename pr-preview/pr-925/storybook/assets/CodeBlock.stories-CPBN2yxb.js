import{j as e}from"./jsx-runtime-BP6H2k8O.js";import{r as J}from"./index-DysCNOs_.js";import{C as S}from"./CodeBlock.component-QEAWFW6m.js";import{T as L,a as R}from"./TabList.component-VwZIa_DY.js";import{T as P}from"./Tab.component-Dhy0FJtl.js";import{T as K}from"./TabPanel.component-DOTqqtbh.js";import"./JsonViewer.component-CFVeNE-q.js";import"./SearchInput.component-Bbi7uNNv.js";import"./Icon.component-A9eTkufy.js";import"./Stack.component-JaLCSfPt.js";import"./TabPanel-Bw-qK0C0.js";import"./index-BKNjMPK8.js";const E={args:{label:"A Tab Label",children:"Tab 1"}},Z={title:"Components/CodeBlock",component:S,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},U=({tabs:v,codeBlocks:W})=>e.jsxs(L,{variant:"codeblocks",children:[e.jsx(R,{children:v.map((d,c)=>J.createElement(P,{...d,key:`t-${c}`}))}),W.map((d,c)=>e.jsx(K,{children:e.jsx(S,{...d})},c))]}),n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},o={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
