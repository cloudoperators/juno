import{j as e}from"./jsx-runtime-BP6H2k8O.js";import{e as z,r as X}from"./index-DysCNOs_.js";import{S as Y}from"./Stack.component-JaLCSfPt.js";import{B as t}from"./Button.component-w3tEngOA.js";import{T as h}from"./TextInput.component-DU5tCBw6.js";import{S as Z,a as y}from"./SelectOption.component-DMDbgFmi.js";import{P as ee}from"./PortalProvider.component-CD4awzcQ.js";import"./Icon.component-DsLoGuwO.js";import"./Spinner.component-DWsJM9DM.js";import"./Label.component-DhLm9IiA.js";import"./FormHint.component-D83hjeZ1.js";import"./portal-CTbR-aKX.js";import"./index-BEZZli5v.js";import"./floating-ui.react-N79nPNwQ.js";import"./frozen-BVmhAox2.js";import"./use-text-value-DWotbbvK.js";const te=(r,n,a)=>{if(!X.isValidElement(r))return r;const o={variant:r.props.variant||n,disabled:r.props.disabled||a};return z.cloneElement(r,o)},re=(r,n,a)=>`
    ${r}-${n}
    ${a?`${r}-disabled`:""}
...
}`,...(N=(D=i.parameters)==null?void 0:D.docs)==null?void 0:N.source}}};var _,E,W;p.parameters={...p.parameters,docs:{...(_=p.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    disabled: true,
    children: [<Button key={0} label="Button" />, <Button key={1} label="Button" />, <Button key={2} label="Button" />]
  }
}`,...(W=(E=p.parameters)==null?void 0:E.docs)==null?void 0:W.source}}};var $,L,V;c.parameters={...c.parameters,docs:{...($=c.parameters)==null?void 0:$.docs,source:{originalSource:`{
  args: {
    children: [<Button key={0} icon="home" />, <Button key={1} icon="help" />, <Button key={2} icon="forum" />]
  }
}`,...(V=(L=c.parameters)==null?void 0:L.docs)==null?void 0:V.source}}};var q,C,w;d.parameters={...d.parameters,docs:{...(q=d.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    children: [<TextInput key={0} placeholder="Enter a value…" />, <Button key={1} label="Submit" />]
  }
}`,...(w=(C=d.parameters)==null?void 0:C.docs)==null?void 0:w.source}}};var A,R,F;m.parameters={...m.parameters,docs:{...(A=m.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    children: [<TextInput key={0} placeholder="First Name" />, <TextInput key={1} placeholder="Last Name" />, <Button key={2} label="Submit" />]
  }
}`,...(F=(R=m.parameters)==null?void 0:R.docs)==null?void 0:F.source}}};var M,O,H;b.parameters={...b.parameters,docs:{...(M=b.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
    variant: "subdued",
    children: [<SelectInput key={0} label="Some label" />, <SelectInput key={1} />, <SelectInput key={2} />, <Button key={3} icon="filterAlt" />]
  }
}`,...(H=(O=b.parameters)==null?void 0:O.docs)==null?void 0:H.source}}};const je=["Default","PrimaryInputGroup","PrimaryDangerInputGroup","SubduedInputGroup","Disabled","IconButtons","TextInputWithButton","MultipleTextInputsWithButton","SelectInputsWithButton"];export{s as Default,p as Disabled,c as IconButtons,m as MultipleTextInputsWithButton,u as PrimaryDangerInputGroup,l as PrimaryInputGroup,b as SelectInputsWithButton,i as SubduedInputGroup,d as TextInputWithButton,je as __namedExportsOrder,xe as default};
