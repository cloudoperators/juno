import{j as a}from"./jsx-runtime-BP6H2k8O.js";import{r as n}from"./index-DysCNOs_.js";import{r as _}from"./index-BEZZli5v.js";import{I as w}from"./Icon.component-A9eTkufy.js";import{u as N}from"./PortalProvider.component-CD4awzcQ.js";const S=(e,l,t)=>`
      jn-fixed
      jn-right-0
...
`,P=`
  ...
  jn-text-lg
  jn-font-bold
`,p=({heading:e="",size:l="default",opened:t=!1,closeable:o=!0,onClose:s,className:f="",children:h,...y})=>{const[i,d]=n.useState(t),[j,b]=n.useState(o),[g,c]=n.useState(!1),r=n.useRef(null),u=N();n.useEffect(()=>d(t),[t]),n.useEffect(()=>b(o),[o]),n.useEffect(()=>()=>{r.current&&clearTimeout(r.current)},[]),n.useEffect(()=>{i||(c(!0),r.current&&clearTimeout(r.current),r.current=setTimeout(()=>c(!1),500))},[i]);const x=v=>{d(!1),s==null||s(v)};return _.createPortal(a.jsxs("div",{className:`juno-panel ${S(i,g,l)} ${f}`,role:"dialog","aria-labelledby":"juno-panel-title",...y,children:[a.jsxs("div",{className:`juno-panel-header ${E}`,children:[a.jsx("div",{className:`juno-panel-title ${P}`,id:"juno-panel-title",children:e}),j&&a.jsx(w,{icon:"close",onClick:x,className:"juno-panel-close jn-ml-auto"})]}),a.jsx("div",{className:`juno-panel-content-wrapper ${T}`,children:h})]}),u||document.body)};try{p.displayName="Panel",p.__docgenInfo={description:`A Panel component that slides in from the right side of the screen.
It can be used to display additional content/controls for the content area.`,displayName:"Panel",props:{heading:{defaultValue:{value:""},description:"Title of the panel.",name:"heading",required:!1,type:{name:"any"}},size:{defaultValue:{value:"default"},description:"Size of the opened panel.",name:"size",required:!1,type:{name:"enum",value:[{value:'"large"'},{value:'"default"'}]}},opened:{defaultValue:{value:"false"},description:"Controls whether the panel is open and visible.",name:"opened",required:!1,type:{name:"boolean"}},closeable:{defaultValue:{value:"true"},description:"Determines whether the panel can be closed using a close button.",name:"closeable",required:!1,type:{name:"boolean"}},onClose:{defaultValue:null,description:"Handler called when the close button is clicked.",name:"onClose",required:!1,type:{name:"MouseEventHandler<HTMLElement>"}},className:{defaultValue:{value:""},description:"Additional CSS classes to apply to the panel for custom styling.",name:"className",required:!1,type:{name:"string"}},children:{defaultValue:null,description:"Content to be rendered inside the main body of the panel.",name:"children",required:!1,type:{name:"any"}}}}}catch{}const q=`
  jn-px-8
  jn-py-4
