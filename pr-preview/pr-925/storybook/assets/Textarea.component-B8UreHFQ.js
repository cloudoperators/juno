import{j as t}from"./jsx-runtime-BP6H2k8O.js";import{r as e}from"./index-DysCNOs_.js";import{L as J}from"./Label.component-DhLm9IiA.js";import{I as F}from"./Icon.component-B8_hStz_.js";import{F as h}from"./FormHint.component-D83hjeZ1.js";const K=`
  jn-inline-block
  jn-relative
`,Q=`
...
`,j=`
  jn-mt-0
`,I=({name:v,value:y="",id:S="",placeholder:x="",disabled:u=!1,readOnly:P=!1,required:C=!1,invalid:g=!1,valid:b=!1,autoFocus:A=!1,className:_="",autoComplete:H="off",helptext:d="",successtext:n="",errortext:l="",onChange:q,onFocus:V,onBlur:w,label:r,width:c="full",wrapperClassName:L="",...M})=>{const s=a=>!(typeof a=="string"&&a.trim().length===0),W=()=>"juno-textarea-"+e.useId(),f=e.useRef(null),[m,T]=e.useState(""),[k,p]=e.useState(!1),[o,R]=e.useState(!1),[i,B]=e.useState(!1);e.useEffect(()=>{document.hasFocus()&&f.current&&f.current.contains(document.activeElement)&&p(!0)},[]),e.useEffect(()=>{T(y.toString())},[y]);const $=e.useMemo(()=>g||!!(l&&s(l)),[g,l]),E=e.useMemo(()=>b||!!(n&&s(n)),[b,n]);e.useEffect(()=>{R($)},[$]),e.useEffect(()=>{B(E)},[E]);const O=a=>{T(a.target.value),q&&q(a)},z=a=>{p(!0),V&&V(a)},D=a=>{p(!1),w&&w(a)},G=({disabled:a})=>i||o?t.jsxs("div",{className:`juno-textinput-row-icon-container ${te} ${a?ne:""}`,children:[o?t.jsx(F,{icon:"dangerous",color:"jn-text-theme-error"}):null,i?t.jsx(F,{icon:"checkCircle",color:"jn-text-theme-success"}):null]}):"",N=S||W();return t.jsxs("div",{children:[t.jsxs("div",{className:`
          juno-textarea-wrapper 
          ${K}
          ${c=="auto"?"jn-inline-block":"jn-block"}
          ${c=="auto"?"jn-w-auto":"jn-w-full"}
          ${L}
        `,children:[r&&r.length?t.jsx(J,{text:r,htmlFor:N,className:`${ae}`,disabled:u,required:C,floating:!0,minimized:!!(x||k||m&&m.length)}):"",t.jsx("textarea",{name:v,autoComplete:H,value:m,id:N,ref:f,placeholder:x,disabled:u,readOnly:P,autoFocus:A,onChange:O,onFocus:z,onBlur:D,className:`juno-textarea 
            ${Q}
            ${r?Z:ee}
