import{j as n}from"./iframe-2wxD09-p.js";import{G as l}from"./GridRow.component-DLm8WY9R.js";import{G as o}from"./GridColumn.component-6A4iqlLq.js";const G={"--grid-column-flex-grow":"1","--grid-column-flex-shrink":"0","--grid-column-flex-basis":"0","--grid-column-default-width":"auto"},i=({auto:r=!1,children:c,className:a="",...t})=>{const C=r?G:{};return n.jsx("div",{className:`juno-grid ${a}`,style:C,...t,children:c})};try{i.displayName="Grid",i.__docgenInfo={description:`A general-use grid component.
