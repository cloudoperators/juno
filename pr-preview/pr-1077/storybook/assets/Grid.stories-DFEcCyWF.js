import{j as n}from"./iframe-CY04Cup7.js";import{G as l}from"./GridRow.component-D4vyA1vb.js";import{G as o}from"./GridColumn.component-Cnzsw5JK.js";const G={"--grid-column-flex-grow":"1","--grid-column-flex-shrink":"0","--grid-column-flex-basis":"0","--grid-column-default-width":"auto"},i=({auto:r=!1,children:c,className:a="",...t})=>{const C=r?G:{};return n.jsx("div",{className:`juno-grid ${a}`,style:C,...t,children:c})};try{i.displayName="Grid",i.__docgenInfo={description:`A general-use grid component.
