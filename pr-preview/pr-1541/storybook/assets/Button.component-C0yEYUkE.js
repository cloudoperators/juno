import{e as I,j as l}from"./iframe-DCUGrE3o.js";import{I as N}from"./Icon.component-ByLmytCj.js";import{S as _}from"./Spinner.component-6JBaamng.js";const y=`
  jn:font-bold
  jn:inline-flex 
  jn:justify-center 
  jn:items-center
...
`,C=(e,a)=>e==="small"?a==="subdued"?`${M}`:`${L}`:a==="subdued"?`${k}`:`${T}`,$=e=>{switch(e){case"default":return w;case"primary":return H;case"primary-danger":return P;case"subdued":return W;default:return w}},E=`
  jn:mr-2
`,R=`
  jn:mr-2
`,O=e=>e==="small"?`${E}`:`${R}`,B=e=>e?"in-progress":"",U=e=>{switch(e){case"default":return"jn:text-theme-accent";case"primary":return"jn:text-white";case"primary-danger":return"jn:text-white";default:return""}},s=I.forwardRef(({label:e,title:a,type:V="button",variant:n="default",size:t="default",disabled:i,href:d,icon:c,className:m="",onClick:o,children:v,progress:u=!1,progressLabel:b="",...p},f)=>{const r=a||e||"",h=u?l.jsx(_,{size:t==="small"?"1.125rem":"1.5rem",color:U(n)}):c?l.jsx(N,{icon:c,title:r,className:`juno-button-icon ${e||v?O(t):""} `,size:t==="small"?"1.125rem":"1.5rem"}):null,j=u&&b?b:e||v,S=A=>{o&&o(A)},q=l.jsxs("button",{className:`
          juno-button 
          juno-button-${n} 
          juno-button-${t}-size 
          ${y} 
