import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{U as n,tt as r}from"./iframe-DlkCBOmp.js";var i,a,o,s,c,l=t((()=>{i=e(r()),a=n(),o=`
  jn:text-sm
  jn:rounded-lg
...
{@link CardProps }`}}}catch{}})),u,d,f,p,m,h,g;t((()=>{l(),u={title:`Components/Card`,component:c,argTypes:{}},d={args:{children:`Some content in a Card with padding.`,padding:!0,onClick:void 0}},f={args:{children:`Some content in a Card rendered as <button> when onClick is passed (with padding). Note: Rendered as <a> when href is passed.`,padding:!0,onClick:()=>alert(`You clicked a card with an onClick event.`)}},p={args:{children:`Some content in a Card rendered as <a> when href is passed (with padding).`,padding:!0,onClick:void 0,href:`https://cloudoperators.github.io/juno/?path=/docs/components-card--docs`}},m={args:{children:`Disabled card (with href and padding).`,padding:!0,onClick:()=>void 0,href:`https://cloudoperators.github.io/juno/?path=/docs/components-card--docs`,disabled:!0}},h={args:{children:`A Card without padding.`,onClick:void 0}},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  ...
  args: {
    children: "Some content in a Card rendered as <button> when onClick is passed (with padding). Note: Rendered as <a> when href is passed.",
    padding: true,
...
}`,...h.parameters?.docs?.source}}},g=[`Default`,`WithClickEvent`,`WithHref`,`Disabled`,`WithoutPadding`]}))();export{d as Default,m as Disabled,f as WithClickEvent,p as WithHref,h as WithoutPadding,g as __namedExportsOrder,u as default};