import{i as e}from"./preload-helper-usAeo7Bx.js";import{B as t,U as n,tt as r,z as i}from"./iframe-CNwMATTQ.js";import{r as a,t as o}from"./Icon.component-BMp5INpT.js";var s=e((()=>{})),c,l,u,d=e((()=>{r(),t(),a(),s(),c=n(),l=`
  jn:inline-flex 
  jn:justify-center 
  jn:items-center
  jn:rounded
...
`,u=({className:e=``,disabled:t=!1,id:n,name:r,onToggleTheme:a,...s})=>{let u=i.useStyles();u||console.warn(`Juno ThemeToggle requires a StyleProvider context in order to work. Use ThemeToggle in a Juno AppShell or include StyleProvider manually.`);let{currentTheme:d,setThemeClass:f}=u||{};return(0,c.jsx)(o,{className:`juno-theme-toggle ${l} ${e}`,disabled:t,icon:d===`theme-light`?`nightsStay`:`wbSunny`,id:n,name:r,onClick:()=>{let e=d===`theme-dark`?`theme-light`:`theme-dark`;f&&f(e),a&&a(e)},...s})};try{u.displayName=`ThemeToggle`,u.__docgenInfo={description:`ThemeToggle is a button component that toggles between Light and Dark UI Themes.
