import{j as e}from"./jsx-runtime-D6fbYt3N.js";import{r as J}from"./index-DysCNOs_.js";import{C as S}from"./CodeBlock.component-BKK9HuUT.js";import{T as L,a as P}from"./TabList.component-D1Ky5kTU.js";import{T as R}from"./Tab.component-CgE4yUSE.js";import{T as K}from"./TabPanel.component-DSoVN15q.js";import"./JsonViewer.component-FBkWTEWx.js";import"./SearchInput.component-DVLiP4wE.js";import"./Icon.component-CCczSbvB.js";import"./widgets-BR6-ubtP.js";import"./Stack.component-B4IgElTG.js";import"./TabPanel-SXlHHxNZ.js";const E={args:{label:"A Tab Label",children:"Tab 1"}},Z={title:"Components/CodeBlock",component:S,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1}}},U=({tabs:v,codeBlocks:W})=>e.jsxs(L,{variant:"codeblocks",children:[e.jsx(P,{children:v.map((d,c)=>J.createElement(R,{...d,key:`t-${c}`}))}),W.map((d,c)=>e.jsx(K,{children:e.jsx(S,{...d})},c))]}),n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},o={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
