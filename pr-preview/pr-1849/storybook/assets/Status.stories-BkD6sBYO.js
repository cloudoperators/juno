...
Caused by: NetworkError: net::ERR_CONNECTION_REFUSED
  ...
  at async commitLifeCycles (react-dom.development.js:20663)`,V={args:{}},H={args:{status:`error`,code:404},parameters:{docs:{description:{story:`Page-level 404 error. Title and body are derived from the HTTP error code reference.`}}}},U={args:{status:`error`,details:B},parameters:{docs:{description:{story:"Pass a stack trace or server response via `details` to render it in a scrollable `<pre>` block below the message. Useful for technical users who need the full error context."}}}},W={args:{status:`error`},render:e=>(0,L.jsx)(P,{...e,action:(0,L.jsx)(f,{variant:`primary`,children:`Retry`})}),parameters:{docs:{description:{story:"Pass any element via the `action` slot — typically a `Button` or a button-styled anchor."}}}},G={args:{status:`progress`},parameters:{docs:{description:{story:'Use `status="progress"` at page or section level while data is being fetched.'}}}},K={decorators:[z],args:{className:`jn:mt-8`}},q={args:{status:`progress`,title:`Loading Servers …`},render:e=>(0,L.jsxs)(o,{direction:`vertical`,children:[(0,L.jsx)(C,{children:(0,L.jsx)(o,{alignment:`center`,distribution:`end`,children:(0,L.jsx)(c,{placeholder:`Search Servers …`})})}),(0,L.jsxs)(p,{columns:4,children:[(0,L.jsxs)(_,{children:[(0,L.jsx)(x,{children:`Name`}),(0,L.jsx)(x,{children:`Region`}),(0,L.jsx)(x,{children:`Status`}),(0,L.jsx)(x,{children:`Last Updated`})]}),(0,L.jsx)(_,{children:(0,L.jsx)(y,{colSpan:4,children:(0,L.jsx)(P,{...e})})})]})]}),parameters:{docs:{description:{story:'Use `status="progress"` inside a `DataGridRow` spanning all columns while data is being fetched. Use the title `title` prop to further qualify the kind of items currently being loaded if possible, otherwise the default title "Loading …" will be rendered.'}}}},J={args:{status:`error`},render:e=>(0,L.jsxs)(o,{direction:`vertical`,children:[(0,L.jsx)(C,{children:(0,L.jsx)(o,{alignment:`center`,distribution:`end`,children:(0,L.jsx)(c,{placeholder:`Search Servers …`})})}),(0,L.jsxs)(p,{columns:4,children:[(0,L.jsxs)(_,{children:[(0,L.jsx)(x,{children:`Name`}),(0,L.jsx)(x,{children:`Region`}),(0,L.jsx)(x,{children:`Status`}),(0,L.jsx)(x,{children:`Last Updated`})]}),(0,L.jsx)(_,{children:(0,L.jsx)(y,{colSpan:4,children:(0,L.jsx)(P,{...e})})})]})]}),parameters:{docs:{description:{story:'Use `status="error"` inside a `DataGridRow` spanning all columns when a data fetch or operation has failed.'}}}},Y={args:{status:`empty`},render:e=>(0,L.jsxs)(o,{direction:`vertical`,children:[(0,L.jsx)(C,{children:(0,L.jsx)(o,{alignment:`center`,distribution:`end`,children:(0,L.jsx)(c,{placeholder:`Search Servers …`})})}),(0,L.jsxs)(p,{columns:4,children:[(0,L.jsxs)(_,{children:[(0,L.jsx)(x,{children:`Name`}),(0,L.jsx)(x,{children:`Region`}),(0,L.jsx)(x,{children:`Status`}),(0,L.jsx)(x,{children:`Last Updated`})]}),(0,L.jsx)(_,{children:(0,L.jsx)(y,{colSpan:4,children:(0,L.jsx)(P,{...e})})})]})]}),parameters:{docs:{description:{story:'Use `status="empty"` inside a `DataGridRow` spanning all columns when the data source contains no items.'}}}},X={args:{status:`no-matches`},render:e=>(0,L.jsxs)(o,{direction:`vertical`,children:[(0,L.jsx)(C,{children:(0,L.jsx)(o,{alignment:`center`,distribution:`end`,children:(0,L.jsx)(c,{placeholder:`Search Servers …`})})}),(0,L.jsxs)(p,{columns:4,children:[(0,L.jsxs)(_,{children:[(0,L.jsx)(x,{children:`Name`}),(0,L.jsx)(x,{children:`Region`}),(0,L.jsx)(x,{children:`Status`}),(0,L.jsx)(x,{children:`Last Updated`})]}),(0,L.jsx)(_,{children:(0,L.jsx)(y,{colSpan:4,children:(0,L.jsx)(P,{...e})})})]})]}),parameters:{docs:{description:{story:'Use `status="no-matches"` inside a `DataGridRow` spanning all columns when items exist but none match the currently applied filters.'}}}},Z={args:{status:`error`,details:B},render:e=>(0,L.jsxs)(o,{direction:`vertical`,children:[(0,L.jsx)(C,{children:(0,L.jsx)(o,{alignment:`center`,distribution:`end`,children:(0,L.jsx)(c,{placeholder:`Search Servers …`})})}),(0,L.jsxs)(p,{columns:4,children:[(0,L.jsxs)(_,{children:[(0,L.jsx)(x,{children:`Name`}),(0,L.jsx)(x,{children:`Region`}),(0,L.jsx)(x,{children:`Status`}),(0,L.jsx)(x,{children:`Last Updated`})]}),(0,L.jsx)(_,{children:(0,L.jsx)(y,{colSpan:4,children:(0,L.jsx)(P,{...e})})})]})]}),parameters:{docs:{description:{story:"DataGrid error state with a stack trace passed via `details`."}}}},V.parameters={...V.parameters,docs:{...V.parameters?.docs,source:{originalSource:`{
  args: {}
...
}`,...Z.parameters?.docs?.source}}},Q=[`Default`,`HttpError`,`WithDetails`,`WithAction`,`Loading`,`InPageContext`,`DataGridLoading`,`DataGridError`,`DataGridEmpty`,`DataGridNoMatches`,`DataGridErrorWithDetails`]}))();export{Y as DataGridEmpty,J as DataGridError,Z as DataGridErrorWithDetails,q as DataGridLoading,X as DataGridNoMatches,V as Default,H as HttpError,K as InPageContext,G as Loading,W as WithAction,U as WithDetails,Q as __namedExportsOrder,R as default};