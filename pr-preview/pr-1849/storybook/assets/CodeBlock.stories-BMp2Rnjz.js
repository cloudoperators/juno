...
console.log(greeting)`,k={name:`CodeBlock with Custom Options`,parameters:{docs:{description:{story:"Pass a custom `codeBlockFooter` element to replace the default copy bar. This example adds Download and Copy actions side by side."}}},render:()=>{let e=(0,g.useCallback)(()=>{navigator.clipboard.writeText(O).catch(()=>{console.warn(`Cannot copy text to clipboard`)})},[]);return(0,v.jsx)(s,{content:O,codeBlockFooter:(0,v.jsxs)(`div`,{className:`juno-codeblock-bottombar jn:flex jn:justify-end jn:px-3 jn:py-2 jn:border-t jn:border-theme-codeblock-footer jn:gap-2`,children:[(0,v.jsx)(i,{icon:`download`,onClick:(0,g.useCallback)(()=>{let e=new Blob([O],{type:`text/plain`}),t=URL.createObjectURL(e),n=document.createElement(`a`);n.href=t,n.download=`code.txt`,n.click(),URL.revokeObjectURL(t)},[])}),(0,v.jsx)(i,{icon:`contentCopy`,onClick:e})]})})}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
