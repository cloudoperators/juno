import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./react-IGKVQItS.js";import{t as n}from"./jsx-runtime-O9QVJvLM.js";import{n as r,t as i}from"./PageHeader.component-CaWGwcJy.js";import{n as a,t as o}from"./Stack.component-DwKvxYjU.js";import{n as s,t as c}from"./SearchInput.component-CPRRZHxw.js";import{t as l}from"./Spinner.component-BLgbJicd.js";import{t as u}from"./Spinner-B1wDQ7Ft.js";import{n as d,t as f}from"./Button.component-Cd_qRmKy.js";import{a as p,i as m,n as h,o as g,r as _,s as v,t as y}from"./DataGridCell.component-D62mcyNA.js";import{n as b,t as x}from"./DataGridHeadCell.component-CUsb8spM.js";import{n as ee,t as S}from"./DataGridToolbar.component-BW1z1bgu.js";var C,w,T,E,D,O,k,A,j,M,N,P=e((()=>{t(),u(),g(),C=n(),w={400:{title:`Bad Request`,body:`The request could not be processed due to invalid syntax. Try again.`},401:{title:`Authentication Required`,body:`Authentication failed. Verify your credentials and try again.`},403:{title:`Access Denied`,body:`You do not have the required permissions to access this resource.`},404:{title:`Page Not Found`,body:`The requested URL does not exist or may have moved.`},408:{title:`Request Timeout`,body:`The request did not return a complete result in time. Check your connection and try again.`},409:{title:`Conflict`,body:``},429:{title:`Too Many Requests`,body:``},500:{title:`Internal Server Error`,body:`An internal error occurred. Try again.`},502:{title:`Bad Gateway`,body:`The server returned an invalid response. Try again.`},503:{title:`Service Unavailable`,body:`The service is temporarily unavailable. Try again later.`},504:{title:`Gateway Timeout`,body:`A server did not respond in time. Check your connection and try again.`}},T={progress:{title:`Loading…`,body:``},error:{title:`Something went wrong`,body:`An error occurred. Try again.`},empty:{title:`No items`,body:`There are no items to display.`},"no-matches":{title:``,body:`No items match the current filters. Adjust or clear filters.`}},E=`
  jn:flex
  jn:flex-col
  jn:items-center
  jn:text-center
...
Caused by: NetworkError: net::ERR_CONNECTION_REFUSED
  ...
  at async commitLifeCycles (react-dom.development.js:20663)`,B={args:{}},V={args:{status:`error`,code:404},parameters:{docs:{description:{story:`Page-level 404 error. Title and body are derived from the HTTP error code reference.`}}}},H={args:{status:`error`,details:z},parameters:{docs:{description:{story:"Pass a stack trace or server response via `details` to render it in a scrollable `<pre>` block below the message. Useful for technical users who need the full error context."}}}},U={args:{status:`error`},render:e=>(0,I.jsx)(N,{...e,action:(0,I.jsx)(f,{variant:`primary`,children:`Retry`})}),parameters:{docs:{description:{story:"Pass any element via the `action` slot — typically a `Button` or a button-styled anchor."}}}},W={args:{status:`progress`},parameters:{docs:{description:{story:'Use `status="progress"` at page or section level while data is being fetched.'}}}},G={decorators:[R],args:{className:`jn:mt-16`},parameters:{docs:{description:{story:"`Status` does not know or care about the context and layout conditions of the surrounding page or component (with the exception of `DataGrid`), so outside of a `DataDrid` postioning has to be handled from the outside for now."}}}},K={decorators:[R],args:{code:404},parameters:{docs:{description:{story:"`Status` does not know or care about the context and layout conditions of the surrounding page or component (with the exception of `DataGrid`), so outside of a `DataDrid` postioning has to be handled from the outside for now."}}}},q={decorators:[R],args:{className:`jn:mt-14`,status:`progress`},parameters:{docs:{description:{story:"`Status` does not know or care about the context and layout conditions of the surrounding page or component (with the exception of `DataGrid`), so outside of a `DataDrid` postioning has to be handled from the outside for now."}}}},J={args:{status:`progress`,title:`Loading Servers …`},render:e=>(0,I.jsxs)(o,{direction:`vertical`,children:[(0,I.jsx)(S,{children:(0,I.jsx)(o,{alignment:`center`,distribution:`end`,children:(0,I.jsx)(c,{placeholder:`Search Servers …`})})}),(0,I.jsxs)(p,{columns:4,children:[(0,I.jsxs)(_,{children:[(0,I.jsx)(x,{children:`Name`}),(0,I.jsx)(x,{children:`Region`}),(0,I.jsx)(x,{children:`Status`}),(0,I.jsx)(x,{children:`Last Updated`})]}),(0,I.jsx)(_,{children:(0,I.jsx)(y,{colSpan:4,children:(0,I.jsx)(N,{...e})})})]})]}),parameters:{docs:{description:{story:'Use `status="progress"` inside a `DataGridRow` spanning all columns while data is being fetched. Use the title `title` prop to further qualify the kind of items currently being loaded if possible, otherwise the default title "Loading …" will be rendered.'}}}},Y={args:{status:`error`},render:e=>(0,I.jsxs)(o,{direction:`vertical`,children:[(0,I.jsx)(S,{children:(0,I.jsx)(o,{alignment:`center`,distribution:`end`,children:(0,I.jsx)(c,{placeholder:`Search Servers …`})})}),(0,I.jsxs)(p,{columns:4,children:[(0,I.jsxs)(_,{children:[(0,I.jsx)(x,{children:`Name`}),(0,I.jsx)(x,{children:`Region`}),(0,I.jsx)(x,{children:`Status`}),(0,I.jsx)(x,{children:`Last Updated`})]}),(0,I.jsx)(_,{children:(0,I.jsx)(y,{colSpan:4,children:(0,I.jsx)(N,{...e})})})]})]}),parameters:{docs:{description:{story:'Use `status="error"` inside a `DataGridRow` spanning all columns when a data fetch or operation has failed.'}}}},X={args:{status:`empty`},render:e=>(0,I.jsxs)(o,{direction:`vertical`,children:[(0,I.jsx)(S,{children:(0,I.jsx)(o,{alignment:`center`,distribution:`end`,children:(0,I.jsx)(c,{placeholder:`Search Servers …`})})}),(0,I.jsxs)(p,{columns:4,children:[(0,I.jsxs)(_,{children:[(0,I.jsx)(x,{children:`Name`}),(0,I.jsx)(x,{children:`Region`}),(0,I.jsx)(x,{children:`Status`}),(0,I.jsx)(x,{children:`Last Updated`})]}),(0,I.jsx)(_,{children:(0,I.jsx)(y,{colSpan:4,children:(0,I.jsx)(N,{...e})})})]})]}),parameters:{docs:{description:{story:'Use `status="empty"` inside a `DataGridRow` spanning all columns when the data source contains no items.'}}}},Z={args:{status:`no-matches`},render:e=>(0,I.jsxs)(o,{direction:`vertical`,children:[(0,I.jsx)(S,{children:(0,I.jsx)(o,{alignment:`center`,distribution:`end`,children:(0,I.jsx)(c,{placeholder:`Search Servers …`})})}),(0,I.jsxs)(p,{columns:4,children:[(0,I.jsxs)(_,{children:[(0,I.jsx)(x,{children:`Name`}),(0,I.jsx)(x,{children:`Region`}),(0,I.jsx)(x,{children:`Status`}),(0,I.jsx)(x,{children:`Last Updated`})]}),(0,I.jsx)(_,{children:(0,I.jsx)(y,{colSpan:4,children:(0,I.jsx)(N,{...e})})})]})]}),parameters:{docs:{description:{story:'Use `status="no-matches"` inside a `DataGridRow` spanning all columns when items exist but none match the currently applied filters.'}}}},Q={args:{status:`error`,details:z},render:e=>(0,I.jsxs)(o,{direction:`vertical`,children:[(0,I.jsx)(S,{children:(0,I.jsx)(o,{alignment:`center`,distribution:`end`,children:(0,I.jsx)(c,{placeholder:`Search Servers …`})})}),(0,I.jsxs)(p,{columns:4,children:[(0,I.jsxs)(_,{children:[(0,I.jsx)(x,{children:`Name`}),(0,I.jsx)(x,{children:`Region`}),(0,I.jsx)(x,{children:`Status`}),(0,I.jsx)(x,{children:`Last Updated`})]}),(0,I.jsx)(_,{children:(0,I.jsx)(y,{colSpan:4,children:(0,I.jsx)(N,{...e})})})]})]}),parameters:{docs:{description:{story:"DataGrid error state with a stack trace passed via `details`."}}}},B.parameters={...B.parameters,docs:{...B.parameters?.docs,source:{originalSource:`{
  args: {}
  ...
  parameters: {
    docs: {
      description: {
        story: "\`Status\` does not know or care about the context and layout conditions of the surrounding page or component (with the exception of \`DataGrid\`), so outside of a \`DataDrid\` postioning has to be handled from the outside for now."
      }
    }
  }
...
}`,...Q.parameters?.docs?.source}}},$=[`Default`,`HttpError`,`WithDetails`,`WithAction`,`Loading`,`InPageContext`,`WithCodeInPageContext`,`WithStatusInPageContext`,`DataGridLoading`,`DataGridError`,`DataGridEmpty`,`DataGridNoMatches`,`DataGridErrorWithDetails`]}))();export{X as DataGridEmpty,Y as DataGridError,Q as DataGridErrorWithDetails,J as DataGridLoading,Z as DataGridNoMatches,B as Default,V as HttpError,G as InPageContext,W as Loading,U as WithAction,K as WithCodeInPageContext,H as WithDetails,q as WithStatusInPageContext,$ as __namedExportsOrder,L as default};