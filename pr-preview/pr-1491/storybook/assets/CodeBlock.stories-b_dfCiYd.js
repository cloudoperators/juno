import{j as e,r as i}from"./iframe-cmzQHpCv.js";import{C as E}from"./CodeBlock.component-CCI8UgDC.js";import{T as D,a as F}from"./TabList.component-D-VfmK1j.js";import{T as B}from"./Tab.component-BlHxPeLZ.js";import{T as m}from"./TabPanel.component-hDvxNa-K.js";import"./preload-helper-PPVm8Dsz.js";import"./JsonViewer.component-C6XHHcK8.js";import"./SearchInput.component-DddEUqnP.js";import"./Icon.component-D_S77_8w.js";import"./Stack.component-DSzSLThg.js";import"./TabPanel-Bb3YzYgq.js";const p=({tabs:c,codeBlocks:l})=>e.jsxs(D,{variant:"codeblocks",children:[e.jsx(F,{children:c.map((d,A)=>i.createElement(B,{...d,key:`t-${A}`}))}),l.map((d,A)=>e.jsx(m,{children:e.jsx(E,{...d})},A))]}),j={title:"Components/CodeBlock",component:E,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
