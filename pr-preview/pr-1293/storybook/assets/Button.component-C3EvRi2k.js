import{R as D,j as o}from"./iframe-CiYX1Wvp.js";import{I as N}from"./Icon.component-Bw9tBs4g.js";import{S as _}from"./Spinner.component-BlUH1qKx.js";const y=`
  jn:font-bold
  jn:inline-flex 
  jn:justify-center 
  jn:items-center
...
`,R=`
  jn:mr-2
`,E=e=>e==="small"?`${W}`:`${R}`,B=e=>e?"in-progress":"",U=e=>{switch(e){case"default":return"jn:text-theme-accent";case"primary":return"jn:text-white";case"primary-danger":return"jn:text-white";default:return""}},s=D.forwardRef(({label:e,title:a,variant:n="default",size:t="default",disabled:i,href:d,icon:c,className:m="",onClick:l,children:v,progress:u=!1,progressLabel:b="",...p},h)=>{const r=a||e||"",f=u?o.jsx(_,{size:t==="small"?"1.125rem":"1.5rem",color:`${U(n)}`}):c?o.jsx(N,{icon:c,title:r,className:`juno-button-icon ${e||v?E(t):""} `,size:t==="small"?"1.125rem":"1.5rem"}):null,j=u&&b?b:e||v,S=A=>{l&&l(A)},V=o.jsxs("button",{className:`
          juno-button 
          juno-button-${n} 
          juno-button-${t}-size 
          ${y} 
