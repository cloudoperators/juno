import{r as u,R as m,j as e}from"./iframe-CiYX1Wvp.js";import{B as r}from"./BreadcrumbItem.component-CFRAtRej.js";import{I as p}from"./Icon.component-Bw9tBs4g.js";import{S as b}from"./Stack.component-B46bFY7p.js";import"./preload-helper-PPVm8Dsz.js";const c=({children:a,className:n="",...l})=>{const o=u.Children.toArray(a).filter(m.isValidElement),i=o.map((d,s)=>e.jsxs(m.Fragment,{children:[e.jsx(r,{...d.props}),s<o.length-1&&e.jsx(p,{icon:"chevronRight"})]},s));return e.jsx(b,{className:`juno-breadcrumb ${n}`,gap:"1",...l,children:i})};try{c.displayName="Breadcrumb",c.__docgenInfo={description:`Breadcrumb is a component that structures navigational links in a breadcrumb trail.
...
The BreadcrumbItem component is typically used.`,name:"children",required:!1,type:{name:"ReactNode"}}}}}catch{}const h=({children:a,...n})=>e.jsx(c,{...n,children:a}),x={title:"Components/Breadcrumb/Breadcrumb",component:c,argTypes:{children:{control:!1}}},t={render:h,args:{children:[e.jsx(r,{label:"",icon:"home"},"1"),e.jsx(r,{label:"Breadcrumb Item"},"2"),e.jsx(r,{label:"Breadcrumb Item with Icon",icon:"place"},"3"),e.jsx(r,{label:"Disabled Item ",disabled:!0},"4"),e.jsx(r,{label:"Active Item",active:!0},"5")]}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  render: Template,
  args: {
