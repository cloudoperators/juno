import{j as e}from"./iframe-C22aOaxX.js";import"./preload-helper-PPVm8Dsz.js";const c=({children:n,alignTerms:s="right",className:u=""})=>e.jsx("dl",{className:`dl ${u}`,"data-testid":"description-list",style:{justifyContent:s==="right"?"flex-end":"flex-start"},children:n}),r=c;try{c.displayName="DescriptionList",c.__docgenInfo={description:`A wrapper component that semantically represents a list of terms and their corresponding descriptions using HTML <dl> elements.
