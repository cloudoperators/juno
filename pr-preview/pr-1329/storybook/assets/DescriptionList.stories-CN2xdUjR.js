import{j as e}from"./iframe-BrOktraJ.js";import"./preload-helper-PPVm8Dsz.js";const r=({children:t,alignTerms:s="right",className:u=""})=>e.jsx("dl",{className:`dl ${u}`,"data-testid":"description-list",style:{justifyContent:s==="right"?"flex-end":"flex-start"},children:t}),m=r;try{r.displayName="DescriptionList",r.__docgenInfo={description:`A wrapper component that semantically represents a list of terms and their corresponding descriptions using HTML <dl> elements.
