import{j as e}from"./jsx-runtime-BP6H2k8O.js";import{r as a}from"./index-DysCNOs_.js";import{L as ue}from"./Label.component-DhLm9IiA.js";import{I as y}from"./Icon.component-D9enpJBw.js";import{S as de}from"./Spinner.component-RQWIWEoX.js";import{F as O}from"./FormHint.component-DtRGMMjY.js";import{S as I}from"./headlessui-float-pPOEMtsx.js";import{o as ce,a as pe,s as me,b as fe}from"./floating-ui.react-dom-C789hh8f.js";import{u as he}from"./PortalProvider.component-Dpl-KYct.js";import{r as ge}from"./index-DxJeRO9x.js";import{I as b}from"./listbox-FgpIuTn9.js";const je=`
  jn-no-wrap
...
`,Y=a.createContext(void 0),z=({ariaLabel:l="",children:S,className:g="",defaultValue:d,disabled:r=!1,error:v=!1,errortext:s="",helptext:i="",id:x="",invalid:j=!1,label:c,loading:W=!1,multiple:C=!1,name:B,onChange:L,onValueChange:_,placeholder:w="Select…",required:G=!1,successtext:p="",truncateOptions:J=!1,valid:k=!1,value:K,valueLabel:V,variant:q="default",width:N="full",wrapperClassName:Q="",...X})=>{const u=t=>!(typeof t=="string"&&t.trim().length===0),A=x||"juno-select-"+a.useId(),P="juno-select-helptext-"+a.useId(),[E,Z]=a.useState(new Map),[m,ee]=a.useState(!1),[T,te]=a.useState(!1),[D,ae]=a.useState(!1),[f,ne]=a.useState(!1),le=(t,n,h)=>{Z(o=>new Map(o).set(t||h,{val:t,label:n,children:h,displayName:h||n||t}))},R=a.useMemo(()=>j||!!(s&&u(s)),[j,s]),H=a.useMemo(()=>k||!!(p&&u(p)),[k,p]);a.useEffect(()=>{ee(v)},[v]),a.useEffect(()=>{te(R)},[R]),a.useEffect(()=>{ae(H)},[H]),a.useEffect(()=>{ne(W)},[W]);const se=t=>{L&&L(t),_&&_(t)},M=he(),oe=[ce(4),pe({crossAxis:!0,allowedPlacements:["bottom","top"]}),me({boundary:"viewport",apply({availableWidth:t,availableHeight:n,elements:h}){Object.assign(h.floating.style,{maxWidth:`${t}px`,maxHeight:`${n}px`,overflowY:"auto"})}}),fe()],re=t=>{const n=o=>{var F;const $=E.get(o);if($)return(F=$.displayName)!=null&&F.length?$.displayName:null};return t.map(o=>n(o)).filter(o=>o&&o.toString().trim().length>0).join(", ")};return e.jsx(Y.Provider,{value:{truncateOptions:J,addOptionValueAndLabel:le},children:e.jsxs("div",{className:`
          juno-select-wrapper 
          jn-relative
          ${N=="auto"?"jn-inline-block":"jn-block"}
          ${N=="auto"?"jn-w-auto":"jn-w-full"}
          ${Q}
        `,children:[e.jsxs(b,{disabled:r||f||m,multiple:C,name:B,onChange:se,value:K,defaultValue:d,children:[c&&u(c)?e.jsx(b.Label,{as:ue,htmlFor:A,text:c,className:`${je}`,disabled:r||f||m,required:G,floating:!0,minimized:!0}):"",e.jsxs(I,{composable:!0,adaptiveWidth:!0,middleware:oe,children:[e.jsx(I.Reference,{children:e.jsx(b.Button,{"aria-describedby":i?P:"","aria-label":l||c,as:"button",id:A,className:`
                    juno-select-toggle
...
`,Ie=`
  ...
  jn-text-ellipsis
  jn-whitespace-nowrap
`,U=({children:l,className:S="",disabled:g=!1,value:d="",label:r,...v})=>{const s=a.useContext(Y),{truncateOptions:i,addOptionValueAndLabel:x}=s||{truncateOptions:!1,addOptionValueAndLabel:()=>{}};return a.useEffect(()=>{x(d,r,l)},[d,r,l]),e.jsx(b.Option,{as:a.Fragment,disabled:g,value:d||l,children:({selected:j})=>e.jsxs("li",{className:`
          juno-select-option 
          jn-min-h-[2.5rem]
          ${Ve}
          ${j?"juno-select-option-selected "+Ne:qe}
          ${g?"juno-select-option-disabled jn-opacity-50 jn-cursor-not-allowed":""}
          ${i?"juno-select-option-truncate":""}
          ${S}
        `,...v,children:[j?e.jsx(y,{icon:"check",size:"18",className:$e}):"",e.jsx("span",{className:`
            ${g?Oe:""}
            ${i?Ie:""}
