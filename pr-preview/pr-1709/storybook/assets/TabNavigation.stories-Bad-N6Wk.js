import{i as e}from"./preload-helper-DbRxMUml.js";import{Z as t,z as n}from"./iframe-Dwu20zEl.js";import{i as r,n as i,r as a,t as o}from"./TabNavigationItem-BlGy-cw4.js";var s,c,l,u,d,f,p;e((()=>{t(),a(),o(),s=n(),c={title:`Navigation/TabNavigation/TabNavigation`,component:r,argTypes:{children:{control:!1},onActiveItemChange:{control:!1},tabStyle:{options:[`main`,`content`],control:{type:`radio`}}}},l={args:{children:[(0,s.jsx)(i,{label:`Item 1`},`item-1`),(0,s.jsx)(i,{label:`Item 2`,active:!0},`item-2`),(0,s.jsx)(i,{label:`Item with Icon`,icon:`warning`},`item-3`),(0,s.jsx)(i,{label:`Disabled Item`,disabled:!0},`item-4`)]}},u={parameters:{docs:{description:{story:"All navigation items can be disabled by passing `disabled` to the `TabNavigation`."}}},args:{disabled:!0,children:[(0,s.jsx)(i,{label:`Item 1`},`item-1`),(0,s.jsx)(i,{label:`Item 2`},`item-2`),(0,s.jsx)(i,{label:`Item 3`},`item-3`),(0,s.jsx)(i,{label:`Item 4`},`item-4`)]}},d={parameters:{docs:{description:{story:"When needed, navigation items can take a `value` prop as a technical identifier that is different form the human-readable `label`. You may use any of the provided props as an identifier to set an active item on the parent. Alternatively, an individual `SideNavigationItem` can be set to `active`. When both an individual item is set to active and an aciveItem is set on the parent, the latter will win."}}},args:{activeItem:`item-3`,children:[(0,s.jsx)(i,{label:`Item 1`,value:`item-1`},`i-1`),(0,s.jsx)(i,{label:`Item 2`,value:`item-2`},`i-2`),(0,s.jsx)(i,{label:`Item 3`,value:`item-3`},`i-3`),(0,s.jsx)(i,{label:`Item 4`,value:`item-4`},`i-4`)]}},f={parameters:{docs:{description:{story:`Alternatively, navigation items can render children passed to them.`}}},args:{activeItem:`item-1`,children:[(0,s.jsx)(i,{value:`item-1`,children:`Item 1`},`i-1`),(0,s.jsx)(i,{value:`item-2`,children:`Item 2`},`i-2`),(0,s.jsx)(i,{value:`item-3`,children:`Item 3`},`i-3`),(0,s.jsx)(i,{value:`item-4`,children:`Item 4`},`i-4`)]}},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
