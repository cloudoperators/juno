import{i as e}from"./preload-helper-DbRxMUml.js";import{F as t,I as n,Z as r,z as i}from"./iframe-CutxMBKi.js";import{r as a,t as o}from"./Icon.component-4iVSYlZD.js";var s=e((()=>{})),c,l,u,d=e((()=>{r(),n(),a(),s(),c=i(),l=`
  jn:inline-flex 
  jn:justify-center 
  jn:items-center
  jn:rounded
...
`,u=({className:e=``,disabled:n=!1,id:r,name:i,onToggleTheme:a,...s})=>{let u=t.useStyles();u||console.warn(`Juno ThemeToggle requires a StyleProvider context in order to work. Use ThemeToggle in a Juno AppShell or include StyleProvider manually.`);let{currentTheme:d,setThemeClass:f}=u||{};return(0,c.jsx)(o,{className:`juno-theme-toggle ${l} ${e}`,disabled:n,icon:d===`theme-light`?`nightsStay`:`wbSunny`,id:r,name:i,onClick:()=>{let e=d===`theme-dark`?`theme-light`:`theme-dark`;f&&f(e),a&&a(e)},...s})};try{u.displayName=`ThemeToggle`,u.__docgenInfo={description:`ThemeToggle is a button component that toggles between Light and Dark UI Themes.
