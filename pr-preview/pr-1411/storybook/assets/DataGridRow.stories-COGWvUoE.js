import{j as e,r as o}from"./iframe-JNaT24jQ.js";import{a as s,D as u,b as i}from"./DataGridCell.component-C7XNENs_.js";import{Default as g}from"./DataGridCell.stories-BBcWKUnp.js";import{B as D}from"./Button.component-BWyPO_f6.js";import"./preload-helper-PPVm8Dsz.js";import"./Icon.component-DPwPfxhT.js";import"./Spinner.component-CKltheOB.js";const l=5,b={title:"Components/DataGrid/DataGridRow",component:s,argTypes:{items:{table:{disable:!0}},children:{control:!1,table:{type:{summary:"ReactNode"}}}},decorators:[r=>e.jsx(u,{columns:l,children:e.jsx(r,{})})],parameters:{docs:{source:{excludeDecorators:!1}}}},d={render:({items:r,...t})=>e.jsx(s,{...t,children:r.map((a,n)=>o.createElement(i,{...a,key:n}))}),args:{isSelected:!1,items:Array(l).fill({...g.args}),onClick:void 0},parameters:{docs:{description:{story:"Juno DataGridRow for use in DataGrid"}}}},c={render:({items:r,...t})=>e.jsxs(e.Fragment,{children:[e.jsx(s,{...t,children:r.map((a,n)=>o.createElement(i,{...a,key:n}))}),e.jsx(s,{...t,children:r.map((a,n)=>o.createElement(i,{...a,key:n}))})]}),args:{items:Array(l).fill({...g.args})},parameters:{docs:{description:{story:"When `onClick` is set in `DataGridRow`, it exhibits visual feedback on hover, enhancing interactivity."}}}},m={render:({...r})=>e.jsx(e.Fragment,{children:e.jsx(s,{...r,onClick:()=>alert("DataGridRow Event!"),children:e.jsx(i,{children:e.jsx(D,{label:"Trigger button event only",onClick:t=>{t.stopPropagation(),alert("Only the `Button` event has been triggered!")}})})})}),args:{items:Array(l).fill({...g.args})},parameters:{docs:{description:{story:"You can enhance `DataGridRow` by incorporating interactive elements such as `Button`. Remember to add `event.stopPropogation()` to the event handler of the interactive element."}}}},p={render:({items:r,...t})=>e.jsxs(e.Fragment,{children:[e.jsx(s,{isSelected:!0,...t,children:r.map((a,n)=>o.createElement(i,{...a,key:n}))}),e.jsx(s,{...t,children:r.map((a,n)=>o.createElement(i,{...a,key:n}))})]}),args:{items:Array(l).fill({...g.args})},parameters:{docs:{description:{story:"When `isSelected` is set, the entire `DataGridRow` persists to be active."}}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  render: ({
    items,
    ...args
  }) => <DataGridRow {...args}>
