import{j as e,r as s}from"./iframe-Cal2xOIN.js";import{a as i,D,b as n}from"./DataGridCell.component-BssK_1K5.js";import{Default as u}from"./DataGridCell.stories-D2qwXXhJ.js";import{B as C}from"./Button.component-CyjQWHfU.js";import{D as o}from"./DataGridHeadCell.component-Hvkuaefm.js";import"./preload-helper-PPVm8Dsz.js";import"./Icon.component-BC_VJ4Ha.js";import"./Spinner.component-CVZl3DsO.js";const G=5,f={title:"Components/DataGrid/DataGridRow",component:i,argTypes:{items:{table:{disable:!0}},children:{control:!1,table:{type:{summary:"ReactNode"}}}},decorators:[r=>e.jsx(D,{columns:G,children:e.jsx(r,{})})],parameters:{docs:{source:{excludeDecorators:!1}}}},d={render:({items:r,...t})=>e.jsx(i,{...t,children:r.map((a,l)=>s.createElement(n,{...a,key:l}))}),args:{isSelected:!1,items:Array(G).fill({...u.args}),onClick:void 0},parameters:{docs:{description:{story:"Juno DataGridRow for use in DataGrid"}}}},c={render:r=>e.jsxs(D,{columns:3,gridColumnTemplate:"150px 150px 150px",children:[e.jsxs(i,{children:[e.jsx(o,{children:"ID"}),e.jsx(o,{children:"Name"}),e.jsx(o,{children:"Status"})]}),Array.from({length:4},(t,a)=>s.createElement(i,{...r,key:`row_${a}`,onClick:()=>alert(`Row ${a+1} clicked (HoverableRow)`)},e.jsx(n,{children:`ID-${a+1}`},`cell_id_${a}`),e.jsx(n,{children:`Name-${a+1}`},`cell_name_${a}`),e.jsx(n,{children:`Status-${a+1}`},`cell_status_${a}`)))]}),args:{items:Array.from({length:3},(r,t)=>({content:`Cell Content ${t+1}`}))},parameters:{docs:{description:{story:"When `onClick` is set in `DataGridRow`, it exhibits visual feedback on hover, enhancing interactivity."}}}},m={render:r=>e.jsxs(D,{columns:4,gridColumnTemplate:"150px 150px 150px 150px",children:[e.jsxs(i,{children:[e.jsx(o,{children:"ID"}),e.jsx(o,{children:"Name"}),e.jsx(o,{children:"Status"}),e.jsx(o,{children:"Action"})]}),Array.from({length:4},(t,a)=>s.createElement(i,{...r,key:`row_${a}`,onClick:()=>alert(`DataGridRow Event for Row ${a+1}!`)},e.jsx(n,{children:`ID-${a+1}`},`cell_id_${a}`),e.jsx(n,{children:`Name-${a+1}`},`cell_name_${a}`),e.jsx(n,{children:`Status-${a+1}`},`cell_status_${a}`),e.jsx(n,{children:a===0?e.jsx(C,{label:"Trigger button event only",onClick:l=>{l.stopPropagation(),alert("Button clicked in Row 1")}}):"None"},`cell_button_${a}`)))]}),args:{items:Array.from({length:3},(r,t)=>({content:`Cell Content ${t+1}`}))},parameters:{docs:{description:{story:"You can enhance `DataGridRow` by incorporating interactive elements such as `Button`. Remember to add `event.stopPropogation()` to the event handler of the interactive element."}}}},p={render:({items:r,...t})=>e.jsxs(e.Fragment,{children:[e.jsx(i,{isSelected:!0,...t,children:r.map((a,l)=>s.createElement(n,{...a,key:l}))}),e.jsx(i,{...t,children:r.map((a,l)=>s.createElement(n,{...a,key:l}))})]}),args:{items:Array(G).fill({...u.args})},parameters:{docs:{description:{story:"When `isSelected` is set, the entire `DataGridRow` persists to be active."}}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  render: ({
    items,
    ...args
  }) => <DataGridRow {...args}>
