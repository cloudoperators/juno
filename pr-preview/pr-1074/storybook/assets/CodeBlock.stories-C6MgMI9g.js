import{j as e,r as W}from"./iframe-BF07MaSR.js";import{C as x}from"./CodeBlock.component-SI8zX5JZ.js";import{T as S,a as J}from"./TabList.component-D81KBS0A.js";import{T as R}from"./Tab.component-C2BoZMlB.js";import{T as P}from"./TabPanel.component-CMrvYhbk.js";import"./JsonViewer.component-CRIiaht9.js";import"./SearchInput.component-BYho01nO.js";import"./Icon.component-CGT6HHfX.js";import"./Stack.component-CF4sKDrg.js";import"./TabPanel-CWzZSYBf.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
