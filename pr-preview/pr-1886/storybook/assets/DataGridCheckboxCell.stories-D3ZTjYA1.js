    ...
    return <DataGrid columns={3} minContentColumns={[0]}>
        ...
        {items.map(item => <DataGridRow key={item.id}>
            <DataGridCheckboxCell>
              <Checkbox checked={!!selected[item.id]} onChange={e => setSelected(s => ({
            ...s,
