import{j as e,r as W}from"./iframe-C6EHvJd5.js";import{C as x}from"./CodeBlock.component-BGCHOKy5.js";import{T as S,a as J}from"./TabList.component-C6THz9zy.js";import{T as R}from"./Tab.component-91de4h69.js";import{T as P}from"./TabPanel.component-WMRbXRBM.js";import"./JsonViewer.component-C0P0Ukc7.js";import"./SearchInput.component-pszRj3uJ.js";import"./Icon.component-CFbR1FL0.js";import"./Stack.component-BPW7YUtE.js";import"./TabPanel-DZH6o3Jc.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
