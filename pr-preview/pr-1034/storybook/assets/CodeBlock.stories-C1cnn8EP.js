import{j as e,r as W}from"./iframe-isKnsl6C.js";import{C as x}from"./CodeBlock.component-BvgJDxy7.js";import{T as S,a as J}from"./TabList.component-D2o57liI.js";import{T as R}from"./Tab.component-CiMPcd-R.js";import{T as P}from"./TabPanel.component-etQJ_aWH.js";import"./JsonViewer.component-DTo2u8dM.js";import"./SearchInput.component-CeoaAyyw.js";import"./Icon.component-0W7CIVgt.js";import"./Stack.component-CFjp1K2S.js";import"./TabPanel-D1pmrJQV.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
