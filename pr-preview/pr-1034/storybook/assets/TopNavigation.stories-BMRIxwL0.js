import{j as e}from"./iframe-isKnsl6C.js";import{T as h,a as t}from"./TopNavigationItem.component-n17lnDu2.js";import"./NavigationItem.component-toTZOWSt.js";import"./Icon.component-0W7CIVgt.js";const f={title:"Navigation/TopNavigation/TopNavigation",component:h,argTypes:{children:{control:!1}}},a={args:{children:[e.jsx(t,{label:"Item 1"},"item-1"),e.jsx(t,{label:"Item 2",active:!0},"item-2"),e.jsx(t,{label:"Item with Icon",icon:"warning"},"item-3"),e.jsx(t,{label:"Disabled Item",disabled:!0},"item-4")]}},i={args:{disabled:!0,children:[e.jsx(t,{label:"Item 1"},"item-1"),e.jsx(t,{label:"Item 2"},"item-2"),e.jsx(t,{label:"Item 3"},"item-3"),e.jsx(t,{label:"Item 4"},"item-4")]},parameters:{docs:{description:{story:"All navigation items can be disabled by passing `disabled` to the `TabNavigation`."}}}},n={args:{activeItem:"i-3",children:[e.jsx(t,{label:"Item 1",value:"i-1"},"item-1"),e.jsx(t,{label:"Item 2",value:"i-2"},"item-2"),e.jsx(t,{label:"Item 3",value:"i-3"},"item-3"),e.jsx(t,{label:"Item 4",value:"i-4"},"item-4")]},parameters:{docs:{description:{story:"When needed, navigation items can take a `value` prop as a technical identifier that is different form the human-readable `label`. You may use any of the provided props as an identifier to set an active item on the parent. Alternatively, an individual `SideNavigationItem` can be set to `active`. When both an individual item is set to active and an aciveItem is set on the parent, the latter will win."}}}},o={args:{activeItem:"item-1",children:[e.jsx(t,{value:"item-1",children:"Item 1"},"i-1"),e.jsx(t,{value:"item-2",children:"Item 2"},"i-2"),e.jsx(t,{value:"item-3",children:"Item 3"},"i-3"),e.jsx(t,{value:"item-4",children:"Item 4"},"i-4")]},parameters:{docs:{description:{story:"Alternatively, navigation items can render children passed to them."}}}};var s,r,m;a.parameters={...a.parameters,docs:{...(s=a.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
...
}`,...(m=(r=a.parameters)==null?void 0:r.docs)==null?void 0:m.source}}};var l,d,c;i.parameters={...i.parameters,docs:{...(l=i.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {
    disabled: true,
...
}`,...(c=(d=i.parameters)==null?void 0:d.docs)==null?void 0:c.source}}};var p,v,I;n.parameters={...n.parameters,docs:{...(p=n.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
    activeItem: "i-3",
...
}`,...(I=(v=n.parameters)==null?void 0:v.docs)==null?void 0:I.source}}};var g,b,u;o.parameters={...o.parameters,docs:{...(g=o.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
    activeItem: "item-1",
...
}`,...(u=(b=o.parameters)==null?void 0:b.docs)==null?void 0:u.source}}};const j=["Default","Disabled","WithValues","WithChildren"];export{a as Default,i as Disabled,o as WithChildren,n as WithValues,j as __namedExportsOrder,f as default};
