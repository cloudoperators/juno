import{c as T,j as W}from"./iframe-C6EHvJd5.js";const w={title:"Layout/StyleProvider",component:T,argTypes:{stylesWrapper:{options:["head","inline","shadowRoot"],control:{type:"radio"}},children:{control:!1}}},a=o=>W.jsx(T,{...o,children:o.children||o.stylesWrapper||"undefined"}),e={render:a,args:{stylesWrapper:"head"}},r={render:a,args:{stylesWrapper:"inline"}},s={render:a,args:{stylesWrapper:"shadowRoot"}},t={render:a,args:{stylesWrapper:"shadowRoot",theme:"theme-light",children:"Light Theme"}};var n,d,p;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`{
  render: Template,
  args: {
    stylesWrapper: "head"
  }
