import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{t}from"./react-C21x__mS.js";import{t as n}from"./jsx-runtime-BdxMnOeJ.js";import{t as r}from"./Icon.component-CHPUdcSd.js";import{t as i}from"./Icon-PUWfLY2X.js";import{a,o,r as s,t as c}from"./TooltipContent.component-VjzlFhxs.js";import{t as l}from"./TooltipContent-C8EBF20j.js";import{t as u}from"./TooltipTrigger-CB9dPkhG.js";var d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E;function D(){return(D=e((()=>{t(),a(),l(),u(),i(),d=n(),f={title:`Components/Tooltip/Tooltip`,component:o,argTypes:{text:{table:{disable:!0}},triggerText:{table:{disable:!0}},children:{control:!1}},decorators:[e=>(0,d.jsx)(`div`,{className:`jn:my-6 jn:flex jn:justify-center`,children:(0,d.jsx)(e,{})})]},p=({placement:e,variant:t,initialOpen:n,open:r,triggerEvent:i,disabled:a,text:l,triggerText:u,...f})=>(0,d.jsxs)(o,{initialOpen:n,placement:e,variant:t,open:r,triggerEvent:i,disabled:a,children:[(0,d.jsx)(s,{children:(0,d.jsx)(`span`,{children:u},`tooltip-trigger-text`)}),(0,d.jsx)(c,{...f,children:l})]}),m=({initialOpen:e,placement:t,variant:n,open:i,triggerEvent:a,disabled:l,text:u,...f})=>(0,d.jsxs)(o,{initialOpen:e,placement:t,variant:n,open:i,triggerEvent:a,disabled:l,children:[(0,d.jsx)(s,{asChild:!0,children:(0,d.jsx)(r,{})}),(0,d.jsx)(c,{...f,children:u})]}),h=({initialOpen:e,placement:t,variant:n,open:r,triggerEvent:i,disabled:a,text:l,...u})=>(0,d.jsxs)(o,{initialOpen:e,placement:t,variant:n,open:r,triggerEvent:i,disabled:a,children:[(0,d.jsx)(s,{asChild:!0,children:(0,d.jsx)(s,{children:(0,d.jsx)(`button`,{children:`hover me`})})}),(0,d.jsx)(c,{...u,children:l})]}),g={args:{text:`A default tooltip`,triggerText:`click me`,initialOpen:!0},render:p},_={args:{text:`A default tooltip opened on hover`,triggerText:`hover me`,triggerEvent:`hover`},render:p},v={args:{text:`A Tooltip with asChild Icon trigger`},parameters:{docs:{description:{story:`If the asChild option is set on the TooltipTrigger the passed child element is used as the tooltip trigger. This is useful for when you want to use e.g. an Icon or Button as the trigger`}}},render:m},y={args:{text:`A Tooltip with asChild Button trigger`,triggerEvent:`hover`},parameters:{docs:{description:{story:`If the asChild option is set on the TooltipTrigger the passed child element is used as the tooltip trigger. This is useful for when you want to use e.g. an Icon or Button as the trigger`}}},render:h},b={args:{variant:`info`,text:`An Info Tooltip`,open:!0},render:m},x={args:{variant:`warning`,text:`A Warning Tooltip`,open:!0},render:m},S={args:{variant:`error`,text:`An Error Tooltip`,open:!0},render:m},C={args:{variant:`danger`,text:`A Danger Tooltip.`,open:!0},render:m},w={args:{variant:`success`,text:`A Success Tooltip`,open:!0},render:m},T={args:{text:`A disabled tooltip`,disabled:!0},render:m},E=[`Default`,`Hover`,`AsChildTooltipTrigger`,`ButtonAsChildTooltipTrigger`,`InfoTooltip`,`WarningTooltip`,`ErrorTooltip`,`DangerTooltip`,`SuccessTooltip`,`Disabled`],g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  args: {
  ...
  render: AsChildIconTemplate
}`,...T.parameters?.docs?.source}}}})))()}D();export{v as AsChildTooltipTrigger,y as ButtonAsChildTooltipTrigger,C as DangerTooltip,g as Default,T as Disabled,S as ErrorTooltip,_ as Hover,b as InfoTooltip,w as SuccessTooltip,x as WarningTooltip,E as __namedExportsOrder,f as default};