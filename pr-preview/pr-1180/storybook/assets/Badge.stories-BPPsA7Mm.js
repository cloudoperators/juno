import{I as W,K as x}from"./Icon.component-CPtFKpL7.js";import{j as v}from"./iframe-BQ-cpnA3.js";import"./preload-helper-PPVm8Dsz.js";const w=`
  jn:rounded
  jn:text-sm
  ...
  jn:justify-center
  jn:items-center
`,h={default:"jn:bg-theme-badge-default",info:"jn:bg-theme-info/25",success:"jn:bg-theme-success/25",warning:"jn:bg-theme-warning/25",danger:"jn:bg-theme-danger/25",error:"jn:bg-theme-error/25"},D="jn:mr-1 jn:items-center",E=e=>h[e]||h.default,_=(e,r)=>{if(typeof e=="string"&&V(e))return e;if(e===!0)return r},N=(e,r)=>{if(e===!0)return`jn:text-theme-${r}`},V=e=>new Set(Object.values(x)).has(e),g=({variant:e="default",icon:r=!1,text:I="",className:y="",children:S,...j})=>{const f=_(r,e),b=N(r,e);return v.jsxs("span",{className:`
        juno-badge 
        juno-badge-${e} 
        ${w} 
        ${E(e)} 
        ${r?"jn:inline-flex":""} 
        ${y}`,...j,children:[f&&v.jsx(W,{icon:f,size:"1.125rem",className:D,color:b}),S||I]})};try{g.displayName="Badge",g.__docgenInfo={description:`A Badge is used to visually represent properties or states of an entity.
