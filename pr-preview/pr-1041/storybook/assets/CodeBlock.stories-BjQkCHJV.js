import{j as e,r as W}from"./iframe-CI61WwEo.js";import{C as x}from"./CodeBlock.component-C0mU2G30.js";import{T as S,a as J}from"./TabList.component-BOA7Ljdu.js";import{T as R}from"./Tab.component-B7pH2WdW.js";import{T as P}from"./TabPanel.component-D11-_PXw.js";import"./JsonViewer.component-X-HCLCRk.js";import"./SearchInput.component-BW4tmyxA.js";import"./Icon.component-Tv7K8ju9.js";import"./Stack.component-BE6eJlXX.js";import"./TabPanel-BX0k_eap.js";import"./clsx-B-dksMZM.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),X={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
