import{j as e,r as W}from"./iframe-DDxKBds8.js";import{C as x}from"./CodeBlock.component-j84xLAi4.js";import{T as S,a as J}from"./TabList.component-Bukh8vpl.js";import{T as R}from"./Tab.component-C1RYVN6B.js";import{T as P}from"./TabPanel.component-DTntiOxd.js";import"./JsonViewer.component-D3gzyy4F.js";import"./SearchInput.component-Bu-U77xC.js";import"./Icon.component-DY4qeqbs.js";import"./Stack.component-BjuX9Xor.js";import"./TabPanel-CsFsVRdy.js";import"./clsx-B-dksMZM.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),X={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
