import{j as e,r as W}from"./iframe-DG5MajgI.js";import{C as x}from"./CodeBlock.component-CEV6xxe_.js";import{T as S,a as J}from"./TabList.component-CRDxSdqY.js";import{T as R}from"./Tab.component-Dbix8zBN.js";import{T as P}from"./TabPanel.component-DVs7oIcr.js";import"./JsonViewer.component-CDQ0Y_0v.js";import"./SearchInput.component-zvH0h0DV.js";import"./Icon.component-BF009uUP.js";import"./Stack.component-CIHupY4N.js";import"./TabPanel-DnlT_h3A.js";import"./clsx-B-dksMZM.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),X={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
