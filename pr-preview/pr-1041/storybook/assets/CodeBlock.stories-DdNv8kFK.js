import{j as e,r as W}from"./iframe-DwbrOYUU.js";import{C as x}from"./CodeBlock.component-DBFRybAb.js";import{T as S,a as J}from"./TabList.component-B8InucS3.js";import{T as R}from"./Tab.component-CD_lSmtN.js";import{T as P}from"./TabPanel.component-DeeJxCyo.js";import"./JsonViewer.component-C2CMz8VV.js";import"./SearchInput.component-D6f1qiE1.js";import"./Icon.component-BA2rWOnK.js";import"./Stack.component-yozeMvZo.js";import"./TabPanel-DehLdL87.js";import"./clsx-B-dksMZM.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),X={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
