import{j as e,r as W}from"./iframe-B3LzZBdp.js";import{C as x}from"./CodeBlock.component-CDj3o9sU.js";import{T as S,a as J}from"./TabList.component-S0R975sB.js";import{T as R}from"./Tab.component-C9pMSogs.js";import{T as P}from"./TabPanel.component-B07xftO6.js";import"./JsonViewer.component-depMkXCe.js";import"./SearchInput.component-BdkscLu1.js";import"./Icon.component-CEdfijU9.js";import"./Stack.component-l5deLhAJ.js";import"./TabPanel-C9v2X1CN.js";import"./clsx-B-dksMZM.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),X={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
