import{g as e}from"./iframe-Cx-zHds2.js";import"react";var t=e(),n=({children:e,alignTerms:n=`right`,className:r=``,...i})=>(0,t.jsx)(`dl`,{className:`dl jn:grid jn:grid-cols-4 jn:group ${n===`right`?`align-right`:`align-left`} ${r}`,...i,children:e}),r=n;try{n.displayName=`DescriptionList`,n.__docgenInfo={description:`A component that semantically represents a list of terms and their corresponding descriptions.
