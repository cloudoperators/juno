import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{U as n,W as r,tt as i}from"./iframe-CZR_tOaO.js";import{r as a,t as o}from"./Icon.component-Dr5iQNBh.js";import{t as s}from"./Icon-__N7uxCo.js";import{r as c}from"./PortalProvider.component-H2F3sSmz.js";import{t as l}from"./PortalProvider-BzOqmGT5.js";import{t as u}from"./Spinner.component-CI7sgXVX.js";import{t as d}from"./Spinner-DAKcaPDy.js";import{t as ee}from"./Label.component-XREicPzq.js";import{t as f}from"./Label-D8FH1UUh.js";import{t as p}from"./FormHint.component-TYqQXzWR.js";import{t as m}from"./FormHint-RL6rFIbX.js";import{_ as te,f as ne,h as re,m as ie,p as h,t as g}from"./headlessui.esm-BJ9IWdKO.js";import{_ as ae,d as oe,h as se,i as ce,m as le,n as ue,p as de,r as fe,s as pe,t as _}from"./floating-ui.react-26xSalTr.js";var v,me,y,he,ge,b,_e,ve,x,ye,S,C,w,T,E,D,O,k,A,j,M,N,P=t((()=>{v=e(i()),g(),_(),f(),m(),s(),d(),l(),me=e(r()),y=n(),he=`
  jn:relative
`,ge=`
...
`,M=(0,v.createContext)(void 0),N=({ariaLabel:e,children:t,className:n=``,defaultValue:r=``,disabled:i=!1,error:a=!1,errortext:s=``,helptext:l=``,id:d=``,invalid:f=!1,loading:m=!1,label:h,name:g=``,onBlur:_,onChange:N,onFocus:P,onInputChange:F,placeholder:I=`Select…`,required:L=!1,successtext:R=``,truncateOptions:z=!1,valid:B=!1,value:V=``,valueLabel:H,width:U=`full`,wrapperClassName:W=``,...be})=>{let G=e=>!(typeof e==`string`&&e.trim().length===0),xe=d||`juno-combobox-`+(0,v.useId)(),Se=`juno-combobox-helptext-`+(0,v.useId)(),[K,q]=(0,v.useState)(!1),[Ce,we]=(0,v.useState)(new Map),[J,Te]=(0,v.useState)(``),[Y,Ee]=(0,v.useState)(V),[X,De]=(0,v.useState)(!1),[Z,Oe]=(0,v.useState)(!1),[ke,Ae]=(0,v.useState)(!1),[Q,je]=(0,v.useState)(!1),[$,Me]=(0,v.useState)(!1),{x:Ne,y:Pe,strategy:Fe,refs:Ie,context:Le}=ce({open:K,onOpenChange:q,placement:`bottom-start`,middleware:[de(4),le(),oe(),se({apply({availableWidth:e,availableHeight:t,elements:n,rects:r}){Object.assign(n.floating.style,{maxWidth:`${e}px`,maxHeight:`${t}px`,minWidth:`${r.reference.width}px`,overflowY:`auto`})}})],whileElementsMounted:ae}),{getReferenceProps:Re,getFloatingProps:ze}=pe([ue(Le),fe(Le)]),Be=(e,t,n)=>{we(r=>new Map([...Array.from(r),[e??n,{val:e,label:t,children:n}]]))},Ve=(0,v.useMemo)(()=>f||!!(s&&G(s)),[f,s]),He=(0,v.useMemo)(()=>B||!!(R&&G(R)),[B,R]);(0,v.useEffect)(()=>{Ee(V)},[V]),(0,v.useEffect)(()=>{Oe(a)},[a]),(0,v.useEffect)(()=>{De(m)},[m]),(0,v.useEffect)(()=>{je(Ve)},[Ve]),(0,v.useEffect)(()=>{Me(He)},[He]);let Ue=e=>{let t=e||``;Ee(t),t&&q(!1),N&&N(t)},We=e=>{Te(e?.target?.value),F&&F(e)},Ge=e=>{Ae(!0),K||q(!0),P&&P(e)},Ke=e=>{Ae(!1),q(!1),_&&_(e)},qe=c(),Je=J===``?v.Children.toArray(t):v.Children.toArray(t).filter(e=>(0,v.isValidElement)(e)?(e.props.children?.toString()||e.props.label||e.props.value)?.toLowerCase().includes(J.toLowerCase()):!1),Ye=e=>{let t=e=>e==null||typeof e==`object`&&String(e)===`[object Object]`?``:String(e),n=Ce.get(e);return n?.children&&t(n.children)||n?.label||H||t(e)||``};return(0,y.jsx)(M.Provider,{value:{selectedValue:Y,truncateOptions:z,addOptionValueAndLabel:Be},children:(0,y.jsxs)(`div`,{className:`
        ...
        `,children:[(0,y.jsx)(ie,{defaultValue:r,disabled:i||X||Z,name:g,onChange:Ue,value:Y||r,as:`div`,...be,children:({open:t})=>((0,v.useEffect)(()=>{t!==K&&q(t)},[t]),(0,y.jsxs)(y.Fragment,{children:[(0,y.jsxs)(`div`,{ref:Ie.setReference,className:`
              ...
              `,children:[h&&G(h)&&!X&&!Z?(0,y.jsx)(ee,{text:h,disabled:i,required:L,htmlFor:xe,className:`${ge}`,floating:!0,minimized:!!(I||ke||J&&G(J)||Y&&G(Y)),...Re()}):``,(0,y.jsx)(te,{autoComplete:`off`,"aria-label":e||h,"aria-describedby":l?Se:``,id:xe,onBlur:Ke,onChange:We,onFocus:Ge,placeholder:!X&&!Z?I:``,displayValue:e=>Ye(e),className:`
                  ...
                  ${n}
                `}),X||Z?(0,y.jsx)(`span`,{className:`${j}`,children:X?(0,y.jsx)(u,{className:`jn:cursor-not-allowed`}):(0,y.jsx)(o,{icon:`errorOutline`,color:`jn:text-theme-error`,className:`jn:cursor-not-allowed`})}):$||Q?(0,y.jsx)(`span`,{className:`
                        juno-combobox-icon-container 
                        ${A} 
                        ${i?`jn:opacity-50`:``}
                      `,children:(0,y.jsx)(o,{icon:$?`checkCircle`:`dangerous`,color:$?`jn:text-theme-success`:`jn:text-theme-error`})}):``,!Z&&!X?(0,y.jsx)(ne,{className:`
