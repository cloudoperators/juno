import{j as e,r as W}from"./iframe-CJ7bM4vj.js";import{C as x}from"./CodeBlock.component-CdKaq_Vv.js";import{T as S,a as J}from"./TabList.component-C_7bxW6d.js";import{T as R}from"./Tab.component-Czmg8dPz.js";import{T as P}from"./TabPanel.component-CIeAar-7.js";import"./JsonViewer.component-ClDGKM6S.js";import"./SearchInput.component-CrX_pZUl.js";import"./Icon.component-CjkNNIF1.js";import"./Stack.component-D9AMyiD7.js";import"./TabPanel-CZG8Lz_y.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
