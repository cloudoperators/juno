import{j as n}from"./iframe-C5dZBlQC.js";import{G as l}from"./GridRow.component-BAwzwMCG.js";import{G as o}from"./GridColumn.component-6fAaBbhR.js";const S={"--grid-column-flex-grow":"1","--grid-column-flex-shrink":"0","--grid-column-flex-basis":"0","--grid-column-default-width":"auto"},i=({auto:r=!1,children:N,className:A="",..._})=>{const v=r?S:{};return n.jsx("div",{className:`juno-grid ${A}`,style:v,..._,children:N})};try{i.displayName="Grid",i.__docgenInfo={description:`A general-use grid component.
