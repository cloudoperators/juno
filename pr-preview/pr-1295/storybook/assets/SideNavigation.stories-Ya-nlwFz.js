import{j as e}from"./iframe-CjE5rxll.js";import{S as r,a as i}from"./SideNavigationItem.component-Duqc30zv.js";import{S as o}from"./SideNavigationList.component-BXRUkouI.js";import{S as l}from"./SideNavigationGroup.component-C7oJRrJ7.js";import"./preload-helper-PPVm8Dsz.js";import"./Navigation.component-BasWNVoQ.js";import"./Icon.component-SpoWxUmr.js";const u={title:"Navigation/SideNavigation/SideNavigation",component:r,decorators:[a=>e.jsx("div",{style:{width:250},children:e.jsx(a,{})})],argTypes:{children:{control:!1}}},t={args:{ariaLabel:"Default Side Navigation"},render:a=>e.jsx(r,{...a,children:e.jsxs(o,{children:[e.jsx(i,{label:"Home",href:"/"}),e.jsxs(i,{label:"Messages",children:[e.jsx(i,{label:"Inbox"}),e.jsx(i,{label:"Sent Items"})]}),e.jsx(i,{label:"Searches",icon:"search"})]})}),parameters:{docs:{description:{story:"This default setup includes a basic side navigation menu with various items, showcasing fundamental usage."}}}},n={render:a=>e.jsx(r,{...a,children:e.jsxs(o,{children:[e.jsx(i,{label:"Item 1",icon:"addCircle",selected:!0,href:"#"}),e.jsxs(i,{label:"Item 2",icon:"addCircle",children:[e.jsx(i,{label:"Sub-Child 1"}),e.jsx(i,{label:"Sub-Child 2"})]}),e.jsxs(l,{label:"Group Example",children:[e.jsx(i,{label:"Grouped Item 1"}),e.jsxs(i,{label:"Grouped Item 2",children:[e.jsx(i,{label:"Sub-Child 1"}),e.jsx(i,{label:"Sub-Child 2",selected:!0})]})]})]})}),parameters:{docs:{description:{story:"Demonstrates a SideNavigation with nested lists and groups, showing hierarchical navigation structure."}}}},s={render:a=>e.jsx(r,{...a,onActiveItemChange:d=>console.log("Active item changed:",d),children:e.jsxs(o,{children:[e.jsx(i,{label:"Dashboard",href:"/"}),e.jsxs(i,{label:"Settings",icon:"search",children:[e.jsx(i,{label:"Profile"}),e.jsx(i,{label:"Preferences"})]}),e.jsxs(l,{label:"Project Management",children:[e.jsx(i,{label:"Overview"}),e.jsxs(i,{label:"Analytics",children:[e.jsx(i,{label:"Reports"}),e.jsx(i,{label:"Statistics",selected:!0})]})]})]})}),parameters:{docs:{description:{story:"An interactive navigation setup that logs active item changes."}}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
