import{j as e}from"./jsx-runtime-D6fbYt3N.js";import{r as a}from"./index-DysCNOs_.js";import{L as O}from"./Label.component-D1jWKEjF.js";import{I as C}from"./Icon.component-Beq88pNK.js";import{F as g}from"./FormHint.component-Bac6eIcI.js";const Z=`
	jn-mb-4
	last:jn-mb-0
`,ee=`
	jn-relative
...
`,W=`
  jn-mt-0
  jn-ml-6
`,B=({checked:l=!1,className:I="",disabled:r=!1,errortext:t="",helptext:c="",id:S=void 0,invalid:v=!1,label:p=void 0,name:_=void 0,onChange:x=void 0,onClick:V=void 0,required:h=!1,successtext:n="",valid:b=!1,value:o=void 0,...d})=>{const i=k=>!(typeof k=="string"&&k.trim().length===0),E=()=>"juno-radio-"+a.useId(),j=a.useContext(U),{selectedValue:u,onChange:f,name:y,updateSelectedValue:N,disabled:m}=j||{},T=()=>j?u===o:!!l,[R,q]=a.useState(()=>T()),[G,w]=a.useState(!1),[s,D]=a.useState(!1),[$,J]=a.useState(!1),A=a.useMemo(()=>v||!!(t&&i(t)),[v,t]),F=a.useMemo(()=>b||!!(n&&i(n)),[b,n]);a.useEffect(()=>{D(A)},[A]),a.useEffect(()=>{J(F)},[F]),a.useEffect(()=>{l&&j&&u===void 0&&N&&N(o)},[]),a.useEffect(()=>{u||q(l)},[l]);const K=()=>{q(!R),f&&typeof f=="function"&&u!==o&&f(o),x&&x(o)},H=()=>u?u===o:R,Q=k=>{V&&V(k)},X=()=>{w(!0)},Y=()=>{w(!1)},M=S||E();return e.jsxs("div",{className:"jn-radio-outer",children:[e.jsxs("div",{className:`juno-radio-wrapper ${se}`,children:[e.jsxs("div",{className:`
             juno-radio 
             ${ie} 
             ${G?re:""} 
             ${r?de:""} 
