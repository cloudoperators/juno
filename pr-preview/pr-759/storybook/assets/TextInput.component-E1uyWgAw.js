import{j as a}from"./jsx-runtime-D6fbYt3N.js";import{r as e}from"./index-DysCNOs_.js";import{L as K}from"./Label.component-D1jWKEjF.js";import{I as E}from"./Icon.component-BqZJhSNn.js";import{F as h}from"./FormHint.component-BZc1fwDf.js";const Q=`
...
`,v=`
  jn-mt-0
`,T=({value:r="",id:F="",name:S=void 0,placeholder:j="",disabled:d=!1,readOnly:P=!1,required:C=!1,invalid:y=!1,valid:x=!1,autoFocus:_=!1,className:R="",autoComplete:A="off",helptext:c="",successtext:n="",errortext:l="",onChange:b=void 0,onFocus:g=void 0,onBlur:q=void 0,type:H=void 0,label:u=void 0,width:p="full",wrapperClassName:L="",...W})=>{const s=t=>!(typeof t=="string"&&t.trim().length===0),k=()=>"juno-textinput-"+e.useId(),V=e.useRef(null),[f,w]=e.useState(""),[B,m]=e.useState(!1),[i,M]=e.useState(!1),[o,O]=e.useState(!1);e.useEffect(()=>{document.hasFocus()&&V.current.contains(document.activeElement)&&m(!0)},[]),e.useEffect(()=>{w(r)},[r]);const I=e.useMemo(()=>y||!!(l&&s(l)),[y,l]),N=e.useMemo(()=>x||!!(n&&s(n)),[x,n]);e.useEffect(()=>{M(I)},[I]),e.useEffect(()=>{O(N)},[N]);const z=t=>{w(t.target.value),b&&b(t)},D=t=>{m(!0),g&&g(t)},G=t=>{m(!1),q&&q(t)},J=({disabled:t})=>o||i?a.jsxs("div",{className:`juno-textinput-row-icon-container ${ne} ${t?le:""}`,children:[i?a.jsx(E,{icon:"dangerous",color:"jn-text-theme-error"}):null,o?a.jsx(E,{icon:"checkCircle",color:"jn-text-theme-success"}):null]}):"",$=F||k();return a.jsxs("div",{children:[a.jsxs("span",{className:`
