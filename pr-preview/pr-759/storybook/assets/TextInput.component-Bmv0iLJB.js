import{j as a}from"./jsx-runtime-D6fbYt3N.js";import{r as e}from"./index-DysCNOs_.js";import{L as K}from"./Label.component-B3thB2lY.js";import{I as E}from"./Icon.component-DteN3msQ.js";import{F as h}from"./FormHint.component-Bac6eIcI.js";const Q=`
...
`,v=`
  jn-mt-0
`,T=({value:o="",id:F="",name:S,placeholder:j="",disabled:d=!1,readOnly:P=!1,required:C=!1,invalid:y=!1,valid:x=!1,autoFocus:_=!1,className:R="",autoComplete:A="off",helptext:c="",successtext:n="",errortext:l="",onChange:b,onFocus:g,onBlur:q,type:H,label:u,width:p="full",wrapperClassName:L="",...W})=>{const s=t=>!(typeof t=="string"&&t.trim().length===0),k=()=>"juno-textinput-"+e.useId(),V=e.useRef(null),[f,w]=e.useState(""),[B,m]=e.useState(!1),[i,M]=e.useState(!1),[r,O]=e.useState(!1);e.useEffect(()=>{document.hasFocus()&&V.current.contains(document.activeElement)&&m(!0)},[]),e.useEffect(()=>{w(o)},[o]);const I=e.useMemo(()=>y||!!(l&&s(l)),[y,l]),N=e.useMemo(()=>x||!!(n&&s(n)),[x,n]);e.useEffect(()=>{M(I)},[I]),e.useEffect(()=>{O(N)},[N]);const z=t=>{w(t.target.value),b&&b(t)},D=t=>{m(!0),g&&g(t)},G=t=>{m(!1),q&&q(t)},J=({disabled:t})=>r||i?a.jsxs("div",{className:`juno-textinput-row-icon-container ${ne} ${t?le:""}`,children:[i?a.jsx(E,{icon:"dangerous",color:"jn-text-theme-error"}):null,r?a.jsx(E,{icon:"checkCircle",color:"jn-text-theme-success"}):null]}):"",$=F||k();return a.jsxs("div",{children:[a.jsxs("span",{className:`
          juno-textinput-wrapper 
          ${te}
          ${p=="auto"?"jn-inline-block":"jn-block"}
          ${p=="auto"?"jn-w-auto":"jn-w-full"}
          ${L}
          `,children:[a.jsx("input",{type:H,name:S,autoComplete:A,value:f,id:$,ref:V,placeholder:j,disabled:d,readOnly:P,autoFocus:_,onChange:z,onFocus:D,onBlur:G,className:`juno-textinput 
            ${Q}
            ${u?Z:ee}
