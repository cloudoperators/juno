import{j as e}from"./jsx-runtime-D6fbYt3N.js";import{r as J}from"./index-DysCNOs_.js";import{C as S}from"./CodeBlock.component-BAEseAc8.js";import{T as L,a as P}from"./TabList.component-BTxnUz4v.js";import{T as R}from"./Tab.component-PhWIN6ar.js";import{T as K}from"./TabPanel.component-C9X2aiqv.js";import"./JsonViewer.component-BIQUI9PT.js";import"./SearchInput.component-Bd6c0jT2.js";import"./Icon.component-B0dUqIrz.js";import"./widgets-BR6-ubtP.js";import"./Stack.component-B4IgElTG.js";import"./TabPanel-SXlHHxNZ.js";const E={args:{label:"A Tab Label",children:"Tab 1"}},Z={title:"Components/CodeBlock",component:S,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1}}},U=({tabs:v,codeBlocks:W})=>e.jsxs(L,{variant:"codeblocks",children:[e.jsx(P,{children:v.map((d,c)=>J.createElement(R,{...d,key:`t-${c}`}))}),W.map((d,c)=>e.jsx(K,{children:e.jsx(S,{...d})},c))]}),n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},o={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
