import{r as n,c as N,j as a}from"./iframe-CIHUuHM3.js";import{I as _}from"./Icon.component-B4A67JeU.js";import{u as w}from"./PortalProvider.component-BJWqH0ZV.js";const S=(e,l,t)=>`
      jn:fixed
      jn:right-0
...
`,E=`
  ...
  jn:text-lg
  jn:font-bold
`,u=({heading:e="",size:l="default",opened:t=!1,closeable:o=!0,onClose:m,className:f="",children:h,...j})=>{const[r,i]=n.useState(t),[y,b]=n.useState(o),[g,c]=n.useState(!1),s=n.useRef(null),d=w();n.useEffect(()=>i(t),[t]),n.useEffect(()=>b(o),[o]),n.useEffect(()=>()=>{s.current&&clearTimeout(s.current)},[]),n.useEffect(()=>{r||(c(!0),s.current&&clearTimeout(s.current),s.current=setTimeout(()=>c(!1),500))},[r]);const x=v=>{i(!1),m?.(v)};return N.createPortal(a.jsxs("div",{className:`juno-panel ${S(r,g,l)} ${f}`,role:"dialog","aria-labelledby":"juno-panel-title",...j,children:[a.jsxs("div",{className:`juno-panel-header ${T}`,children:[a.jsx("div",{className:`juno-panel-title ${E}`,id:"juno-panel-title",children:e}),y&&a.jsx(_,{icon:"close",onClick:x,className:"juno-panel-close jn:ml-auto"})]}),a.jsx("div",{className:`juno-panel-content-wrapper ${C}`,children:h})]}),d||document.body)};try{u.displayName="Panel",u.__docgenInfo={description:`A Panel component that slides in from the right side of the screen.
