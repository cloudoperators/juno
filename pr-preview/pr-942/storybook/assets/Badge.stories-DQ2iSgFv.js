import{I as oe,K as ee}from"./Icon.component-B1ql-PdV.js";import{j as v}from"./jsx-runtime-BjG_zV1W.js";import"./index-BdGwgT04.js";const ce=`
  jn-rounded
  jn-text-sm
  ...
  jn-justify-center
  jn-items-center
`,h={default:"jn-bg-theme-badge-default",info:"jn-bg-theme-info/25",success:"jn-bg-theme-success/25",warning:"jn-bg-theme-warning/25",danger:"jn-bg-theme-danger/25",error:"jn-bg-theme-error/25"},ie="jn-mr-1 jn-items-center",de=e=>h[e]||h.default,ue=(e,r)=>{if(typeof e=="string"&&pe(e))return e;if(e===!0)return r},le=(e,r)=>{if(e===!0)return`jn-text-theme-${r}`},pe=e=>new Set(Object.values(ee)).has(e),g=({variant:e="default",icon:r=!1,text:re="",className:ae="",children:ne,...te})=>{const f=ue(r,e),se=le(r,e);return v.jsxs("span",{className:`
        juno-badge 
        juno-badge-${e} 
        ${ce} 
        ${de(e)} 
        ${r?"jn-inline-flex":""} 
        ${ae}`,...te,children:[f&&v.jsx(oe,{icon:f,size:"1.125rem",className:ie,color:se}),ne||re]})};try{g.displayName="Badge",g.__docgenInfo={description:`A Badge is used to visually represent properties or states of an entity.
...
If a string is provided and it's a valid icon name, that icon will be displayed.`,name:"icon",required:!1,type:{name:'boolean | "info" | "warning" | "danger" | "error" | "success" | "search" | "default" | "download" | "accessTime" | "accountCircle" | "addCircle" | "autoAwesomeMosaic" | "autoAwesomeMotion" | ... 38 more ...'}},text:{defaultValue:{value:""},description:`Pass an optional string of text to be rendered as content.
...
}`,...(y=(I=a.parameters)==null?void 0:I.docs)==null?void 0:y.source}}};var S,j,W;n.parameters={...n.parameters,docs:{...(S=n.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    text: "Deleted",
    icon: "deleteForever"
  }
}`,...(W=(j=n.parameters)==null?void 0:j.docs)==null?void 0:W.source}}};var b,w,D;t.parameters={...t.parameters,docs:{...(b=t.parameters)==null?void 0:b.docs,source:{originalSource:`{
  args: {
    variant: "info",
    text: "Info"
  }
