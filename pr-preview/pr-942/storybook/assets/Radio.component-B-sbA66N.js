import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as a}from"./index-DI7CEG0L.js";import{L as D}from"./Label.component-DZ9JGTj_.js";import{I as _}from"./Icon.component-BLwcN8y0.js";import{F as g}from"./FormHint.component-CxYdfrh1.js";const Z=`
	jn-mb-4
	last:jn-mb-0
`,ee=`
	jn-relative
...
`,A=`
  jn-mt-0
  jn-ml-6
`,O=({checked:o=!1,className:I="",disabled:r=!1,errortext:t="",helptext:c="",id:S,invalid:v=!1,label:p,name:E,onChange:x,onClick:V,required:h=!1,successtext:n="",valid:R=!1,value:i="",...d})=>{const l=C=>!(typeof C=="string"&&C.trim().length===0),G=()=>"juno-radio-"+a.useId(),j=a.useContext(k),{selectedValue:u,onChange:m,name:y,updateSelectedValue:N,disabled:f}=j||{},T=()=>j?u===i:!!o,[b,q]=a.useState(()=>T()),[W,w]=a.useState(!1),[s,U]=a.useState(!1),[$,J]=a.useState(!1),F=a.useMemo(()=>v||!!(t&&l(t)),[v,t]),H=a.useMemo(()=>R||!!(n&&l(n)),[R,n]);a.useEffect(()=>{U(F)},[F]),a.useEffect(()=>{J(H)},[H]),a.useEffect(()=>{o&&j&&u===void 0&&N&&N(i)},[]),a.useEffect(()=>{u||q(o)},[o]);const K=()=>{q(!b),m&&typeof m=="function"&&u!==i&&m(i),x&&x(i)},M=()=>u?u===i:b,Q=C=>{V&&V(C)},X=()=>{w(!0)},Y=()=>{w(!1)},L=S||G();return e.jsxs("div",{className:"jn-radio-outer",children:[e.jsxs("div",{className:`juno-radio-wrapper ${se}`,children:[e.jsxs("div",{className:`
             juno-radio 
             ${re} 
             ${W?le:""} 
             ${r?de:""} 
           ...
           `,...d,children:[e.jsx("input",{checked:M(),className:`
              ${r?"jn-cursor-not-allowed":"hover:jn-cursor-pointer"}
              ${oe} 
              ${s?"juno-radio-invalid":""} 
              ${$?"juno-radio-valid":""}
            `,disabled:f||r,id:L,onBlur:Y,onChange:K,onClick:Q,onFocus:X,name:y||E,type:"radio",value:i}),M()?e.jsx("span",{className:`${ie}`}):""]}),p&&l(p)?e.jsxs(e.Fragment,{children:[e.jsx(D,{className:`${me}`,disabled:f||r,htmlFor:L,required:h,text:p}),s?e.jsx(_,{icon:"dangerous",color:"jn-text-theme-error",size:"1.125rem",className:`
                    ${B}
                    ${r?"jn-opacity-50":""}
