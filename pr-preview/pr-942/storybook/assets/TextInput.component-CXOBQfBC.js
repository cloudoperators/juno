import{j as a}from"./jsx-runtime-BjG_zV1W.js";import{r as e}from"./index-BdGwgT04.js";import{L as K}from"./Label.component-D4gjYofZ.js";import{I as E}from"./Icon.component-6n8NaT9U.js";import{F as h}from"./FormHint.component-Bn51_8r6.js";const Q=`
...
`,j=`
  jn-mt-0
`,T=({value:o="",id:F="",name:S,placeholder:v="",disabled:d=!1,readOnly:P=!1,required:C=!1,invalid:y=!1,valid:x=!1,autoFocus:_=!1,className:H="",autoComplete:L="off",helptext:p="",successtext:n="",errortext:l="",onChange:b,onFocus:g,onBlur:q,type:A,label:u,width:c="full",wrapperClassName:M="",...W})=>{const s=t=>!(typeof t=="string"&&t.trim().length===0),k=()=>"juno-textinput-"+e.useId(),V=e.useRef(null),[f,w]=e.useState(""),[R,m]=e.useState(!1),[i,B]=e.useState(!1),[r,O]=e.useState(!1);e.useEffect(()=>{document.hasFocus()&&V.current.contains(document.activeElement)&&m(!0)},[]),e.useEffect(()=>{w(o)},[o]);const I=e.useMemo(()=>y||!!(l&&s(l)),[y,l]),$=e.useMemo(()=>x||!!(n&&s(n)),[x,n]);e.useEffect(()=>{B(I)},[I]),e.useEffect(()=>{O($)},[$]);const z=t=>{w(t.target.value),b&&b(t)},D=t=>{m(!0),g&&g(t)},G=t=>{m(!1),q&&q(t)},J=({disabled:t})=>r||i?a.jsxs("div",{className:`juno-textinput-row-icon-container ${ne} ${t?le:""}`,children:[i?a.jsx(E,{icon:"dangerous",color:"jn-text-theme-error"}):null,r?a.jsx(E,{icon:"checkCircle",color:"jn-text-theme-success"}):null]}):"",N=F||k();return a.jsxs("div",{className:"juno-textinput-outer-wrapper",children:[a.jsxs("span",{className:`
          juno-textinput-wrapper 
          ${te}
          ${c=="auto"?"jn-inline-block":"jn-block"}
          ${c=="auto"?"jn-w-auto":"jn-w-full"}
          ${M}
          `,children:[a.jsx("input",{type:A,name:S,autoComplete:L,value:f,id:N,ref:V,placeholder:v,disabled:d,readOnly:P,autoFocus:_,onChange:z,onFocus:D,onBlur:G,className:`juno-textinput 
            ${Q}
            ${u?Z:ee}
