import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{B as r}from"./BreadcrumbItem.component-BEXS1v_E.js";import{r as h,e as m}from"./index-BdGwgT04.js";import{I as y}from"./Icon.component-BcTr8sHk.js";import{S as I}from"./Stack.component-C9cPsQbk.js";const n=({children:a,className:o="",...u})=>{const c=h.Children.toArray(a).filter(m.isValidElement),p=c.map((b,s)=>e.jsxs(m.Fragment,{children:[e.jsx(r,{...b.props}),s<c.length-1&&e.jsx(y,{icon:"chevronRight"})]},s));return e.jsx(I,{className:`juno-breadcrumb ${o}`,gap:"1",...u,children:p})};try{n.displayName="Breadcrumb",n.__docgenInfo={description:`Breadcrumb is a component that structures navigational links in a breadcrumb trail.
