import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{r as J}from"./index-BdGwgT04.js";import{C as S}from"./CodeBlock.component-Dnu0UjD1.js";import{T as L,a as R}from"./TabList.component-MLK_7kQy.js";import{T as P}from"./Tab.component-DtBKoCxg.js";import{T as K}from"./TabPanel.component-DuTnwr05.js";import"./JsonViewer.component-fed5Yffd.js";import"./SearchInput.component-D5sqSg9_.js";import"./Icon.component-B1ql-PdV.js";import"./Stack.component-C9cPsQbk.js";import"./TabPanel-BmeRdDBb.js";const E={args:{label:"A Tab Label",children:"Tab 1"}},Y={title:"Components/CodeBlock",component:S,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},U=({tabs:v,codeBlocks:W})=>e.jsxs(L,{variant:"codeblocks",children:[e.jsx(R,{children:v.map((d,c)=>J.createElement(P,{...d,key:`t-${c}`}))}),W.map((d,c)=>e.jsx(K,{children:e.jsx(S,{...d})},c))]}),n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},o={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
