import{j as e}from"./jsx-runtime-D6fbYt3N.js";import{r as M,e as m}from"./index-DysCNOs_.js";import{v as ke}from"./v4-CQkTLCs1.js";import{S as D}from"./headlessui-float-CRaAej_Z.js";import{I as xe,K as Ae}from"./Icon.component-DivjP38f.js";import{P as we}from"./PortalProvider.component-DJiEgPYG.js";import{q as E}from"./menu-BV8S7JmC.js";import{B as V}from"./Button.component-Bb9xhaQb.js";import"./index-DxCGxluL.js";import"./keyboard-BayCKsX5.js";import"./floating-ui.react-dom-t1-XbZXo.js";import"./widgets-BR6-ubtP.js";import"./use-text-value-CqB0ebPQ.js";import"./use-tree-walker-sKJwDSu4.js";import"./Spinner.component-B1CtRX5Z.js";const{addons:Ee}=__STORYBOOK_MODULE_PREVIEW_API__,{ImplicitActionsDuringRendering:Ne}=__STORYBOOK_MODULE_CORE_EVENTS_PREVIEW_ERRORS__,{global:F}=__STORYBOOK_MODULE_GLOBAL__;var We="storybook/actions",De=`${We}/action-event`,R={depth:10,clearOnStoryChange:!0,limit:50},Se=(t,s)=>{let o=Object.getPrototypeOf(t);return!o||s(o)?o:Se(o,s)},Re=t=>!!(typeof t=="object"&&t&&Se(t,s=>/^Synthetic(?:Base)?Event$/.test(s.constructor.name))&&typeof t.persist=="function"),Be=t=>{if(Re(t)){let s=Object.create(t.constructor.prototype,Object.getOwnPropertyDescriptors(t));s.persist();let o=Object.getOwnPropertyDescriptor(s,"view"),a=o==null?void 0:o.value;return typeof a=="object"&&(a==null?void 0:a.constructor.name)==="Window"&&Object.defineProperty(s,"view",{...o,value:Object.create(a.constructor.prototype)}),s}return t},Ve=()=>typeof crypto=="object"&&typeof crypto.getRandomValues=="function"?ke():Date.now().toString(36)+Math.random().toString(36).substring(2);function $e(t,s={}){let o={...R,...s},a=function(...u){var d,g;if(s.implicit){let f=(d="__STORYBOOK_PREVIEW__"in F?F.__STORYBOOK_PREVIEW__:void 0)==null?void 0:d.storyRenders.find(l=>l.phase==="playing"||l.phase==="rendering");if(f){let l=!((g=window==null?void 0:window.FEATURES)!=null&&g.disallowImplicitActionsInRenderV8),P=new Ne({phase:f.phase,name:t,deprecated:l});if(l)console.warn(P);else throw P}}let r=Ee.getChannel(),c=Ve(),b=5,i=u.map(Be),y=u.length>1?i:i[0],h={id:c,count:0,data:{name:t,args:y},options:{...o,maxDepth:b+(o.depth||3),allowFunction:o.allowFunction||!1}};r.emit(De,h)};return a.isAction=!0,a.implicit=s.implicit,a}var p=(...t)=>{let s=R,o=t;o.length===1&&Array.isArray(o[0])&&([o]=o),o.length!==1&&typeof o[o.length-1]!="string"&&(s={...R,...o.pop()});let a=o[0];(o.length!==1||typeof a=="string")&&(a={},o.forEach(r=>{a[r]=r}));let u={};return Object.keys(a).forEach(r=>{u[r]=$e(a[r],s)}),u};const Fe=`
...
}`,...(ae=(se=S.parameters)==null?void 0:se.docs)==null?void 0:ae.source}}};var re,le,ue;C.parameters={...C.parameters,docs:{...(re=C.parameters)==null?void 0:re.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(ue=(le=C.parameters)==null?void 0:le.docs)==null?void 0:ue.source}}};var ie,pe,ce;T.parameters={...T.parameters,docs:{...(ie=T.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
