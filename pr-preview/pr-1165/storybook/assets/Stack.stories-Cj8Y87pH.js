import{j as r}from"./iframe-BgNY2w1l.js";import{S as f}from"./Stack.component-sHyxL07A.js";const y=({label:e})=>r.jsx("div",{className:`
        jn:flex
        jn:bg-juno-blue
        jn:rounded
        jn:text-white
        ...
        jn:py-3
        jn:border
        jn:border-juno-blue-7`,children:r.jsx("div",{className:"jn:m-auto",children:e})});try{y.displayName="DummyComponent",y.__docgenInfo={description:"",displayName:"DummyComponent",props:{label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string"}}}}}catch{}const z={title:"Layout/Stack",component:f,argTypes:{children:{control:!1,table:{type:{summary:"ReactNode"}}},gap:{options:["0","px","0.5","1","1.5","2","2.5","3","3.5","4","5","6","7","8","9","10","11","12","14","16","20","24","28","32","36","40","44","48","52","56","60","64","72","80","96"]}},parameters:{docs:{source:{transform:e=>e.replace(/jn:/g,"")}}}},v=e=>`
