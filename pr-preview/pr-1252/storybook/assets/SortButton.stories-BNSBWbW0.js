import{j as a}from"./iframe-TdV1PwZi.js";import{T as p}from"./ToggleButton.component-Dk_fL444.js";import{I as t}from"./Icon.component-DtbIuRMO.js";import"./preload-helper-PPVm8Dsz.js";import"./Button.component-Ch8ZKhBV.js";import"./Spinner.component-D-biRLJg.js";const s=({order:e="desc",onChange:l,options:i=[{value:"asc",label:a.jsx(t,{icon:"sortShortWideArrowUp"})},{value:"desc",label:a.jsx(t,{icon:"sortShortWideArrowDown"})}],...d})=>{const u=c=>{l?.(c)};return a.jsx(p,{options:i,value:e,onChange:u,...d})};try{s.displayName="SortButton",s.__docgenInfo={description:"",displayName:"SortButton",props:{order:{defaultValue:{value:"desc"},description:"",name:"order",required:!1,type:{name:"enum",value:[{value:'"asc"'},{value:'"desc"'}]}},onChange:{defaultValue:null,description:"",name:"onChange",required:!1,type:{name:"((_order: OrderType) => void)"}},options:{defaultValue:{value:`[
