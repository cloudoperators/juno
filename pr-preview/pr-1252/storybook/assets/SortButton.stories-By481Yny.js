import{j as a}from"./iframe-CM_Si6lY.js";import{T as p}from"./ToggleButton.component-1q8EL7hc.js";import{I as t}from"./Icon.component-B-XMNTWu.js";import"./preload-helper-PPVm8Dsz.js";import"./Button.component-DKnXZ_-s.js";import"./Spinner.component-BI-TpUVC.js";const s=({order:e="desc",onChange:l,options:i=[{value:"asc",label:a.jsx(t,{icon:"sortShortWideArrowUp"})},{value:"desc",label:a.jsx(t,{icon:"sortShortWideArrowDown"})}],...d})=>{const u=c=>{l?.(c)};return a.jsx(p,{options:i,value:e,onChange:u,...d})};try{s.displayName="SortButton",s.__docgenInfo={description:"",displayName:"SortButton",props:{order:{defaultValue:{value:"desc"},description:"",name:"order",required:!1,type:{name:"enum",value:[{value:'"asc"'},{value:'"desc"'}]}},onChange:{defaultValue:null,description:"",name:"onChange",required:!1,type:{name:"((_order: OrderType) => void)"}},onOrderChange:{defaultValue:null,description:"",name:"onOrderChange",required:!1,type:{name:"((_order: OrderType) => void)"}},options:{defaultValue:{value:`[
