import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-IGKVQItS.js";import{t as r}from"./jsx-runtime-O9QVJvLM.js";import{t as i}from"./Icon.component-DvqP7AUJ.js";import{t as a}from"./Icon-CX8jx_MN.js";import{n as o,t as s}from"./JsonViewer-dItRv9F0.js";var c,l,u,d,f=t((()=>{n(),a(),c=r(),l=`
  jn:flex
  jn:justify-end
  jn:px-3
  jn:py-2
...
`,u=`
  ...
  jn:mr-4
  jn:mt-1
`,d=({onCopy:e,isCopied:t})=>(0,c.jsxs)(`div`,{className:`juno-codeblock-bottombar ${l}`,children:[(0,c.jsx)(`span`,{className:`${u}`,children:t?`Copied!`:``}),(0,c.jsx)(i,{icon:`contentCopy`,onClick:e})]});try{d.displayName=`CodeBlockFooter`,d.__docgenInfo={description:``,displayName:`CodeBlockFooter`,filePath:`/home/runner/work/juno/juno/packages/ui-components/src/components/CodeBlock/CodeBlockFooter.component.tsx`,methods:[],props:{onCopy:{defaultValue:null,declarations:[{fileName:`ui-components/src/components/CodeBlock/CodeBlockFooter.component.tsx`,name:`CodeBlockFooterProps`}],description:`Callback function to handle the copy action.`,name:`onCopy`,parent:{fileName:`ui-components/src/components/CodeBlock/CodeBlockFooter.component.tsx`,name:`CodeBlockFooterProps`},required:!0,tags:{},type:{name:`() => void`}},isCopied:{defaultValue:null,declarations:[{fileName:`ui-components/src/components/CodeBlock/CodeBlockFooter.component.tsx`,name:`CodeBlockFooterProps`}],description:`Indicates whether the content has been copied.`,name:`isCopied`,parent:{fileName:`ui-components/src/components/CodeBlock/CodeBlockFooter.component.tsx`,name:`CodeBlockFooterProps`},required:!0,tags:{},type:{name:`boolean`}}},tags:{}}}catch{}})),p,m,h,g,_,v,y,b,x,S,C,w=t((()=>{p=e(n()),s(),f(),m=r(),h=`
  jn:bg-theme-code-block
  jn:rounded
`,g=e=>`
    jn:p-6
    ${e?`jn:break-words jn:break-all jn:whitespace-pre-wrap`:`jn:overflow-x-auto`}
  `,_=e=>{switch(e){case`small`:return`
