import{n as e,o as t}from"./rolldown-runtime-C0FnF6B9.js";import{t as n}from"./react-DiVRNtpo.js";import{t as r}from"./jsx-runtime-BdxMnOeJ.js";import{n as i,r as a}from"./Icon.component-RrYTo7Ui.js";import{n as o,t as s}from"./PortalProvider.component-DdOLbaz3.js";import{t as c}from"./Button.component-4DVsxU6y.js";import{t as l}from"./Button-mkT7ct8a.js";import{a as u,c as d,i as f,n as p,o as m,r as h,s as g,t as _,u as v}from"./PopupMenu-v5XzYvL_.js";var y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V;function H(){return(H=e((()=>{y=t(n()),_(),a(),o(),l(),b=r(),{fn:x}=__STORYBOOK_MODULE_TEST__,S={title:`Components/PopupMenu`,component:p,subcomponents:{PopupMenuToggle:d,PopupMenuOptions:f,PopupMenuItem:h,PopupMenuSection:u},argTypes:{children:{control:!1},icon:{options:[`moreVert`,...Object.keys(i)],control:{type:`select`}}},decorators:[e=>(0,b.jsx)(s,{children:(0,b.jsx)(e,{})})]},C=y.forwardRef(({className:e=``,onClick:t=void 0,...n},r)=>(0,b.jsx)(c,{ref:r,className:`my-custom-toggle ${e}`,onClick:t,...n,children:`Custom Toggle`})),C.displayName=`ToggleButton`,w=y.forwardRef((e,t)=>{let{isOpen:n}=v(),{className:r,...i}=e;return(0,b.jsx)(c,{ref:t,className:`toggle-button ${n?`
    jn:bg-theme-accent
    jn:text-theme-highest
   toggle-button-open`:`toggle-button-closed`} ${r||``}`,...i,children:e.children||`Toggle Me!`})}),w.displayName=`StyledToggleButton`,T=e=>{let{close:t}=v();return(0,b.jsx)(c,{onClick:t,...e})},E=y.forwardRef(({className:e=``,onClick:t=void 0,...n},r)=>(0,b.jsx)(c,{ref:r,icon:`moreVert`,className:e,onClick:t,...n})),E.displayName=`IconToggleButton`,D={parameters:{docs:{description:{story:"When no `<PopupMenuOptions>` child is passed, the component will render but there will be no visible menu unless passed. This story only adds a simple placeholder for the menu for illustrational purposes. OnOpen and onClose handlers will be run though, even if no PopupMenuOptions is passed."}}},args:{onOpen:x(),onClose:x(),children:(0,b.jsx)(f,{children:(0,b.jsx)(`p`,{children:`Menu goes here.`})})}},O={parameters:{docs:{description:{story:"This story has no `PopupMenuOptions` passed. The component should still render without any errors, and `onOpen` and `onClose` should be run regardless."}}},args:{onOpen:x(),onClose:x()}},k={parameters:{args:{description:{story:`Disable the default toggle.`}}},args:{onOpen:x(),onClose:x(),disabled:!0}},A={parameters:{docs:{description:{story:"Pass at least a `<PopupMenuOptions>` component with `<PopupMenuItem>` elements inside to render a functional menu. A default toggle element will be rendered."}}},args:{onOpen:x(),onClose:x(),children:(0,b.jsxs)(f,{children:[(0,b.jsx)(h,{label:`Menu Item 1`}),(0,b.jsx)(h,{label:`Menu Item 2`,icon:`deleteForever`}),(0,b.jsx)(h,{label:`Menu Item 3 Disabled`,disabled:!0})]})}},j={parameters:{docs:{description:{story:"Pass `as` as `anchor` and supply a `href` prop in order to render PopupMenuItem elements as links."}}},args:{onOpen:x(),onClose:x(),children:(0,b.jsxs)(f,{children:[(0,b.jsx)(h,{as:`a`,href:`https://github.com/cloudoperators/juno`,label:`Go to Juno on Github`}),(0,b.jsx)(h,{as:`a`,href:`https://www.sap.com`,label:`Go to sap.com`,target:`_blank`,icon:`openInNew`})]})}},M={parameters:{docs:{description:{story:"`PopupMenuItem` elements may contain random elements other than `PopupMenuItem`. In such cases you may consume the PopupMenu context using the `usePopupMenuContext` hook that contains a `close` function that can be used by custom components to close the menu if needed."}}},args:{onOpen:x(),onClose:x(),children:(0,b.jsxs)(f,{children:[(0,b.jsx)(`p`,{children:`Some content goes here.`}),(0,b.jsx)(T,{variant:`primary`,children:`Yay!`})]})}},N={parameters:{docs:{description:{story:`In order to better group and organize options, a PopupMenu menu may contain one or multiple sections with optional titles and dividers.`}}},args:{onOpen:x(),onClose:x(),children:(0,b.jsxs)(f,{children:[(0,b.jsxs)(u,{children:[(0,b.jsx)(m,{children:`Section 1`}),(0,b.jsx)(h,{label:`Menu Item 1`}),(0,b.jsx)(h,{label:`Menu Item 2`,icon:`deleteForever`})]}),(0,b.jsx)(g,{}),(0,b.jsxs)(u,{children:[(0,b.jsx)(m,{label:`Section 2`}),(0,b.jsx)(h,{label:`Menu Item 3`}),(0,b.jsx)(h,{label:`Menu Item 4 Disabled`,disabled:!0})]})]})}},P={parameters:{docs:{description:{story:`A default toggle can be rendered with a custom icon without having to pass a custom toggle element.`}}},args:{onOpen:x(),onClose:x(),icon:`warning`,children:(0,b.jsxs)(f,{children:[(0,b.jsx)(h,{label:`Menu Item 1`}),(0,b.jsx)(h,{label:`Menu Item 2`,icon:`deleteForever`}),(0,b.jsx)(h,{label:`Menu Item 3 Disabled`,disabled:!0})]})}},F={parameters:{docs:{description:{story:"In the simplest case, a toggle can contain only a string. `PopupMenu` will render a `<button>` element containing that string or any opther children."}}},args:{onOpen:x(),onClose:x(),children:[(0,b.jsx)(d,{children:`The Toggle`},`t`),(0,b.jsxs)(f,{children:[(0,b.jsx)(h,{label:`Menu Item 1`}),(0,b.jsx)(h,{label:`Menu Item 2`,icon:`deleteForever`}),(0,b.jsx)(h,{label:`Menu Item 3 Disabled`,disabled:!0})]},`m`)]}},I={parameters:{docs:{description:{story:"Pass a custom component to render `as={MyCustomComponent}` to render as a toggle. Make sure to forward refs. Note we may change the standard `<PopupMenuToggle>` to use our own `<Button>` component, in this case we would need a different example component here."}}},args:{onOpen:x(),onClose:x(),children:[(0,b.jsx)(d,{as:C},`t`),(0,b.jsxs)(f,{children:[(0,b.jsx)(h,{label:`Menu Item 1`}),(0,b.jsx)(h,{label:`Menu Item 2`,icon:`deleteForever`}),(0,b.jsx)(h,{label:`Menu Item 3 Disabled`,disabled:!0})]},`m`)]}},L={parameters:{docs:{description:{story:"A custom toggle component may consume the PopupMenu context using the `usePopupMenuContext` hook. This hook exposes the current `isOpen` state of the menu that can be used e.g. to apply conditional styling to the toggle."}}},args:{onOpen:x(),onClose:x(),children:[(0,b.jsx)(d,{as:w},`t`),(0,b.jsxs)(f,{children:[(0,b.jsx)(h,{label:`Menu Item 1`}),(0,b.jsx)(h,{label:`Menu Item 2`,icon:`deleteForever`}),(0,b.jsx)(h,{label:`Menu Item 3 Disabled`,disabled:!0})]},`m`)]}},R={parameters:{docs:{description:{story:"By default, `PopupMenuToggle` will render a `<button>` element as a toggle. When passing a custom component as a child, that will itself render a button or an element with button-like behavior, set the `PopupMenuToggle`'s `as` prop to `React.Fragment` to prevent rendering a button inside a button, which is invalid. When using a custom toggle component this way, make sure to forward refs and handle accessibility requirements properly."}}},args:{onOpen:x(),onClose:x(),children:[(0,b.jsx)(d,{as:y.Fragment,children:(0,b.jsx)(C,{})},`t`),(0,b.jsxs)(f,{children:[(0,b.jsx)(h,{label:`Menu Item 1`}),(0,b.jsx)(h,{label:`Menu Item 2`,icon:`deleteForever`}),(0,b.jsx)(h,{label:`Menu Item 3 Disabled`,disabled:!0})]},`m`)]}},z={parameters:{docs:{description:{story:`When a menu contains actions targeting multiple entity types, group actions by entity type and separate groups with a divider. Within each group, place View actions first and order remaining actions by importance and expected frequency of use, with destructive actions last. No additional divider is needed before the Delete action within a group — the group dividers already provide visual separation.`}}},args:{children:[(0,b.jsx)(d,{as:E,title:`More actions`},`t`),(0,b.jsxs)(f,{children:[(0,b.jsxs)(u,{children:[(0,b.jsx)(h,{label:`View Bucket`}),(0,b.jsx)(h,{label:`Edit Bucket`}),(0,b.jsx)(h,{label:`Empty Bucket`}),(0,b.jsx)(h,{label:`Delete Bucket`})]}),(0,b.jsx)(g,{}),(0,b.jsxs)(u,{children:[(0,b.jsx)(h,{label:`View Policy`}),(0,b.jsx)(h,{label:`Edit Policy`}),(0,b.jsx)(h,{label:`Delete Policy`})]}),(0,b.jsx)(g,{}),(0,b.jsxs)(u,{children:[(0,b.jsx)(h,{label:`View Version History`}),(0,b.jsx)(h,{label:`Suspend Versioning`}),(0,b.jsx)(h,{label:`Delete Version`})]})]},`m`)]}},B={parameters:{docs:{description:{story:`When all actions in a menu refer to a single entity type, place View actions first, order remaining actions by importance and expected frequency of use, and separate the destructive action from the rest with a horizontal divider.`}}},args:{children:[(0,b.jsx)(d,{as:E,title:`More actions`},`t`),(0,b.jsxs)(f,{children:[(0,b.jsx)(h,{label:`View Item Details`}),(0,b.jsx)(h,{label:`Copy Item`}),(0,b.jsx)(h,{label:`Share Item URL`}),(0,b.jsx)(h,{label:`Download Item`}),(0,b.jsx)(g,{}),(0,b.jsx)(h,{label:`Delete Item`})]},`m`)]}},V=[`Default`,`NoMenu`,`DisabledDefaultToggle`,`WithMenuChild`,`WithChildrenAsLinks`,`WithMenuWithRandomContent`,`WithMenuChildWithSection`,`WithIcon`,`WithToggleAndMenuChildren`,`WithToggleAsButtonComponent`,`WithToggleAsButtonStyledByState`,`WithCustomButtonComponentAsChild`,`OverflowMenuMultipleEntityGroups`,`OverflowMenuSingleEntityType`],D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
  ...
  parameters: {
    docs: {
      description: {
        story: "When all actions in a menu refer to a single entity type, place View actions first, order remaining actions by importance and expected frequency of use, and separate the destructive action from the rest with a horizontal divider."
      }
    }
  },
  args: {
...
}`,...B.parameters?.docs?.source}}}})))()}H();export{D as Default,k as DisabledDefaultToggle,O as NoMenu,z as OverflowMenuMultipleEntityGroups,B as OverflowMenuSingleEntityType,j as WithChildrenAsLinks,R as WithCustomButtonComponentAsChild,P as WithIcon,A as WithMenuChild,N as WithMenuChildWithSection,M as WithMenuWithRandomContent,F as WithToggleAndMenuChildren,I as WithToggleAsButtonComponent,L as WithToggleAsButtonStyledByState,V as __namedExportsOrder,S as default};