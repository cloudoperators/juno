import{j as e,r as W}from"./iframe-Co0hevCM.js";import{C as x}from"./CodeBlock.component-CtX6sLQv.js";import{T as S,a as J}from"./TabList.component-HmfPEH8t.js";import{T as R}from"./Tab.component-c_-EdquZ.js";import{T as P}from"./TabPanel.component-2lkqLsqj.js";import"./JsonViewer.component-DU6uIdtc.js";import"./SearchInput.component-CkN_1hlM.js";import"./Icon.component-IJHM0szB.js";import"./Stack.component-BeJ66vgf.js";import"./TabPanel-C_ezTYoS.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
