...
`,Z=`
  ...
  jn:gap-2
  jn:justify-end
`,d=({heading:l="",applicationName:n="",href:a="",className:r="",logo:o=!0,children:c,onClick:i,...p})=>{const m=typeof o=="function"||f.isValidElement(o)?o:o&&t.jsx(h,{alt:"","data-testid":"default-logo"}),u=()=>t.jsxs("div",{onClick:i,className:`juno-pageheader-logo-title ${E} ${i?"jn:cursor-pointer":""}`,role:i?"button":void 0,children:[t.jsx("div",{className:`juno-pageheader-logo-container ${x}`,children:m}),t.jsx("div",{className:`juno-pageheader-application-name ${y}`,children:n.trim()||l})]}),s=t.jsxs(t.Fragment,{children:[u(),t.jsx("div",{className:"juno-pageheader-content-container",children:t.jsx("div",{className:`juno-pageheader-options ${Z}`,children:c})})]});return t.jsx("div",{className:`juno-pageheader ${g} ${r}`,role:"banner",...p,children:t.jsx("div",{className:`juno-pageheader-inner ${j}`,children:a?t.jsx("a",{href:a,children:s}):s})})};try{d.displayName="PageHeader",d.__docgenInfo={description:"The `PageHeader` component renders a header for an application with customisable `logo`, `title` and other options.\nIdeally, the custom logo component should return an `<img />` or an inline `<svg>` element.\nWhen using SVG, ensure the file is optimized to eliminate any superfluous elements or data that can contribute to increased file size and reduced performance. `Svgo` is a great tool to optimize `svg` files. Make sure the `viewBox` element is not removed when optimizing a file for usage a a header logo.\nPass as prop to `AppShell` so it gets slotted into the correct place in the layout. If building your layout manually without `AppShell` place as first child of AppBody.",displayName:"PageHeader",props:{applicationName:{defaultValue:{value:""},description:"Name of the application.",name:"applicationName",required:!1,type:{name:"string"}},heading:{defaultValue:{value:""},description:"Deprecated - Replaced by `applicationName`. If `applicationName` is provided, it will take precedence.",name:"heading",required:!1,type:{name:"string | ReactElement<unknown, string | JSXElementConstructor<any>>"}},href:{defaultValue:{value:""},description:"Link to open when applicationName or logo is clicked. If `onClick` is provided, it will take precedence.",name:"href",required:!1,type:{name:"string"}},className:{defaultValue:{value:""},description:"Custom class names.",name:"className",required:!1,type:{name:"string"}},logo:{defaultValue:{value:"true"},description:"Application logo.",name:"logo",required:!1,type:{name:"boolean | ReactElement<unknown, string | JSXElementConstructor<any>>"}},onClick:{defaultValue:null,description:"Handler executed when `applicationName` or `logo` are clicked.",name:"onClick",required:!1,type:{name:"MouseEventHandler<HTMLDivElement>"}},children:{defaultValue:null,description:"Children to render in the header such as user name, avatar, log-in/out button, etc.",name:"children",required:!1,type:{name:"ReactNode"}}}}}catch{}export{d as P};
