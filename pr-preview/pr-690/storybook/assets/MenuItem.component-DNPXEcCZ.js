import{j as n}from"./jsx-runtime-D6fbYt3N.js";import{r as m}from"./index-DysCNOs_.js";import{w as c}from"./withDeprecationWarning.component-DcP1MqMf.js";import{q as v}from"./menu-Cd3DpD44.js";import{I as x}from"./Icon.component-XYEWmfNf.js";const w=`
	jn-overflow-hidden
	jn-flex
	jn-flex-col
	jn-rounded
...
`,I=`
	jn-text-base
`,p=m.createContext(void 0),h=({children:a=null,variant:l="normal",className:e="",...t})=>n.jsx(p.Provider,{value:{variant:l},children:n.jsx(v,{children:n.jsx("div",{className:`
					juno-menu 
					juno-menu-${l} 
					${w} 
					${l==="small"?N:I} 
					${e}
				`,role:"menu",...t,children:a})})});h.displayName="Menu";const i=c(h,"Menu is deprecated and will be removed in future versions. Use PopupMenu instead.");try{i.displayName="Menu",i.__docgenInfo={description:"",displayName:"Menu",props:{children:{defaultValue:{value:"null"},description:"The children to render in the MenuSection",name:"children",required:!1,type:{name:"ReactNode"}},variant:{defaultValue:{value:"normal"},description:"Whether the Menu will be in normal or small variant",name:"variant",required:!1,type:{name:"enum",value:[{value:'"small"'},{value:'"normal"'}]}},className:{defaultValue:{value:""},description:"Pass a custom className to the menu",name:"className",required:!1,type:{name:"string"}}}}}catch{}const _=`
 ...
 `,f=({children:a=null,className:l="",disabled:e=!1,href:t="",icon:r=null,label:j="",onClick:s=void 0,...y})=>{const o=m.useContext(p),b=(o==null?void 0:o.variant)??"normal",u=t?"a":a?"div":s?"button":"div",g=M=>{s&&s(M)};return n.jsx(v.Item,{as:u,...t&&!e&&u==="a"?{href:t}:{},onClick:s&&u==="button"&&!e?g:void 0,disabled:e,className:`
         juno-menu-item
         juno-menu-item-${u}
         ${_} 
         ${u!=="div"?q:""}
