import{j as e,r as i}from"./iframe-D1I1Il4I.js";import{C as E}from"./CodeBlock.component-y1NzDYB4.js";import{T as D,a as F}from"./TabList.component-CqZ8FjLT.js";import{T as B}from"./Tab.component-DoMxmIhc.js";import{T as m}from"./TabPanel.component-BMOXF4Kn.js";import"./preload-helper-PPVm8Dsz.js";import"./JsonViewer.component-DYW_Z3_z.js";import"./SearchInput.component-COU29hqR.js";import"./Icon.component-B76pEyav.js";import"./Stack.component-XhQN4nCd.js";import"./TabPanel-BKDb9T6o.js";const p=({tabs:c,codeBlocks:l})=>e.jsxs(D,{variant:"codeblocks",children:[e.jsx(F,{children:c.map((d,A)=>i.createElement(B,{...d,key:`t-${A}`}))}),l.map((d,A)=>e.jsx(m,{children:e.jsx(E,{...d})},A))]}),j={title:"Components/CodeBlock",component:E,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
