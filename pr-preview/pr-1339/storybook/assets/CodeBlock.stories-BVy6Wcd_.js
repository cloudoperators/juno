import{j as e,r as i}from"./iframe-CIn7mbc1.js";import{C as E}from"./CodeBlock.component-DxpLnzCm.js";import{T as D,a as F}from"./TabList.component-oNZeR1Ti.js";import{T as B}from"./Tab.component-DVwie-Cu.js";import{T as m}from"./TabPanel.component-ng5Ql3Dv.js";import"./preload-helper-PPVm8Dsz.js";import"./JsonViewer.component-BtZ6gW5T.js";import"./SearchInput.component--vgcv34K.js";import"./Icon.component-CHFffyMJ.js";import"./Stack.component-ontc1wA1.js";import"./TabPanel-DYc_sUif.js";const p=({tabs:c,codeBlocks:l})=>e.jsxs(D,{variant:"codeblocks",children:[e.jsx(F,{children:c.map((d,A)=>i.createElement(B,{...d,key:`t-${A}`}))}),l.map((d,A)=>e.jsx(m,{children:e.jsx(E,{...d})},A))]}),j={title:"Components/CodeBlock",component:E,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
