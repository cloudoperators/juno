import{j as e,r as o,e as V}from"./iframe-DM3HbEI8.js";import{a as _}from"./Navigation.component-D6xmTXxj.js";import{I as b}from"./Icon.component-B4D3YW6w.js";const E=`
  jn:px-[1.25rem]
  jn:py-[1rem]
  jn:w-[16rem]
  jn:bg-theme-sidenav
...
`,N=({ariaLabel:i="",children:a,disabled:n=!1,href:t="",icon:s,label:u="",onClick:l,open:c=!1,selected:d=!1,...f})=>{const[r,v]=o.useState(c),m=o.useContext(S);o.useEffect(()=>{v(c)},[c]);const w=p=>{n||(p.stopPropagation(),v(!r))},h=p=>{n||(r||v(!r),t?window.location.href=t:l&&l(p))},I=()=>typeof a!="string"&&V.Children.count(a)>0?e.jsx("span",{onClick:w,role:"button",tabIndex:0,children:e.jsx(b,{size:"24",className:`
          ${n?j:""}`,icon:r?"expandMore":"chevronRight"})}):null,C=()=>e.jsxs("span",{className:q,children:[s&&m===0?e.jsx(b,{className:"jn:mr-[0.25rem]",icon:s,size:"24"}):null,e.jsx("div",{className:`juno-sidenavigation-item level-${m+1}`,children:u||a})]}),g=()=>e.jsxs(e.Fragment,{children:[C(),I()]}),y=`
