...
`,N=({ariaLabel:i="",children:a,disabled:n=!1,href:t="",icon:r,label:u="",onClick:l,open:c=!1,selected:d=!1,...f})=>{const[o,v]=s.useState(c),m=s.useContext(S);s.useEffect(()=>{v(c)},[c]);const w=p=>{n||(p.stopPropagation(),v(!o))},g=p=>{n||(o||v(!o),t?window.location.href=t:l&&l(p))},I=()=>typeof a!="string"&&V.Children.count(a)>0?e.jsx("span",{onClick:w,role:"button",tabIndex:0,children:e.jsx(b,{size:"24",className:`
          juno-sidenavigation-item
          ${n?j:""}`,icon:o?"expandMore":"chevronRight"})}):null,C=()=>e.jsxs("span",{className:q,children:[r&&m===0?e.jsx(b,{icon:r,size:"24"}):null,e.jsx("div",{className:`juno-sidenavigation-item level-${m+1}`,children:u||a})]}),h=()=>e.jsxs(e.Fragment,{children:[C(),I()]}),y=`
    juno-sidenavigation-item
    ${k}
    ${n?j:""}
    ${d?"selected":""}
    ${l||t||a?"jn:cursor-pointer":"jn:cursor-default"}
  `;return e.jsxs(S.Provider,{value:m+1,children:[t?e.jsx("a",{"aria-current":d?"page":void 0,"aria-label":i,className:y,href:n?void 0:t,onClick:g,...f,children:h()}):e.jsx("button",{"aria-current":d?"page":void 0,"aria-label":i,className:y,onClick:n?void 0:g,...f,children:h()}),o&&typeof a!="string"&&a]})};try{N.displayName="SideNavigationItem",N.__docgenInfo={description:`SideNavigationItem is a versatile component designed to be used within the SideNavigation component,
