import{j as e,r as o,e as V}from"./iframe-DhZ_MK_M.js";import{a as _}from"./Navigation.component-CUafn-Rp.js";import{I as b}from"./Icon.component-DWLaUpS1.js";const E=`
  jn:px-[1rem]
  jn:py-[1.25rem]
  jn:w-[16rem]
  jn:bg-theme-sidenav
...
`,N=({ariaLabel:i="",children:a,disabled:n=!1,href:t="",icon:s,label:u="",onClick:l,open:c=!1,selected:d=!1,...f})=>{const[r,v]=o.useState(c),m=o.useContext(S);o.useEffect(()=>{v(c)},[c]);const w=p=>{n||(p.stopPropagation(),v(!r))},g=p=>{n||(r||v(!r),t?window.location.href=t:l&&l(p))},I=()=>typeof a!="string"&&V.Children.count(a)>0?e.jsx("span",{onClick:w,role:"button",tabIndex:0,children:e.jsx(b,{size:"24",className:`
          ...
          ${n?j:""}`,icon:r?"expandMore":"chevronRight"})}):null,C=()=>e.jsxs("span",{className:q,children:[s&&m===0?e.jsx(b,{icon:s,size:"24"}):null,e.jsx("div",{className:`juno-sidenavigation-item level-${m+1}`,children:u||a})]}),h=()=>e.jsxs(e.Fragment,{children:[C(),I()]}),y=`
    juno-sidenavigation-item
    ${k}
    ${n?j:""}
    ${d?"selected":""}
