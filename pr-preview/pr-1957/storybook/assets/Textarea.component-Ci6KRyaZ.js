import{n as e,o as t}from"./rolldown-runtime-C0FnF6B9.js";import{t as n}from"./react-C21x__mS.js";import{t as r}from"./jsx-runtime-BdxMnOeJ.js";import{t as i}from"./Icon.component-CeSd25G7.js";import{t as a}from"./Icon-CFyhWgxo.js";import{t as o}from"./Label.component-DOSKHppz.js";import{t as s}from"./Label-DvnYklPU.js";import{n as c,t as l}from"./FormHint.component-CpRixu1s.js";var u,d,f,p,m,h,g,_,v,y,b,x,S,C;function w(){return(w=e((()=>{u=t(n()),s(),a(),c(),d=r(),f=`
  jn:inline-block
  jn:relative
`,p=`
...
`,S=`
  jn:mt-0
`,C=({name:e,value:t=``,id:n=``,placeholder:r=``,disabled:a=!1,readOnly:s=!1,required:c=!1,invalid:C=!1,valid:w=!1,autoFocus:T=!1,className:E=``,autoComplete:D=`off`,helptext:O=``,successtext:k=``,errortext:A=``,onChange:j,onFocus:M,onBlur:N,label:P,width:F=`full`,wrapperClassName:ee=``,...I})=>{let L=e=>typeof e!=`string`||e.trim().length!==0,R=(0,u.useId)(),z=(0,u.useRef)(null),[B,V]=(0,u.useState)(``),[H,U]=(0,u.useState)(!1),[W,G]=(0,u.useState)(!1),[K,q]=(0,u.useState)(!1);(0,u.useEffect)(()=>{document.hasFocus()&&z.current&&z.current.contains(document.activeElement)&&U(!0)},[]),(0,u.useEffect)(()=>{V(t.toString())},[t]);let J=(0,u.useMemo)(()=>C||!!(A&&L(A)),[C,A]),Y=(0,u.useMemo)(()=>w||!!(k&&L(k)),[w,k]);(0,u.useEffect)(()=>{G(J)},[J]),(0,u.useEffect)(()=>{q(Y)},[Y]);let X=e=>{V(e.target.value),j&&j(e)},Z=e=>{U(!0),M&&M(e)},Q=e=>{U(!1),N&&N(e)},te=({disabled:e})=>K||W?(0,d.jsxs)(`div`,{className:`juno-textinput-row-icon-container ${b} ${e?x:``}`,children:[W?(0,d.jsx)(i,{icon:`dangerous`,color:`jn:text-theme-error`}):null,K?(0,d.jsx)(i,{icon:`checkCircle`,color:`jn:text-theme-success`}):null]}):``,$=n||`juno-textarea-`+R;return(0,d.jsxs)(`div`,{children:[(0,d.jsxs)(`div`,{className:`
