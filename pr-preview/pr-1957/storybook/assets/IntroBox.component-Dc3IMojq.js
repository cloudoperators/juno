import{n as e,o as t}from"./rolldown-runtime-C0FnF6B9.js";import{t as n}from"./react-C21x__mS.js";import{t as r}from"./jsx-runtime-BdxMnOeJ.js";var i,a,o,s,c,l,u;function d(){return(d=e((()=>{i=t(n()),a=r(),o=(e,t)=>`
...
`,c=(e,t)=>`
    ...
    `,l=`
    jn:font-bold
`,u=({title:e=``,text:t=``,variant:n=`default`,heroImage:r=``,className:u=``,children:d,...f})=>{let p=(0,i.useMemo)(()=>r&&n===`hero`,[n,r]);return(0,a.jsxs)(`div`,{className:`juno-introbox ${o(n,r)} ${u}`,style:p?{backgroundImage:`${r}`}:{},...f,children:[(0,a.jsx)(`div`,{className:`${s}`}),(0,a.jsxs)(`div`,{className:`${c(n,r)}`,children:[e?(0,a.jsx)(`p`,{className:`${l}`,children:e}):``,d||(0,a.jsx)(`p`,{children:t})]})]})};try{u.displayName=`IntroBox`,u.__docgenInfo={description:`The \`IntroBox\` component presents important information about the contents,
