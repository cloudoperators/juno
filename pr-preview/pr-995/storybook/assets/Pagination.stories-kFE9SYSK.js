import{r as j,j as t}from"./iframe-8-cwDH10.js";import{S as ie}from"./Stack.component-DpSD1Bvd.js";import{B as q}from"./Button.component-BnXPmQEf.js";import{S as se}from"./Spinner.component-BOOVsHtD.js";import{T as oe}from"./TextInput.component-DEa-I-Gl.js";import{S as le,a as ue}from"./SelectOption.component-Cbu3a8Ku.js";import{P as de}from"./PortalProvider.component-B24QbBZK.js";import"./Icon.component-CTo8OzKg.js";import"./Label.component-CjpRzVf7.js";import"./FormHint.component-CBvorvU4.js";import"./portal-B6i3uJTl.js";import"./floating-ui.react-C61xqVZI.js";import"./frozen-BWO_mdWb.js";import"./use-text-value-CP4rjVox.js";const pe=`
  jn-flex
  jn-gap-[0.375rem]
  jn-items-center
`,ce="jn-ml-3",me="justify-normal",h=({variant:i="default",currentPage:b,totalPages:P,pages:l,disabled:u=!1,isFirstPage:M,isLastPage:Q,onPressPrevious:w,onPressNext:S,onSelectChange:y,onInputChange:N,onKeyPress:C,onBlur:T,progress:d=!1,className:U="",...X})=>{const[n,s]=j.useState(b),[r,k]=j.useState(l||P);j.useEffect(()=>{s(b),k(l||P),n!==void 0&&r!==void 0&&n>r&&s(r)},[b,P,l]);const Y=()=>{let e;n!==void 0&&n>1&&(e=n-1,s(e)),w&&w(e)},Z=()=>{let e;n!==void 0&&(r===void 0||n<r)&&(e=n+1,s(e)),S&&S(e)},ee=e=>{if(e===void 0)return;let a;typeof e=="string"||Array.isArray(e)?a=parseInt(Array.isArray(e)?e[0]:e,10):a=e,!(a===void 0||isNaN(a))&&(s(a),y==null||y(a))},ne=e=>{let a=e.target.value?parseInt(e.target.value,10):void 0;a!==void 0&&(a<1?a=1:r!==void 0&&a>r&&(a=r)),s(a),N&&N(a)},ae=e=>{e.key==="Enter"&&n!==void 0&&C&&C(n)},te=()=>{T&&T(n)},re=()=>{let e=n!==void 0&&!isNaN(n)?n.toString().length:1;return e=e>5?5:e,{width:`${(e*.6+2.1).toFixed(1)}rem`}};return t.jsxs("div",{className:`juno-pagination juno-pagination-${i||"default"} ${pe} ${U}`,...X,children:[t.jsx(q,{icon:"chevronLeft",disabled:!!M||!!u||!!d||n===1,onClick:Y,title:"Previous Page"}),d?t.jsx(se,{size:"small",color:"default",className:ce}):"",i&&!d?(()=>{switch(i){case"number":return n!==void 0?t.jsxs("div",{className:"page-value",children:[" ",n]}):"";case"select":return t.jsx(le,{name:"totalPages",width:"auto",value:n==null?void 0:n.toString(),onChange:ee,disabled:u,children:(()=>{const e=[];if(r!==void 0)for(let a=0;a<r;a++){const x=(a+1).toString();e.push(t.jsx(ue,{value:x,label:x},x))}return e})()});case"input":return t.jsxs(ie,{gap:"2",alignment:"center",children:[t.jsx("div",{className:"juno-pagination-wrapper",style:re(),children:t.jsx(oe,{value:n!==void 0?n:"",onChange:ne,onBlur:te,onKeyPress:ae,disabled:!!u,className:me,maxLength:6})}),r!==void 0?t.jsxs("span",{children:["of ",r]}):""]});default:return""}})():"",t.jsx(q,{icon:"chevronRight",disabled:!!Q||!!u||!!d||n!==void 0&&r!==void 0&&n===r,onClick:Z,title:"Next Page"})]})};try{h.displayName="Pagination",h.__docgenInfo={description:"The Pagination component provides navigation controls for paginated content.",displayName:"Pagination",props:{variant:{defaultValue:{value:"default"},description:`The variant determines the style and user interaction method of the Pagination component:
...
}`,...(I=(W=p.parameters)==null?void 0:W.docs)==null?void 0:I.source}}};var V,D,A;c.parameters={...c.parameters,docs:{...(V=c.parameters)==null?void 0:V.docs,source:{originalSource:`{
  render: Template,
  args: {
    variant: "number",
    currentPage: 12,
...
}`,...(J=(H=v.parameters)==null?void 0:H.docs)==null?void 0:J.source}}};const qe=["Default","PaginationWithNumber","PaginationWithSelect","PaginationWithInput","DisabledPagination","ProgressPagination"];export{p as Default,f as DisabledPagination,g as PaginationWithInput,c as PaginationWithNumber,m as PaginationWithSelect,v as ProgressPagination,qe as __namedExportsOrder,ke as default};
