import{j as e,r as W}from"./iframe-D_NY3Wq-.js";import{C as x}from"./CodeBlock.component-CrrRJpkG.js";import{T as S,a as J}from"./TabList.component-CBlT9Ecz.js";import{T as R}from"./Tab.component-C6jRlSmR.js";import{T as P}from"./TabPanel.component-DVbyokah.js";import"./JsonViewer.component-BhrhPxBD.js";import"./SearchInput.component-CHwnulVX.js";import"./Icon.component-DDSh8YIW.js";import"./Stack.component-D6ZB86Qv.js";import"./TabPanel-DogDAp8G.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
