import{j as e,r as J}from"./iframe-BTuQkvQ2.js";import{C as S}from"./CodeBlock.component-DpYzm_eH.js";import{T as L,a as R}from"./TabList.component-C8jApqcH.js";import{T as P}from"./Tab.component-C6s7W0LX.js";import{T as K}from"./TabPanel.component-Dl1SYJRO.js";import"./JsonViewer.component-DVub7QWk.js";import"./SearchInput.component-BXYly8Br.js";import"./Icon.component-DIwd9lFq.js";import"./Stack.component-BtFWc00G.js";import"./TabPanel--1R6Hth5.js";const E={args:{label:"A Tab Label",children:"Tab 1"}},X={title:"Components/CodeBlock",component:S,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},U=({tabs:v,codeBlocks:W})=>e.jsxs(L,{variant:"codeblocks",children:[e.jsx(R,{children:v.map((d,c)=>J.createElement(P,{...d,key:`t-${c}`}))}),W.map((d,c)=>e.jsx(K,{children:e.jsx(S,{...d})},c))]}),n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},o={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
