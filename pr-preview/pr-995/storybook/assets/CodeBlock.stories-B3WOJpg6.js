import{j as e,r as W}from"./iframe-BWSVa5SS.js";import{C as x}from"./CodeBlock.component-BHG3EvVd.js";import{T as S,a as J}from"./TabList.component-BZ0-BwG5.js";import{T as R}from"./Tab.component-EDf0dxr2.js";import{T as P}from"./TabPanel.component-C9Lolox8.js";import"./JsonViewer.component-rjmYO3gE.js";import"./SearchInput.component-CMHNqfq3.js";import"./Icon.component-BXsBOa6C.js";import"./Stack.component-CkQNh0UQ.js";import"./TabPanel-KXO-KnIg.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
