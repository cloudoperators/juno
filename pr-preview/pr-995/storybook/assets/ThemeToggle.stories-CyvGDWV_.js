import{c as j,j as v}from"./iframe-9Ty3EMVT.js";import{I as S}from"./Icon.component-QW3vMm9t.js";const x=`
  jn-inline-flex 
  jn-justify-center 
  jn-items-center
  jn-rounded
...
`,n=({className:o="",disabled:p=!1,id:f,name:T,onToggleTheme:a,...y})=>{const s=j.useStyles();s||console.warn("Juno ThemeToggle requires a StyleProvider context in order to work. Use ThemeToggle in a Juno AppShell or include StyleProvider manually.");const{currentTheme:r,setThemeClass:l}=s||{},b=()=>{const i=r==="theme-dark"?"theme-light":"theme-dark";l&&l(i),a&&a(i)};return v.jsx(S,{className:`juno-theme-toggle ${x} ${o}`,disabled:p,icon:r==="theme-light"?"nightsStay":"wbSunny",id:f,name:T,onClick:b,...y})};try{n.displayName="ThemeToggle",n.__docgenInfo={description:`ThemeToggle is a button component that toggles between Light and Dark UI Themes.
...
If not using the AppShell, include a StyleProvider manually.`,displayName:"ThemeToggle",props:{className:{defaultValue:{value:""},description:"Additional CSS classes for custom styling.",name:"className",required:!1,type:{name:"string"}},disabled:{defaultValue:{value:"false"},description:"If true, the ThemeToggle will be disabled and not respond to user input.",name:"disabled",required:!1,type:{name:"boolean"}},id:{defaultValue:null,description:"HTML id attribute for the ThemeToggle.",name:"id",required:!1,type:{name:"string"}},name:{defaultValue:null,description:"HTML name attribute for the ThemeToggle.",name:"name",required:!1,type:{name:"string"}},onToggleTheme:{defaultValue:null,description:"Callback function that is called when the theme is toggled.",name:"onToggleTheme",required:!1,type:{name:"((newTheme: string) => void)"}}}}}catch{}const k={title:"WIP/ThemeToggle",component:n,argTypes:{}},e={parameters:{},args:{}},t={args:{disabled:!0}};var c,d,m;e.parameters={...e.parameters,docs:{...(c=e.parameters)==null?void 0:c.docs,source:{originalSource:`{
  parameters: {},
  args: {}
}`,...(m=(d=e.parameters)==null?void 0:d.docs)==null?void 0:m.source}}};var u,g,h;t.parameters={...t.parameters,docs:{...(u=t.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
    disabled: true
  }
