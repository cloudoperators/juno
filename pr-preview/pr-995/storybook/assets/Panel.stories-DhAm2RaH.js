import{j as e}from"./iframe-8-cwDH10.js";import{P as l,a as m}from"./PanelBody.component-DE70o3L5.js";import{P as p}from"./PortalProvider.component-B24QbBZK.js";import"./Icon.component-CTo8OzKg.js";const v={title:"Layout/Panel/Panel",component:l,argTypes:{children:{control:!1,table:{type:{summary:"ReactNode"}}},heading:{table:{type:{summary:"ReactNode"}}}},decorators:[r=>e.jsx(p,{children:e.jsx("div",{className:"jn-contrast-100",children:r()})})]},h=r=>e.jsxs("div",{children:[e.jsx(l,{...r,children:e.jsx(m,{children:"Panel Body Content"})}),e.jsx("div",{className:"dummy-css-ignore jn-h-[150px]",children:"Content Area"})]}),n={args:{heading:"Panel Heading",opened:!0},parameters:{docs:{description:{story:'The panel component slides into view from the right. It is to be used as a drawer containing forms for actions on the current view, like "new item" etc. Panels should have a heading.'}}}},a=h.bind({});a.args={opened:!0};var s,o,t;n.parameters={...n.parameters,docs:{...(s=n.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
