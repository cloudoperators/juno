import{j as e,r as W}from"./iframe-BJ4-9zl6.js";import{C as x}from"./CodeBlock.component-B5uZvSAf.js";import{T as S,a as J}from"./TabList.component-BhWLdlzD.js";import{T as R}from"./Tab.component-BiFI1yfZ.js";import{T as P}from"./TabPanel.component-Dg8sY-sO.js";import"./JsonViewer.component-b8ZsmELb.js";import"./SearchInput.component-ByQ9uME0.js";import"./Icon.component-BlpBxAQ3.js";import"./Stack.component-DkhMXesq.js";import"./TabPanel-BgIDAW9S.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
