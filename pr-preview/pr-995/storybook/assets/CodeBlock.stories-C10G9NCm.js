import{j as e,r as J}from"./iframe-9Ty3EMVT.js";import{C as S}from"./CodeBlock.component-Dadp1A8u.js";import{T as L,a as R}from"./TabList.component-CQYOmQsu.js";import{T as P}from"./Tab.component-QnnhTEUh.js";import{T as K}from"./TabPanel.component-OUX0iwdO.js";import"./JsonViewer.component-ZKBocDfj.js";import"./SearchInput.component-8-VWZKTo.js";import"./Icon.component-QW3vMm9t.js";import"./Stack.component-OIlxi40B.js";import"./TabPanel-B4UiuCSH.js";const E={args:{label:"A Tab Label",children:"Tab 1"}},X={title:"Components/CodeBlock",component:S,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},U=({tabs:v,codeBlocks:W})=>e.jsxs(L,{variant:"codeblocks",children:[e.jsx(R,{children:v.map((d,c)=>J.createElement(P,{...d,key:`t-${c}`}))}),W.map((d,c)=>e.jsx(K,{children:e.jsx(S,{...d})},c))]}),n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},o={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
