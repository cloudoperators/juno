import{j as e,r as J}from"./iframe-BFEr-twC.js";import{C as S}from"./CodeBlock.component-DsTzGjZp.js";import{T as L,a as R}from"./TabList.component-Dzsw0lLs.js";import{T as P}from"./Tab.component-CNO_pBGV.js";import{T as K}from"./TabPanel.component-BXYiO18K.js";import"./JsonViewer.component-BtJPM2oz.js";import"./SearchInput.component-DQwDGClj.js";import"./Icon.component-BHttO1Sx.js";import"./Stack.component-DTjp3pOn.js";import"./TabPanel-CWqrPREi.js";const E={args:{label:"A Tab Label",children:"Tab 1"}},X={title:"Components/CodeBlock",component:S,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},U=({tabs:v,codeBlocks:W})=>e.jsxs(L,{variant:"codeblocks",children:[e.jsx(R,{children:v.map((d,c)=>J.createElement(P,{...d,key:`t-${c}`}))}),W.map((d,c)=>e.jsx(K,{children:e.jsx(S,{...d})},c))]}),n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},o={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
