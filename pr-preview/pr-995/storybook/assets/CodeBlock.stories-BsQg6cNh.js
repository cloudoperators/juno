import{j as e,r as W}from"./iframe-CerBUOeu.js";import{C as x}from"./CodeBlock.component-5y3Nxt54.js";import{T as S,a as J}from"./TabList.component-Dc8RBqrM.js";import{T as R}from"./Tab.component-DCIbJuGU.js";import{T as P}from"./TabPanel.component-DAyFETN0.js";import"./JsonViewer.component-CJmDgGA9.js";import"./SearchInput.component-Tu4WWXN1.js";import"./Icon.component-BDE1vF8K.js";import"./Stack.component-DVZKnrcK.js";import"./TabPanel-piXw5Sv_.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
