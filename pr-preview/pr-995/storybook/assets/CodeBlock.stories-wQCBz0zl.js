import{j as e,r as W}from"./iframe-D8YqRCUk.js";import{C as x}from"./CodeBlock.component-Doq41-Xl.js";import{T as S,a as J}from"./TabList.component-L2eDyfgi.js";import{T as R}from"./Tab.component-DQQ-v6mX.js";import{T as P}from"./TabPanel.component-BXSrmn6B.js";import"./JsonViewer.component-D9XWAN7d.js";import"./SearchInput.component-BeqTRS_H.js";import"./Icon.component-DhIcW0y2.js";import"./Stack.component-CZH7MA3a.js";import"./TabPanel-CqtfEuxP.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
