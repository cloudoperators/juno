import{j as e,r as J}from"./iframe-8-cwDH10.js";import{C as S}from"./CodeBlock.component-B7SG6z-Q.js";import{T as L,a as R}from"./TabList.component-B88nWqyW.js";import{T as P}from"./Tab.component-MNBdzbtw.js";import{T as K}from"./TabPanel.component-D0GD5cqe.js";import"./JsonViewer.component-BDzAJlhD.js";import"./SearchInput.component-B5EfAVjp.js";import"./Icon.component-CTo8OzKg.js";import"./Stack.component-DpSD1Bvd.js";import"./TabPanel-CK4j7biZ.js";const E={args:{label:"A Tab Label",children:"Tab 1"}},X={title:"Components/CodeBlock",component:S,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},U=({tabs:v,codeBlocks:W})=>e.jsxs(L,{variant:"codeblocks",children:[e.jsx(R,{children:v.map((d,c)=>J.createElement(P,{...d,key:`t-${c}`}))}),W.map((d,c)=>e.jsx(K,{children:e.jsx(S,{...d})},c))]}),n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},o={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
