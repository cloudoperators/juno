import{j as e,r as W}from"./iframe-CtGHvtSK.js";import{C as x}from"./CodeBlock.component-C4mhDMKC.js";import{T as S,a as J}from"./TabList.component-jIcfYVV7.js";import{T as R}from"./Tab.component-B8jDH1I5.js";import{T as P}from"./TabPanel.component-QJrH6wNG.js";import"./JsonViewer.component-BJGJDY6j.js";import"./SearchInput.component-CB0h3iXY.js";import"./Icon.component-WvdjbAtF.js";import"./Stack.component-D5znmGbz.js";import"./TabPanel-u6mmnrpB.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
