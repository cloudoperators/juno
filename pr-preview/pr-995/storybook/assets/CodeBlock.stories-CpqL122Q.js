import{j as e,r as W}from"./iframe-BTXmk3MZ.js";import{C as x}from"./CodeBlock.component-B_V8tcTX.js";import{T as S,a as J}from"./TabList.component-CMIQh_Gh.js";import{T as R}from"./Tab.component-Dc60wyHl.js";import{T as P}from"./TabPanel.component-j_JbaXSV.js";import"./JsonViewer.component-DbSoAIYu.js";import"./SearchInput.component-B_8qxSJz.js";import"./Icon.component-BRnXO-D3.js";import"./Stack.component-CKi_ikF9.js";import"./TabPanel-DpLAkDoI.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
