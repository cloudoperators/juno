import{j as e,r as J}from"./iframe-CTR9i8U0.js";import{C as S}from"./CodeBlock.component--X1YKCyD.js";import{T as L,a as R}from"./TabList.component-Du0XyhKq.js";import{T as P}from"./Tab.component-CDENPzRk.js";import{T as K}from"./TabPanel.component-DgMKGCom.js";import"./JsonViewer.component-C7Pz9QQH.js";import"./SearchInput.component-BKfPSwKG.js";import"./Icon.component-BDAzSom4.js";import"./Stack.component-BMF9SEuR.js";import"./TabPanel-BEyA76ua.js";const E={args:{label:"A Tab Label",children:"Tab 1"}},X={title:"Components/CodeBlock",component:S,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},U=({tabs:v,codeBlocks:W})=>e.jsxs(L,{variant:"codeblocks",children:[e.jsx(R,{children:v.map((d,c)=>J.createElement(P,{...d,key:`t-${c}`}))}),W.map((d,c)=>e.jsx(K,{children:e.jsx(S,{...d})},c))]}),n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},o={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
