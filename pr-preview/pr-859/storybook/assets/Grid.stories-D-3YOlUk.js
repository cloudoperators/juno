import{j as n}from"./jsx-runtime-BP6H2k8O.js";import{G as l}from"./GridRow.component-BJkaqhPM.js";import{G as o}from"./GridColumn.component-mxtSyCaA.js";import"./index-DysCNOs_.js";const T={"--grid-column-flex-grow":"1","--grid-column-flex-shrink":"0","--grid-column-flex-basis":"0","--grid-column-default-width":"auto"},e=({auto:r=!1,children:_,className:A="",...v})=>{const S=r?T:{};return n.jsx("div",{className:`juno-grid ${A}`,style:S,...v,children:_})};try{e.displayName="Grid",e.__docgenInfo={description:`A general-use grid component.
