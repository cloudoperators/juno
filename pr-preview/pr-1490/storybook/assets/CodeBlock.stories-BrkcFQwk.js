import{j as e,r as i}from"./iframe-C83ux939.js";import{C as E}from"./CodeBlock.component-BxOZBq_F.js";import{T as D,a as F}from"./TabList.component-DQ_oKKJs.js";import{T as B}from"./Tab.component-B4tbJVGL.js";import{T as m}from"./TabPanel.component-BoPj9i0T.js";import"./preload-helper-PPVm8Dsz.js";import"./JsonViewer.component-DWAvEATx.js";import"./SearchInput.component-C0XLvgOl.js";import"./Icon.component-TYkSRJF0.js";import"./Stack.component-5sf5mFdC.js";import"./TabPanel--DquaRXr.js";const p=({tabs:c,codeBlocks:l})=>e.jsxs(D,{variant:"codeblocks",children:[e.jsx(F,{children:c.map((d,A)=>i.createElement(B,{...d,key:`t-${A}`}))}),l.map((d,A)=>e.jsx(m,{children:e.jsx(E,{...d})},A))]}),j={title:"Components/CodeBlock",component:E,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
