import{j as e,r as i}from"./iframe-pJarEpEu.js";import{C as E}from"./CodeBlock.component-DWiGW4S1.js";import{T as D,a as F}from"./TabList.component-BmS3TZF-.js";import{T as B}from"./Tab.component-DJWyG1GN.js";import{T as m}from"./TabPanel.component-BAGYmNEg.js";import"./preload-helper-PPVm8Dsz.js";import"./JsonViewer.component-DtdfRolW.js";import"./SearchInput.component-KR4mJlIB.js";import"./Icon.component-CbuMpMA8.js";import"./Stack.component-D1D3SFom.js";import"./TabPanel-BL7Od936.js";const p=({tabs:c,codeBlocks:l})=>e.jsxs(D,{variant:"codeblocks",children:[e.jsx(F,{children:c.map((d,A)=>i.createElement(B,{...d,key:`t-${A}`}))}),l.map((d,A)=>e.jsx(m,{children:e.jsx(E,{...d})},A))]}),j={title:"Components/CodeBlock",component:E,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
