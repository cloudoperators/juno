import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-CSnjoAvk.js";import{t as r}from"./react-dom-CGisJMlQ.js";import{t as i}from"./jsx-runtime-O9QVJvLM.js";import{t as a}from"./Icon.component-Wek_1Cmc.js";import{t as o}from"./Icon-Crw5TJDk.js";import{r as s}from"./PortalProvider.component-QtHhXQzy.js";import{t as c}from"./PortalProvider-DsUwbYgj.js";import{_ as ee,h as te,i as ne,m as re,n as ie,p as ae,r as oe,s as se,t as l,u as ce}from"./floating-ui.react-LTbkmXz8.js";import{t as le}from"./Spinner.component-DE21MZRi.js";import{t as u}from"./Spinner-RluGSYbz.js";import{t as ue}from"./Label.component-NthLmulI.js";import{t as d}from"./Label-CdB29q0p.js";import{t as f}from"./FormHint.component-CKmx24-K.js";import{t as p}from"./FormHint-9MUllOTc.js";import{c as m,l as de,s as fe,t as h,u as pe,v as me}from"./headlessui.esm-B0SDWI_D.js";var g=t((()=>{})),_,v,y,b,x,S,C,w,T,E,D,O,k,A=t((()=>{_=e(n()),h(),d(),o(),u(),p(),l(),c(),v=e(r()),g(),y=i(),b=`
  jn:no-wrap
...
`,O=(0,_.createContext)(void 0),k=({ariaLabel:e=``,children:t,className:n=``,defaultValue:r,disabled:i=!1,error:o=!1,errortext:c=``,helptext:l=``,id:u=``,invalid:d=!1,label:p,loading:m=!1,multiple:h=!1,name:g,onChange:k,onValueChange:A,placeholder:j=`Select…`,required:M=!1,successtext:N=``,truncateOptions:P=!1,valid:F=!1,value:I,valueLabel:L,variant:R=`default`,width:z=`full`,wrapperClassName:B=``,...he})=>{let V=e=>!(typeof e==`string`&&e.trim().length===0),ge=(0,_.useId)(),H=`juno-select-helptext-`+(0,_.useId)(),[U,W]=(0,_.useState)(!1),G=u||`juno-select-`+ge,[K,_e]=(0,_.useState)(new Map),[q,ve]=(0,_.useState)(!1),[J,ye]=(0,_.useState)(!1),[Y,be]=(0,_.useState)(!1),[X,xe]=(0,_.useState)(!1),Se=(e,t,n)=>{_e(r=>new Map([...Array.from(r),[e??n,{val:e,label:t,children:n,displayName:n??t??e}]]))},Z=(0,_.useMemo)(()=>d||!!(c&&V(c)),[d,c]),Q=(0,_.useMemo)(()=>F||!!(N&&V(N)),[F,N]);(0,_.useEffect)(()=>{ve(o)},[o]),(0,_.useEffect)(()=>{ye(Z)},[Z]),(0,_.useEffect)(()=>{be(Q)},[Q]),(0,_.useEffect)(()=>{xe(m)},[m]);let Ce=e=>{k&&k(e),A&&A(e)},we=s(),{x:Te,y:Ee,strategy:De,refs:Oe,context:$}=ne({open:U,onOpenChange:W,placement:`top`,whileElementsMounted:ee,middleware:[ae(4),ce({crossAxis:!0,allowedPlacements:[`bottom`,`top`]}),te({apply({availableWidth:e,availableHeight:t,elements:n,rects:r}){Object.assign(n.floating.style,{maxWidth:`${e}px`,maxHeight:`${t}px`,minWidth:`${r.reference.width}px`,overflowY:`auto`})}}),re()]}),{getReferenceProps:ke,getFloatingProps:Ae}=se([ie($),oe($)]),je=e=>{let t=e=>{let t=K.get(e);if(t)return t.displayName?.length?t.displayName:null};return e.map(e=>t(e)).filter(e=>e&&e.toString().trim().length>0).join(`, `)};return(0,y.jsx)(O.Provider,{value:{truncateOptions:P,addOptionValueAndLabel:Se},children:(0,y.jsxs)(`div`,{className:`
          juno-select-wrapper 
          jn:relative
          ${z==`auto`?`jn:inline-block`:`jn:block`}
          ${z==`auto`?`jn:w-auto`:`jn:w-full`}
          ${B}
        `,children:[(0,y.jsx)(de,{disabled:i||X||q,multiple:h,name:g,onChange:Ce,value:I,defaultValue:r,as:`div`,children:({open:r})=>((0,_.useEffect)(()=>{W(r)},[r]),(0,y.jsxs)(y.Fragment,{children:[p&&V(p)?(0,y.jsx)(me,{as:ue,htmlFor:G,text:p,className:`${b}`,disabled:i||X||q,required:M,floating:!0,minimized:!0}):``,(0,y.jsxs)(`div`,{children:[(0,y.jsx)(pe,{ref:Oe.setReference,"aria-describedby":l?H:``,"aria-label":e||p,as:`button`,id:G,className:`
                    juno-select-toggle
...
{@link SelectProps }`}}}catch{}})),j,M,N,P,F,I,L,R,z,B=t((()=>{j=e(n()),h(),A(),o(),M=i(),N=`
  jn:flex
  jn:pt-2.75
  jn:pb-[0.5rem]
  jn:pr-3.5
...
`,R=`
  ...
  jn:text-ellipsis
  jn:whitespace-nowrap
`,z=({children:e,className:t=``,disabled:n=!1,value:r=``,label:i,...o})=>{let{truncateOptions:s,addOptionValueAndLabel:c}=(0,j.useContext)(O)||{truncateOptions:!1,addOptionValueAndLabel:()=>{}};return(0,j.useEffect)(()=>{c(r,i,e)},[r,i,e]),(0,M.jsx)(m,{as:j.Fragment,disabled:n,value:r||e,children:({selected:c})=>(0,M.jsxs)(`li`,{className:`
          juno-select-option 
          jn:min-h-10
          ${N}
