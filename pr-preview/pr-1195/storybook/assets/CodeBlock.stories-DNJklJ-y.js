import{j as e,r as i}from"./iframe-57_BUTQX.js";import{C as E}from"./CodeBlock.component-DjiUwvmM.js";import{T as D,a as F}from"./TabList.component-DVe9eypc.js";import{T as B}from"./Tab.component-ivORKCnZ.js";import{T as m}from"./TabPanel.component-BUr2-l0H.js";import"./preload-helper-PPVm8Dsz.js";import"./JsonViewer.component-BP2cDvm_.js";import"./SearchInput.component-BB16pxRS.js";import"./Icon.component-BX-tEFGw.js";import"./Stack.component-CkSFfcZv.js";import"./TabPanel--TvPVMJF.js";const p=({tabs:c,codeBlocks:l})=>e.jsxs(D,{variant:"codeblocks",children:[e.jsx(F,{children:c.map((d,A)=>i.createElement(B,{...d,key:`t-${A}`}))}),l.map((d,A)=>e.jsx(m,{children:e.jsx(E,{...d})},A))]}),j={title:"Components/CodeBlock",component:E,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
