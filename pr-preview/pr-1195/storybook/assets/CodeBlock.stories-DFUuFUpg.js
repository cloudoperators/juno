import{j as e,r as i}from"./iframe-BlXP6VeT.js";import{C as E}from"./CodeBlock.component-Jrd70LK8.js";import{T as D,a as F}from"./TabList.component-C6pEcQ8k.js";import{T as B}from"./Tab.component-VU5xwPiN.js";import{T as m}from"./TabPanel.component-D2pl5sFG.js";import"./preload-helper-PPVm8Dsz.js";import"./JsonViewer.component-DGCDFypH.js";import"./SearchInput.component-qrrA8FlQ.js";import"./Icon.component-_F_jHgmT.js";import"./Stack.component-Dr2aUuNF.js";import"./TabPanel-Bf6z-oF_.js";const p=({tabs:c,codeBlocks:l})=>e.jsxs(D,{variant:"codeblocks",children:[e.jsx(F,{children:c.map((d,A)=>i.createElement(B,{...d,key:`t-${A}`}))}),l.map((d,A)=>e.jsx(m,{children:e.jsx(E,{...d})},A))]}),j={title:"Components/CodeBlock",component:E,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
