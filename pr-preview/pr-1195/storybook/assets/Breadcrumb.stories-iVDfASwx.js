import{r as u,e as m,j as e}from"./iframe-CfhF8s1P.js";import{B as r}from"./BreadcrumbItem.component-CquziKtA.js";import{I as p}from"./Icon.component-Bxdm1ecv.js";import{S as b}from"./Stack.component-CEg5lpEK.js";import"./preload-helper-PPVm8Dsz.js";const n=({children:a,className:c="",...l})=>{const o=u.Children.toArray(a).filter(m.isValidElement),i=o.map((d,s)=>e.jsxs(m.Fragment,{children:[e.jsx(r,{...d.props}),s<o.length-1&&e.jsx(p,{icon:"chevronRight"})]},s));return e.jsx(b,{className:`juno-breadcrumb ${c}`,gap:"1",...l,children:i})};try{n.displayName="Breadcrumb",n.__docgenInfo={description:`Breadcrumb is a component that structures navigational links in a breadcrumb trail.
