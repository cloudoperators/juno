import{j as e,r as W}from"./iframe-Cs9dQPh5.js";import{C as x}from"./CodeBlock.component-BDKePtsw.js";import{T as S,a as J}from"./TabList.component-BDUq3Da9.js";import{T as R}from"./Tab.component-BcHp9Edm.js";import{T as P}from"./TabPanel.component-C93oJFaA.js";import"./JsonViewer.component-BcKHhUKm.js";import"./SearchInput.component-CEw07y21.js";import"./Icon.component-CpkFtrvz.js";import"./Stack.component-Bi1taRye.js";import"./TabPanel-yVLeJa4H.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
