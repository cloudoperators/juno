import{j as e,r as W}from"./iframe-Dj_ANc-G.js";import{C as x}from"./CodeBlock.component-Cy0LIFV_.js";import{T as S,a as J}from"./TabList.component-wHVfS7YE.js";import{T as R}from"./Tab.component-XAOufuqg.js";import{T as P}from"./TabPanel.component-Tyx5-uNv.js";import"./JsonViewer.component-DB8PsCfj.js";import"./SearchInput.component-B_tuH6zc.js";import"./Icon.component-xg4SWuNe.js";import"./Stack.component-DzdMa6q8.js";import"./TabPanel-XjUIzmPV.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
