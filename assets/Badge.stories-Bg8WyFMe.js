import{I as oe,K as ee}from"./Icon.component-CMVMCM4S.js";import{j as h}from"./jsx-runtime-D6fbYt3N.js";import"./index-DysCNOs_.js";import"./widgets-BR6-ubtP.js";const ce=`
  jn-rounded
  jn-text-sm
...
Optionally, an icon can be included to further emphasize the meaning.`,displayName:"Badge",props:{variant:{defaultValue:{value:"default"},description:"Specify an optional semantic variant that determines the appearance of a badge.",name:"variant",required:!1,type:{name:"enum",value:[{value:'"default"'},{value:'"error"'},{value:'"success"'},{value:'"danger"'},{value:'"info"'},{value:'"warning"'}]}},icon:{defaultValue:{value:"false"},description:`Optional.
If true, an icon corresponding to the variant will be displayed.
If a string is provided and it's a valid icon name, that icon will be displayed.`,name:"icon",required:!1,type:{name:'boolean | "default" | "download" | "search" | "help" | "error" | "success" | "accessTime" | "accountCircle" | "addCircle" | "autoAwesomeMosaic" | "autoAwesomeMotion" | "bolt" | ... 39 more ...'}},text:{defaultValue:{value:""},description:`Pass an optional string of text to be rendered as content.
