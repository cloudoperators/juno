import{j as i}from"./iframe-Dxa3ewE5.js";import"./preload-helper-D9Z9MdNV.js";const p=`
  jn:text-sm
  jn:rounded
...
`,l=`
  jn:py-1
  jn:px-2
`,n=({children:o,unpad:t=!1,className:r="",...s})=>{const d=`juno-box ${p} ${t?"":l} ${r}`;return i.jsx("div",{className:d,...s,children:o})};try{n.displayName="Box",n.__docgenInfo={description:`A generic Box component with optional padding and a light border.
...
}`,...a.parameters?.docs?.source}}};const x=["Default","WithoutPadding"];export{e as Default,a as WithoutPadding,x as __namedExportsOrder,u as default};
