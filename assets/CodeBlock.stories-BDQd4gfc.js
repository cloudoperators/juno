import{j as e,r as i}from"./iframe-Cn_EWEvX.js";import{C as E}from"./CodeBlock.component-CJCmqdsh.js";import{T as D,a as F}from"./TabList.component-DorDeT7E.js";import{T as B}from"./Tab.component-DZz2ONFU.js";import{T as m}from"./TabPanel.component-RDvTRcvJ.js";import"./JsonViewer.component-DmMqTkX6.js";import"./SearchInput.component-CagVH5Q8.js";import"./Icon.component-B6iGNrCI.js";import"./Stack.component-MsHiYSBx.js";import"./TabPanel-uYsScKFf.js";const p=({tabs:c,codeBlocks:l})=>e.jsxs(D,{variant:"codeblocks",children:[e.jsx(F,{children:c.map((d,A)=>i.createElement(B,{...d,key:`t-${A}`}))}),l.map((d,A)=>e.jsx(m,{children:e.jsx(E,{...d})},A))]}),I={title:"Components/CodeBlock",component:E,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
