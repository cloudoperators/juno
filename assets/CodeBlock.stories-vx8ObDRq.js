import{j as e}from"./jsx-runtime-BP6H2k8O.js";import{r as J}from"./index-DysCNOs_.js";import{C as S}from"./CodeBlock.component-CkeXuaaQ.js";import{T as L,a as R}from"./TabList.component-DhaVE-BD.js";import{T as P}from"./Tab.component-CachPbAF.js";import{T as K}from"./TabPanel.component-BdVUess2.js";import"./JsonViewer.component-CJrejPXx.js";import"./SearchInput.component-Dk0nkOQu.js";import"./Icon.component-D9enpJBw.js";import"./widgets-BR6-ubtP.js";import"./Stack.component-JaLCSfPt.js";import"./TabPanel-SXlHHxNZ.js";const E={args:{label:"A Tab Label",children:"Tab 1"}},Z={title:"Components/CodeBlock",component:S,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},U=({tabs:v,codeBlocks:W})=>e.jsxs(L,{variant:"codeblocks",children:[e.jsx(R,{children:v.map((d,c)=>J.createElement(P,{...d,key:`t-${c}`}))}),W.map((d,c)=>e.jsx(K,{children:e.jsx(S,{...d})},c))]}),n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},o={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
