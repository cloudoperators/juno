import{j as e,r as W}from"./iframe-DCEqe52N.js";import{C as x}from"./CodeBlock.component-CaTbPLfv.js";import{T as S,a as J}from"./TabList.component-CYG7TjWz.js";import{T as R}from"./Tab.component-DeSxshSN.js";import{T as P}from"./TabPanel.component-D6HCXJfF.js";import"./JsonViewer.component-j70bbG2v.js";import"./SearchInput.component-Kc34I79r.js";import"./Icon.component-DoBhStFC.js";import"./Stack.component-B0K-dVjC.js";import"./TabPanel-btAZ5upU.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
