import{j as e,r as W}from"./iframe-DT3rWUEB.js";import{C as x}from"./CodeBlock.component-ichL7YT_.js";import{T as S,a as J}from"./TabList.component-DmkEwOfh.js";import{T as R}from"./Tab.component-DY-noadN.js";import{T as P}from"./TabPanel.component-Bdh2k6SE.js";import"./JsonViewer.component-t10KsaEG.js";import"./SearchInput.component-DEZopRnl.js";import"./Icon.component-DqXsjQJc.js";import"./Stack.component-y6Dkt9Ax.js";import"./TabPanel-DuqWB-sc.js";const K=({tabs:v,codeBlocks:L})=>e.jsxs(S,{variant:"codeblocks",children:[e.jsx(J,{children:v.map((d,A)=>W.createElement(R,{...d,key:`t-${A}`}))}),L.map((d,A)=>e.jsx(P,{children:e.jsx(x,{...d})},A))]}),Q={title:"Components/CodeBlock",component:x,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
