import{j as e,r as i}from"./iframe-DpzLhcSD.js";import{C as E}from"./CodeBlock.component-CbrxmwMb.js";import{T as D,a as F}from"./TabList.component-Ci9s6MWY.js";import{T as B}from"./Tab.component-C8pDirth.js";import{T as m}from"./TabPanel.component-44J-vbdS.js";import"./JsonViewer.component-B1ark7So.js";import"./SearchInput.component-BrVQOmhp.js";import"./Icon.component-CZd049u1.js";import"./Stack.component-BJ2Yo6FH.js";import"./TabPanel-BlseO2XN.js";const p=({tabs:c,codeBlocks:l})=>e.jsxs(D,{variant:"codeblocks",children:[e.jsx(F,{children:c.map((d,A)=>i.createElement(B,{...d,key:`t-${A}`}))}),l.map((d,A)=>e.jsx(m,{children:e.jsx(E,{...d})},A))]}),I={title:"Components/CodeBlock",component:E,argTypes:{size:{options:["auto","small","medium","large"],control:{type:"select"}},children:{control:!1,table:{type:{summary:"ReactNode"}}}}},n={parameters:{docs:{description:{story:"Default code block"}}},args:{content:"Some code goes here"}},a={parameters:{docs:{description:{story:"Code Block with children"}}},args:{lang:"html",children:`<html lang="en">
    <head>
